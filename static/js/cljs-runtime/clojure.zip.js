...
var G__88380 = clojure.zip.node(loc);
var fexpr__88379 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__88379.cljs$core$IFn$_invoke$arity$1 ? fexpr__88379.cljs$core$IFn$_invoke$arity$1(G__88380) : fexpr__88379.call(null,G__88380));
});
/**
...
var G__88382 = clojure.zip.node(loc);
var fexpr__88381 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__88381.cljs$core$IFn$_invoke$arity$1 ? fexpr__88381.cljs$core$IFn$_invoke$arity$1(G__88382) : fexpr__88381.call(null,G__88382));
} else {
...
var fexpr__88383 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__88383.cljs$core$IFn$_invoke$arity$2 ? fexpr__88383.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__88383.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__88384 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88384,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88384,(1),null);
var vec__88387 = clojure.zip.children(loc);
var seq__88388 = cljs.core.seq(vec__88387);
var first__88389 = cljs.core.first(seq__88388);
var seq__88388__$1 = cljs.core.next(seq__88388);
var c = first__88389;
var cnext = seq__88388__$1;
var cs = vec__88387;
...
var vec__88390 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88390,(0),null);
var map__88393 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88390,(1),null);
var map__88393__$1 = cljs.core.__destructure_map(map__88393);
var path = map__88393__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88393__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88393__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88393__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88393__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88393__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__88394 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88394,(0),null);
var map__88397 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88394,(1),null);
var map__88397__$1 = cljs.core.__destructure_map(map__88397);
var path = map__88397__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88397__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__88398 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88397__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__88399 = cljs.core.seq(vec__88398);
var first__88400 = cljs.core.first(seq__88399);
var seq__88399__$1 = cljs.core.next(seq__88399);
var r = first__88400;
var rnext = seq__88399__$1;
var rs = vec__88398;
...
var vec__88401 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88401,(0),null);
var map__88404 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88401,(1),null);
var map__88404__$1 = cljs.core.__destructure_map(map__88404);
var path = map__88404__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88404__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88404__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5041__auto__ = path;
if(cljs.core.truth_(and__5041__auto__)){
return r;
} else {
...
var vec__88405 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88405,(0),null);
var map__88408 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88405,(1),null);
var map__88408__$1 = cljs.core.__destructure_map(map__88408);
var path = map__88408__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88408__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88408__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5041__auto__ = path;
if(cljs.core.truth_(and__5041__auto__)){
...
var vec__88409 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88409,(0),null);
var map__88412 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88409,(1),null);
var map__88412__$1 = cljs.core.__destructure_map(map__88412);
var path = map__88412__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88412__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88412__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5041__auto__ = path;
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__88413 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88413,(0),null);
var map__88416 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88413,(1),null);
var map__88416__$1 = cljs.core.__destructure_map(map__88416);
var path = map__88416__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88416__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__88417 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88417,(0),null);
var map__88420 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88417,(1),null);
var map__88420__$1 = cljs.core.__destructure_map(map__88420);
var path = map__88420__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88420__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__88421 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88421,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88421,(1),null);
...
var len__5766__auto___88432 = arguments.length;
var i__5767__auto___88433 = (0);
while(true){
if((i__5767__auto___88433 < len__5766__auto___88432)){
args__5772__auto__.push((arguments[i__5767__auto___88433]));

var G__88434 = (i__5767__auto___88433 + (1));
i__5767__auto___88433 = G__88434;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq88424){
var G__88425 = cljs.core.first(seq88424);
var seq88424__$1 = cljs.core.next(seq88424);
var G__88426 = cljs.core.first(seq88424__$1);
var seq88424__$2 = cljs.core.next(seq88424__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__88425,G__88426,seq88424__$2);
}));
...
var G__88436 = clojure.zip.rightmost(child);
loc__$1 = G__88436;
continue;
} else {
return loc__$1;
...
var vec__88427 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88427,(0),null);
var map__88430 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88427,(1),null);
var map__88430__$1 = cljs.core.__destructure_map(map__88430);
var path = map__88430__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88430__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88430__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88430__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88430__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__88437 = clojure.zip.rightmost(child);
loc__$1 = G__88437;
continue;
} else {
return loc__$1;
