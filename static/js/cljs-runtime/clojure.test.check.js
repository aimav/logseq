...
var vec__122200 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__122200,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__122200,(1),null);
...
var len__5766__auto___122238 = arguments.length;
var i__5767__auto___122239 = (0);
while(true){
if((i__5767__auto___122239 < len__5766__auto___122238)){
args__5772__auto__.push((arguments[i__5767__auto___122239]));

var G__122240 = (i__5767__auto___122239 + (1));
i__5767__auto___122239 = G__122240;
continue;
} else {
}
break;
...
return clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5773__auto__);
});

(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__122207){
var map__122208 = p__122207;
var map__122208__$1 = cljs.core.__destructure_map(map__122208);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__122208__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__122208__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__122208__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__122209 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__122209,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__122209,(1),null);
...
var vec__122223 = size_seq__$1;
var seq__122224 = cljs.core.seq(vec__122223);
var first__122225 = cljs.core.first(seq__122224);
var seq__122224__$1 = cljs.core.next(seq__122224);
var size = first__122225;
var rest_size_seq = seq__122224__$1;
var vec__122226 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__122226,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__122226,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq122204){
var G__122205 = cljs.core.first(seq122204);
var seq122204__$1 = cljs.core.next(seq122204);
var G__122206 = cljs.core.first(seq122204__$1);
var seq122204__$2 = cljs.core.next(seq122204__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__122205,G__122206,seq122204__$2);
}));
...
var map__122230 = smallest;
var map__122230__$1 = cljs.core.__destructure_map(map__122230);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__122230__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__122246 = tail;
var G__122247 = current_smallest;
var G__122248 = (total_nodes_visited + (1));
var G__122249 = depth;
nodes = G__122246;
current_smallest = G__122247;
total_nodes_visited = G__122248;
depth = G__122249;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__122232_122250 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__122232_122250) : reporter_fn.call(null,G__122232_122250));

var temp__5802__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5802__auto__){
var children = temp__5802__auto__;
var G__122251 = children;
var G__122252 = new_smallest;
var G__122253 = (total_nodes_visited + (1));
var G__122254 = (depth + (1));
nodes = G__122251;
current_smallest = G__122252;
total_nodes_visited = G__122253;
depth = G__122254;
continue;
} else {
var G__122255 = tail;
var G__122256 = new_smallest;
var G__122257 = (total_nodes_visited + (1));
var G__122258 = depth;
nodes = G__122255;
current_smallest = G__122256;
total_nodes_visited = G__122257;
depth = G__122258;
continue;
}
}
...
var G__122234_122259 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__122234_122259) : reporter_fn.call(null,G__122234_122259));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__122233_SHARP_){
var G__122235 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__122233_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__122235) : reporter_fn.call(null,G__122235));
}));
var G__122236_122260 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__122236_122260) : reporter_fn.call(null,G__122236_122260));
