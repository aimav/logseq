...
var G__125522 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__125522)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__125522)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__125522)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__125522)].join('')));
...
while(true){
var temp__5802__auto__ = cljs.core.first(sq);
if(cljs.core.truth_(temp__5802__auto__)){
var c = temp__5802__auto__;
var G__125654 = c;
switch (G__125654) {
case "\\":
var temp__5802__auto____$1 = cljs.core.second(sq);
if(cljs.core.truth_(temp__5802__auto____$1)){
var c2 = temp__5802__auto____$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c2,"'")){
var G__125756 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__125757 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__125756;
v = G__125757;
continue;
} else {
var G__125758 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__125759 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__125758;
v = G__125759;
continue;
}
...
break;
case "\"":
var G__125760 = cljs.core.next(sq);
var G__125761 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__125760;
v = G__125761;
continue;
...
break;
default:
var G__125762 = cljs.core.next(sq);
var G__125763 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__125762;
v = G__125763;
continue;
...
while(true){
var G__125674 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__125674__$1 = (((G__125674 instanceof cljs.core.Keyword))?G__125674.fqn:null);
switch (G__125674__$1) {
case "rule":
var vec__125675 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125675,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125675,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__125678 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__125678) : instaparse.cfg.content.call(null,G__125678));
...
break;
case "paren":
var G__125773 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__125773;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__125681 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__125681) : instaparse.cfg.build_rule.call(null,G__125681));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__125682 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__125682) : instaparse.cfg.build_rule.call(null,G__125682));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__125683 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__125683) : instaparse.cfg.build_rule.call(null,G__125683));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__125684 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__125684) : instaparse.cfg.build_rule.call(null,G__125684));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__125685 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__125685) : instaparse.cfg.build_rule.call(null,G__125685));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__125689 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__125689) : instaparse.cfg.build_rule.call(null,G__125689));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__125674__$1)].join('')));
...
while(true){
var G__125697 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__125697__$1 = (((G__125697 instanceof cljs.core.Keyword))?G__125697.fqn:null);
switch (G__125697__$1) {
case "nt":
...
case "neg":
case "rep":
var G__125779 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__125779;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__125697__$1)].join('')));
...
var valid_nts_125780 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__125701_125781 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__125702_125782 = null;
var count__125703_125783 = (0);
var i__125704_125784 = (0);
while(true){
if((i__125704_125784 < count__125703_125783)){
var nt_125785 = chunk__125702_125782.cljs$core$IIndexed$_nth$arity$2(null,i__125704_125784);
if(cljs.core.truth_((valid_nts_125780.cljs$core$IFn$_invoke$arity$1 ? valid_nts_125780.cljs$core$IFn$_invoke$arity$1(nt_125785) : valid_nts_125780.call(null,nt_125785)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_125785),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__125786 = seq__125701_125781;
var G__125787 = chunk__125702_125782;
var G__125788 = count__125703_125783;
var G__125789 = (i__125704_125784 + (1));
seq__125701_125781 = G__125786;
chunk__125702_125782 = G__125787;
count__125703_125783 = G__125788;
i__125704_125784 = G__125789;
continue;
} else {
var temp__5804__auto___125790 = cljs.core.seq(seq__125701_125781);
if(temp__5804__auto___125790){
var seq__125701_125791__$1 = temp__5804__auto___125790;
if(cljs.core.chunked_seq_QMARK_(seq__125701_125791__$1)){
var c__5565__auto___125792 = cljs.core.chunk_first(seq__125701_125791__$1);
var G__125793 = cljs.core.chunk_rest(seq__125701_125791__$1);
var G__125794 = c__5565__auto___125792;
var G__125795 = cljs.core.count(c__5565__auto___125792);
var G__125796 = (0);
seq__125701_125781 = G__125793;
chunk__125702_125782 = G__125794;
count__125703_125783 = G__125795;
i__125704_125784 = G__125796;
continue;
} else {
var nt_125800 = cljs.core.first(seq__125701_125791__$1);
if(cljs.core.truth_((valid_nts_125780.cljs$core$IFn$_invoke$arity$1 ? valid_nts_125780.cljs$core$IFn$_invoke$arity$1(nt_125800) : valid_nts_125780.call(null,nt_125800)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_125800),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__125801 = cljs.core.next(seq__125701_125791__$1);
var G__125802 = null;
var G__125803 = (0);
var G__125804 = (0);
seq__125701_125781 = G__125801;
chunk__125702_125782 = G__125802;
count__125703_125783 = G__125803;
i__125704_125784 = G__125804;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__125707_125806 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__125708_125807 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__125709_125808 = true;
var _STAR_print_fn_STAR__temp_val__125710_125809 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__125709_125808);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__125710_125809);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__125708_125807);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__125707_125806);
}
...
var len__5766__auto___125810 = arguments.length;
var i__5767__auto___125811 = (0);
while(true){
if((i__5767__auto___125811 < len__5766__auto___125810)){
args__5772__auto__.push((arguments[i__5767__auto___125811]));

var G__125812 = (i__5767__auto___125811 + (1));
i__5767__auto___125811 = G__125812;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__125726){
var map__125731 = p__125726;
var map__125731__$1 = cljs.core.__destructure_map(map__125731);
var opts = map__125731__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__125732 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__125733 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__125733);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__5687__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__125743_125817 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__125744_125818 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__125745_125819 = true;
var _STAR_print_fn_STAR__temp_val__125746_125820 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__125745_125819);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__125746_125820);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__125744_125818);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__125743_125817);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5687__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__125732);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq125712){
var G__125713 = cljs.core.first(seq125712);
var seq125712__$1 = cljs.core.next(seq125712);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__125713,seq125712__$1);
}));
