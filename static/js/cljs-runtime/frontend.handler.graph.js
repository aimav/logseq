...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__114736){
var vec__114737 = p__114736;
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114737,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114737,(1),null);
...
var color = (function (){var G__114740 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dark_QMARK_,current_page_QMARK_], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__114740)){
return "#999";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__114740)){
return "#045591";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__114740)){
return "#93a1a1";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__114740)){
return "#ffffff";
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__114740)].join('')));
...
var G__114741 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),p__$1,new cljs.core.Keyword(null,"label","label",1718410804),p__$1,new cljs.core.Keyword(null,"size","size",1098693007),size,new cljs.core.Keyword(null,"color","color",1011675173),color__$1], null);
if(cljs.core.contains_QMARK_(parents,p__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__114741,new cljs.core.Keyword(null,"parent","parent",-878878779),true);
} else {
return G__114741;
}
...
return ((frontend.util.uuid_string_QMARK_(id)) || (((clojure.string.starts_with_QMARK_(id,"../assets/")) || (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,"..")) || (((clojure.string.starts_with_QMARK_(id,"assets/")) || (((clojure.string.ends_with_QMARK_(id,".gif")) || (((clojure.string.ends_with_QMARK_(id,".jpg")) || (clojure.string.ends_with_QMARK_(id,".png")))))))))))));
});
...
frontend.handler.graph.normalize_page_name = (function frontend$handler$graph$normalize_page_name(p__114742){
var map__114743 = p__114742;
var map__114743__$1 = cljs.core.__destructure_map(map__114743);
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114743__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114743__$1,new cljs.core.Keyword(null,"links","links",-654507394));
var page_name__GT_original_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114743__$1,new cljs.core.Keyword(null,"page-name->original-name","page-name->original-name",599049389));
var links__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__114744){
var map__114745 = p__114744;
var map__114745__$1 = cljs.core.__destructure_map(map__114745);
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114745__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114745__$1,new cljs.core.Keyword(null,"target","target",253001721));
...
var temp__5802__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(page_name__GT_original_name,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(node));
if(cljs.core.truth_(temp__5802__auto__)){
var original_name = temp__5802__auto__;
...
frontend.handler.graph.build_global_graph = (function frontend$handler$graph$build_global_graph(theme,p__114747){
var map__114748 = p__114747;
var map__114748__$1 = cljs.core.__destructure_map(map__114748);
var journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114748__$1,new cljs.core.Keyword(null,"journal?","journal?",-897756522));
var orphan_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114748__$1,new cljs.core.Keyword(null,"orphan-pages?","orphan-pages?",-824819206));
var builtin_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114748__$1,new cljs.core.Keyword(null,"builtin-pages?","builtin-pages?",1299611390));
var excluded_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114748__$1,new cljs.core.Keyword(null,"excluded-pages?","excluded-pages?",1527958391));
...
var all_pages = cljs.core.map.cljs$core$IFn$_invoke$arity$2(frontend.db.get_original_name,full_pages);
...
var pages_after_exclude_filter = (function (){var G__114749 = pages_after_journal_filter;
if(cljs.core.not(excluded_pages_QMARK_)){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,new cljs.core.Keyword(null,"exclude-from-graph-view","exclude-from-graph-view",-1509369969).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","properties","block/properties",708347145).cljs$core$IFn$_invoke$arity$1(p)));
}),G__114749);
} else {
return G__114749;
}
...
var linked = cljs.core.set(cljs.core.flatten(links));
var build_in_pages = cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.string.lower_case,logseq.db.default$.built_in_pages_names));
var nodes = (function (){var G__114750 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","name","block/name",1619760316),pages_after_exclude_filter);
var G__114750__$1 = ((cljs.core.not(builtin_pages_QMARK_))?cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p){
return cljs.core.contains_QMARK_(build_in_pages,clojure.string.lower_case(p));
}),G__114750):G__114750);
if(cljs.core.not(orphan_pages_QMARK_)){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__114746_SHARP_){
return cljs.core.contains_QMARK_(linked,clojure.string.lower_case(p1__114746_SHARP_));
}),G__114750__$1);
} else {
return G__114750__$1;
}
})();
var page_links = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__114751){
var vec__114752 = p__114751;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114752,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114752,(1),null);
...
var links__$1 = frontend.handler.graph.build_links(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__114755){
var vec__114756 = p__114755;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114756,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114756,(1),null);
return (to == null);
}),links));
...
frontend.handler.graph.build_page_graph = (function frontend$handler$graph$build_page_graph(page,theme,show_journal){
var dark_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("dark",theme);
var temp__5804__auto__ = frontend.state.get_current_repo();
if(cljs.core.truth_(temp__5804__auto__)){
var repo = temp__5804__auto__;
...
var page_entity = (function (){var G__114760 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page__$1], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__114760) : frontend.db.entity.call(null,G__114760));
})();
...
var tags__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__114759_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page__$1,p1__114759_SHARP_);
}),tags);
...
var mentioned_pages = (frontend.db.get_pages_that_mentioned_page.cljs$core$IFn$_invoke$arity$3 ? frontend.db.get_pages_that_mentioned_page.cljs$core$IFn$_invoke$arity$3(repo,page__$1,show_journal) : frontend.db.get_pages_that_mentioned_page.call(null,repo,page__$1,show_journal));
var namespaces = (frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1(repo) : frontend.db.get_all_namespace_relation.call(null,repo));
var links = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(namespaces,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__114761){
var vec__114762 = p__114761;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114762,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114762,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [page__$1,p], null);
}),ref_pages),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__114765){
var vec__114766 = p__114765;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114766,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114766,(1),null);
...
var mentioned_pages__$1 = clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,(frontend.db.get_pages_that_mentioned_page.cljs$core$IFn$_invoke$arity$3 ? frontend.db.get_pages_that_mentioned_page.cljs$core$IFn$_invoke$arity$3(repo,page__$2,show_journal) : frontend.db.get_pages_that_mentioned_page.call(null,repo,page__$2,show_journal)))),other_pages);
...
var namespaces = (frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_all_namespace_relation.cljs$core$IFn$_invoke$arity$1(repo) : frontend.db.get_all_namespace_relation.call(null,repo));
var links = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__114769){
var vec__114770 = p__114769;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114770,(0),null);
var _aliases = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114770,(1),null);
 ...
 */
frontend.handler.graph.n_hops = (function frontend$handler$graph$n_hops(p__114773,nodes,level){
var map__114774 = p__114773;
var map__114774__$1 = cljs.core.__destructure_map(map__114774);
var graph = map__114774__$1;
var links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114774__$1,new cljs.core.Keyword(null,"links","links",-654507394));
...
var G__114775 = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.concat,nodes__$1,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (nodes__$1,level__$1,links__$1,map__114774,map__114774__$1,graph,links){
return (function (id){
...
});})(nodes__$1,level__$1,links__$1,map__114774,map__114774__$1,graph,links))
,nodes__$1)));
var G__114776 = (level__$1 - (1));
nodes__$1 = G__114775;
level__$1 = G__114776;
continue;
}
