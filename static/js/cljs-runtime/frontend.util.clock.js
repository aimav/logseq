 ...
 */
frontend.util.clock.s__GT_dhms_util = (function frontend$util$clock$s__GT_dhms_util(seconds){
...
frontend.util.clock.seconds__GT_days_COLON_hours_COLON_minutes_COLON_seconds = (function frontend$util$clock$seconds__GT_days_COLON_hours_COLON_minutes_COLON_seconds(seconds){
var vec__105494 = frontend.util.clock.s__GT_dhms_util(seconds);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105494,(0),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105494,(1),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105494,(2),null);
var seconds__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105494,(3),null);
return frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("%s%s%s%s",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(((days === (0)))?"":[cljs.core.str.cljs$core$IFn$_invoke$arity$1(days),"d"].join('')),(((hours === (0)))?"":[cljs.core.str.cljs$core$IFn$_invoke$arity$1(hours),"h"].join('')),(((minutes === (0)))?"":[cljs.core.str.cljs$core$IFn$_invoke$arity$1(minutes),"m"].join('')),(((seconds__$1 === (0)))?"":[cljs.core.str.cljs$core$IFn$_invoke$arity$1(seconds__$1),"s"].join(''))], 0));
});
frontend.util.clock.support_seconds_QMARK_ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(frontend.state.get_config.cljs$core$IFn$_invoke$arity$0(),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("logbook","settings","logbook/settings",824968896),new cljs.core.Keyword(null,"with-second-support?","with-second-support?",1045118886)], null),true);
...
var vec__105498 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__105497_SHARP_){
return cljs_time.format.parse.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(frontend.util.clock.support_seconds_QMARK_)?frontend.date.custom_formatter_4:frontend.date.custom_formatter_3),p1__105497_SHARP_);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [stime,etime], null));
var stime__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105498,(0),null);
var etime__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105498,(1),null);
...
try{var or__5043__auto__ = (function (){var temp__5804__auto__ = cljs.core.last(cljs.core.last(frontend.util.drawer.get_drawer_ast(format,content,"logbook")));
...
var temp__5804__auto____$2 = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__105505_SHARP_){
return clojure.string.starts_with_QMARK_(p1__105505_SHARP_,"CLOCK:");
}),logbook_lines));
if(temp__5804__auto____$2){
var clock_lines = temp__5804__auto____$2;
var vec__105514 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.map,cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__105507_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.int$,p1__105507_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__105506_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(clojure.string.trim(cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__105506_SHARP_,"=>"))),":");
}),clock_lines)));
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105514,(0),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105514,(1),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105514,(2),null);
