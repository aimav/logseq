...
try{var G__68587 = goog.dom.getElement("mock-text");
var G__68587__$1 = (((G__68587 == null))?null:goog.dom.getChildren(G__68587));
var G__68587__$2 = (((G__68587__$1 == null))?null:cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(G__68587__$1));
var G__68587__$3 = (((G__68587__$2 == null))?null:frontend.util.nth_safe(G__68587__$2,pos));
var G__68587__$4 = (((G__68587__$3 == null))?null:frontend.util.cursor.mock_char_pos(G__68587__$3));
if((G__68587__$4 == null)){
return null;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68587__$4,new cljs.core.Keyword(null,"rect","rect",-108902628),rect);
}
}catch (e68586){var e = e68586;
...
if(cljs.core.truth_(input)){
var map__68590 = frontend.util.cursor.get_caret_pos.cljs$core$IFn$_invoke$arity$1(input);
var map__68590__$1 = cljs.core.__destructure_map(map__68590);
var pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68590__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
var pos__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(1)))?(function (){var or__5043__auto__ = frontend.util.safe_inc_current_pos_from_start(input.value,pos);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return (pos + (1));
...
if(cljs.core.truth_(input)){
var map__68593 = frontend.util.cursor.get_caret_pos.cljs$core$IFn$_invoke$arity$1(input);
var map__68593__$1 = cljs.core.__destructure_map(map__68593);
var pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68593__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
...
var vec__68594 = frontend.util.cursor.get_input_content_AMPERSAND_pos(input);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68594,(0),null);
var pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68594,(1),null);
if((pos === (0))){
return (0);
} else {
...
var vec__68597 = frontend.util.cursor.get_input_content_AMPERSAND_pos(input);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68597,(0),null);
var pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68597,(1),null);
...
var vec__68600 = frontend.util.cursor.get_input_content_AMPERSAND_pos(input);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68600,(0),null);
var pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68600,(1),null);
if(cljs.core.truth_(content)){
var or__5043__auto__ = (pos === (0));
if(or__5043__auto__){
return or__5043__auto__;
} else {
var temp__5804__auto__ = cljs.core.subs.cljs$core$IFn$_invoke$arity$3(content,(pos - (1)),pos);
...
var vec__68605 = frontend.util.cursor.get_input_content_AMPERSAND_pos(input);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68605,(0),null);
var _pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68605,(1),null);
...
while(true){
if(cljs.core.truth_((function (){var G__68611 = frontend.util.nth_safe(val,idx);
var fexpr__68610 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [" ",null,"\n",null], null), null);
return (fexpr__68610.cljs$core$IFn$_invoke$arity$1 ? fexpr__68610.cljs$core$IFn$_invoke$arity$1(G__68611) : fexpr__68610.call(null,G__68611));
})())){
var G__68621 = (idx + (1));
idx = G__68621;
continue;
...
while(true){
if(cljs.core.truth_((function (){var G__68615 = frontend.util.nth_safe(val,idx);
var fexpr__68614 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [" ",null,"\n",null], null), null);
return (fexpr__68614.cljs$core$IFn$_invoke$arity$1 ? fexpr__68614.cljs$core$IFn$_invoke$arity$1(G__68615) : fexpr__68614.call(null,G__68615));
})())){
var G__68622 = (idx - (1));
idx = G__68622;
continue;
...
var tops_p = cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p1__68616_SHARP_){
return (new cljs.core.Keyword(null,"top","top",-1856271961).cljs$core$IFn$_invoke$arity$1(cursor) === p1__68616_SHARP_);
}),tops);
