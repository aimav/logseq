...
var or__5043__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(frontend.extensions.calc.constants,var$__$1);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var or__5043__auto____$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(env),var$__$1);
...
}),cljs.core.comp.cljs$core$IFn$_invoke$arity$2(module$node_modules$bignumber_DOT_js$bignumber.BigNumber,(function (p1__126465_SHARP_){
return clojure.string.replace(p1__126465_SHARP_,",","");
...
if(cljs.core.truth_((function (){var and__5041__auto__ = a.isInteger();
if(cljs.core.truth_(and__5041__auto__)){
var and__5041__auto____$1 = a.isPositive();
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("Can't redefine constant %s",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([var$], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"var","var",-769682797),var$], null));
} else {
...
var G__126467 = ast;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__126466,G__126467) : instaparse.core.transform.call(null,G__126466,G__126467));
});
frontend.extensions.calc.eval = (function frontend$extensions$calc$eval(var_args){
var G__126469 = arguments.length;
switch (G__126469) {
case 1:
...
}catch (e126470){if((e126470 instanceof Error)){
var e = e126470;
return e;
} else {
throw e126470;
 ...
 */
frontend.extensions.calc.can_fix_QMARK_ = (function frontend$extensions$calc$can_fix_QMARK_(num,places){
var or__5043__auto__ = num.isZero();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var mag = num.abs();
...
var and__5041__auto__ = mag.isGreaterThanOrEqualTo(lower_bound);
if(cljs.core.truth_(and__5041__auto__)){
 ...
 */
frontend.extensions.calc.can_fit_QMARK_ = (function frontend$extensions$calc$can_fit_QMARK_(num,digits,tolerance){
var and__5041__auto__ = (num.e < digits);
if(and__5041__auto__){
return num.shiftedBy((tolerance + digits)).isInteger();
} else {
return and__5041__auto__;
}
});
...
return [((cljs.core.neg_int_QMARK_(sign))?"-":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__126472 = base;
switch (G__126472) {
case (2):
return "0b";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__126472)].join('')));
...
if(cljs.core.truth_((function (){var or__5043__auto__ = improper;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return whole.isZero();
...
var precision = (function (){var or__5043__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(env),new cljs.core.Keyword(null,"precision","precision",-1175707478));
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return (21);
...
var max_denominator = (function (){var or__5043__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(env),new cljs.core.Keyword(null,"max-denominator","max-denominator",1539997685));
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return (4095);
...
var vec__126473 = val.toFraction(max_denominator);
var numerator = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126473,(0),null);
var denominator = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126473,(1),null);
var delta = numerator.dividedBy(denominator).minus(val);
if(cljs.core.truth_((function (){var or__5043__auto__ = delta.isZero();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return (delta.e < (-16));
...
})], null),(function (){var iter__5520__auto__ = (function frontend$extensions$calc$iter__126486(s__126487){
return (new cljs.core.LazySeq(null,(function (){
var s__126487__$1 = s__126487;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__126487__$1);
if(temp__5804__auto____$1){
var s__126487__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__126487__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__126487__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__126489 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__126488 = (0);
while(true){
if((i__126488 < size__5519__auto__)){
var vec__126490 = cljs.core._nth(c__5518__auto__,i__126488);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126490,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126490,(1),null);
cljs.core.chunk_append(b__126489,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.extensions__code-calc-output-line.CodeMirror-line","div.extensions__code-calc-output-line.CodeMirror-line",-293396137),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),(((line == null))?"":((frontend.extensions.calc.failure_QMARK_(line))?"?":cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)
))], null)], null));

var G__126498 = (i__126488 + (1));
i__126488 = G__126498;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__126489),frontend$extensions$calc$iter__126486(cljs.core.chunk_rest(s__126487__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__126489),null);
}
} else {
var vec__126493 = cljs.core.first(s__126487__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126493,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126493,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.extensions__code-calc-output-line.CodeMirror-line","div.extensions__code-calc-output-line.CodeMirror-line",-293396137),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),(((line == null))?"":((frontend.extensions.calc.failure_QMARK_(line))?"?":cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)
))], null)], null),frontend$extensions$calc$iter__126486(cljs.core.rest(s__126487__$2)));
}
} else {
return null;
}
