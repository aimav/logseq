...
var len__5766__auto___88358 = arguments.length;
var i__5767__auto___88359 = (0);
while(true){
if((i__5767__auto___88359 < len__5766__auto___88358)){
args__5772__auto__.push((arguments[i__5767__auto___88359]));

var G__88360 = (i__5767__auto___88359 + (1));
i__5767__auto___88359 = G__88360;
continue;
} else {
}
break;
...
return rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5773__auto__);
});

(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__88354){
var vec__88355 = p__88354;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88355,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__88351_SHARP_){
var and__5041__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__88351_SHARP_) : allowed_QMARK_.call(null,p1__88351_SHARP_)));
if(and__5041__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__88351_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq88352){
var G__88353 = cljs.core.first(seq88352);
var seq88352__$1 = cljs.core.next(seq88352);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__88353,seq88352__$1);
}));
