goog.provide('frontend.format.protocol');
...
var frontend$format$protocol$Format$toEdn$dyn_69535 = (function (this$,content,config){
...
frontend.format.protocol.toEdn = (function frontend$format$protocol$toEdn(this$,content,config){
...
return frontend$format$protocol$Format$toEdn$dyn_69535(this$,content,config);
}
});

var frontend$format$protocol$Format$toHtml$dyn_69536 = (function (this$,content,config,references){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
frontend.format.protocol.toHtml = (function frontend$format$protocol$toHtml(this$,content,config,references){
...
return frontend$format$protocol$Format$toHtml$dyn_69536(this$,content,config,references);
}
});

var frontend$format$protocol$Format$exportMarkdown$dyn_69537 = (function (this$,content,config,references){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
frontend.format.protocol.exportMarkdown = (function frontend$format$protocol$exportMarkdown(this$,content,config,references){
...
return frontend$format$protocol$Format$exportMarkdown$dyn_69537(this$,content,config,references);
}
});

var frontend$format$protocol$Format$exportOPML$dyn_69538 = (function (this$,content,config,title,references){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
frontend.format.protocol.exportOPML = (function frontend$format$protocol$exportOPML(this$,content,config,title,references){
...
return frontend$format$protocol$Format$exportOPML$dyn_69538(this$,content,config,title,references);
}
});


//# sourceMappingURL=frontend.format.protocol.js.map
