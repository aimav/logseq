...
var m = (function (){var or__5043__auto__ = cljs.core.meta(expr);
...
var fm = (function (){var or__5043__auto__ = new cljs.core.Keyword("sci.impl","f-meta","sci.impl/f-meta",-1735495322).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var G__70573 = f;
...
return cljs.core.meta(G__70573);
}
}
})();
...
var data__$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__70574,entry){
var vec__70575 = p__70574;
var acc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70575,(0),null);
var last_file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70575,(1),null);
var last_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70575,(2),null);
var last_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70575,(3),null);
var new_last_name = (function (){var or__5043__auto__ = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(entry);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return last_name;
...
var new_last_file = (function (){var or__5043__auto__ = new cljs.core.Keyword(null,"file","file",-1269645878).cljs$core$IFn$_invoke$arity$1(entry);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return last_file;
...
var data = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__70583){
var map__70584 = p__70583;
var map__70584__$1 = cljs.core.__destructure_map(map__70584);
var nom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70584__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70584__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70584__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70584__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70584__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var built_in = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70584__$1,new cljs.core.Keyword("sci","built-in","sci/built-in",1244659599));
var local = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70584__$1,new cljs.core.Keyword(null,"local","local",-1497766724));
if(cljs.core.truth_((function (){var or__5043__auto__ = line;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return built_in;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70593){
var map__70594 = p__70593;
var map__70594__$1 = cljs.core.__destructure_map(map__70594);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70594__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var loc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70594__$1,new cljs.core.Keyword(null,"loc","loc",-584284901));
