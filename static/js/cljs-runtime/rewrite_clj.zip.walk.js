...
var or__5043__auto__ = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc) : f.call(null,zloc));
...
var G__90056 = rewrite_clj.zip.move.next(rewrite_clj.zip.walk.process_loc(loc,p_QMARK_,f));
loc = G__90056;
continue;
}
break;
...
var G__90058 = rewrite_clj.zip.walk.downmost(rewrite_clj.zip.move.right(loc__$1));
loc = G__90058;
continue;
} else {
if(cljs.core.truth_(rewrite_clj.zip.move.up(loc__$1))){
var G__90059 = rewrite_clj.zip.move.up(loc__$1);
loc = G__90059;
continue;
} else {
return loc__$1;
...
return rewrite_clj.zip.subedit.subedit_node(zloc,(function (p1__90053_SHARP_){
return rewrite_clj.zip.walk.postwalk_subtree(p_QMARK_,f,p1__90053_SHARP_);
}));
}));
