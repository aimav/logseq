...
var comma_88315 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_88316 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_88315),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__88310){
var vec__88311 = p__88310;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88311,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88311,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_88316,rewrite_clj.node.protocols.coerce(v),comma_88315);
...
return rewrite_clj.node.stringz.string_node(rewrite_clj.parser.impl.read_string_data(rewrite_clj.reader.string_reader(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0)))));
}));
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__88314 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__88314) : f.call(null,G__88314));
})(),sq);
});
...
(cljs.core.LazySeq.prototype.rewrite_clj$node$protocols$NodeCoerceable$ = cljs.core.PROTOCOL_SENTINEL);

(cljs.core.LazySeq.prototype.rewrite_clj$node$protocols$NodeCoerceable$coerce$arity$1 = (function (sq){
var sq__$1 = this;
return rewrite_clj.node.coercer.seq_node(rewrite_clj.node.seq.list_node,sq__$1);
}));
