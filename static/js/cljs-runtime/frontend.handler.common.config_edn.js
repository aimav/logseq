...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__86833){
var vec__86834 = p__86833;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86834,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86834,(1),null);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__86837){
var vec__86838 = p__86837;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86838,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86838,(1),null);
...
return frontend.handler.common.config_edn.config_notification_show_BANG_.cljs$core$IFn$_invoke$arity$4(title,body,status,true);
}));
 ...
 */
frontend.handler.common.config_edn.detect_deprecations = (function frontend$handler$common$config_edn$detect_deprecations(path,content){
var body = (function (){try{return clojure.edn.read_string.cljs$core$IFn$_invoke$arity$1(content);
}catch (e86845){var _ = e86845;
...
var warnings = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("editor","command-trigger","editor/command-trigger",1018337295),"is no longer supported. Please use '/' and report bugs on it."], null);
...
var temp__5804__auto__ = cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__86844_SHARP_){
if(cljs.core.truth_((function (){var G__86846 = cljs.core.key(p1__86844_SHARP_);
return (body.cljs$core$IFn$_invoke$arity$1 ? body.cljs$core$IFn$_invoke$arity$1(G__86846) : body.call(null,G__86846));
})())){
return p1__86844_SHARP_;
} else {
return null;
}
}),warnings));
