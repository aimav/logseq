...
(instaparse.line_col.Cursor.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k125751,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__125767 = k125751;
var G__125767__$1 = (((G__125767 instanceof cljs.core.Keyword))?G__125767.fqn:null);
switch (G__125767__$1) {
case "index":
return self__.index;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k125751,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__125769){
var vec__125770 = p__125769;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125770,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125770,(1),null);
...
(instaparse.line_col.Cursor.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__125750){
var self__ = this;
var G__125750__$1 = this;
return (new cljs.core.RecordIter((0),G__125750__$1,3,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"index","index",-1531685915),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this125752,other125753){
var self__ = this;
var this125752__$1 = this;
return (((!((other125753 == null)))) && ((((this125752__$1.constructor === other125753.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this125752__$1.index,other125753.index)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this125752__$1.line,other125753.line)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this125752__$1.column,other125753.column)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this125752__$1.__extmap,other125753.__extmap)))))))))));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k125751){
var self__ = this;
var this__5347__auto____$1 = this;
var G__125821 = k125751;
var G__125821__$1 = (((G__125821 instanceof cljs.core.Keyword))?G__125821.fqn:null);
switch (G__125821__$1) {
case "index":
case "line":
case "column":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k125751);

}
}));

(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__125750){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__125823 = cljs.core.keyword_identical_QMARK_;
var expr__125824 = k__5349__auto__;
if(cljs.core.truth_((pred__125823.cljs$core$IFn$_invoke$arity$2 ? pred__125823.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"index","index",-1531685915),expr__125824) : pred__125823.call(null,new cljs.core.Keyword(null,"index","index",-1531685915),expr__125824)))){
return (new instaparse.line_col.Cursor(G__125750,self__.line,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__125823.cljs$core$IFn$_invoke$arity$2 ? pred__125823.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"line","line",212345235),expr__125824) : pred__125823.call(null,new cljs.core.Keyword(null,"line","line",212345235),expr__125824)))){
return (new instaparse.line_col.Cursor(self__.index,G__125750,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__125823.cljs$core$IFn$_invoke$arity$2 ? pred__125823.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"column","column",2078222095),expr__125824) : pred__125823.call(null,new cljs.core.Keyword(null,"column","column",2078222095),expr__125824)))){
return (new instaparse.line_col.Cursor(self__.index,self__.line,G__125750,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__125750),null));
}
}
}
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__125750){
var self__ = this;
var this__5339__auto____$1 = this;
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,G__125750,self__.__extmap,self__.__hash));
}));
 ...
 */
instaparse.line_col.map__GT_Cursor = (function instaparse$line_col$map__GT_Cursor(G__125754){
var extmap__5382__auto__ = (function (){var G__125826 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__125754,new cljs.core.Keyword(null,"index","index",-1531685915),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], 0));
if(cljs.core.record_QMARK_(G__125754)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__125826);
} else {
return G__125826;
}
})();
return (new instaparse.line_col.Cursor(new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(G__125754),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(G__125754),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(G__125754),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
...
var G__125829 = (index + (1));
var G__125830 = (line + (1));
var G__125831 = (1);
index = G__125829;
line = G__125830;
column = G__125831;
...
var G__125832 = (index + (1));
var G__125833 = line;
var G__125834 = (column + (1));
index = G__125832;
line = G__125833;
column = G__125834;
continue;
