 ...
 */
cljs_time.local._STAR_local_formatters_STAR_ = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__69229){
var vec__69230 = p__69229;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69230,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69230,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(f)),new cljs.core.Keyword("fmt","formatter","fmt/formatter",-483947944)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(f,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"parser","parser",-1543495310)], null),(function (p1__69228_SHARP_){
return cljs_time.core.to_default_time_zone(p1__69228_SHARP_);
})):f)], null);
...
var cljs_time$local$ILocalCoerce$to_local_date_time$dyn_69239 = (function (obj){
...
return cljs_time$local$ILocalCoerce$to_local_date_time$dyn_69239(obj);
}
});
...
return cljs.core.first((function (){var iter__5520__auto__ = (function cljs_time$local$from_local_string_$_iter__69233(s__69234){
return (new cljs.core.LazySeq(null,(function (){
var s__69234__$1 = s__69234;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__69234__$1);
if(temp__5804__auto__){
var s__69234__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__69234__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__69234__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__69236 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__69235 = (0);
while(true){
if((i__69235 < size__5519__auto__)){
var f = cljs.core._nth(c__5518__auto__,i__69235);
...
cljs.core.chunk_append(b__69236,d);

var G__69240 = (i__69235 + (1));
i__69235 = G__69240;
continue;
} else {
var G__69241 = (i__69235 + (1));
i__69235 = G__69241;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__69236),cljs_time$local$from_local_string_$_iter__69233(cljs.core.chunk_rest(s__69234__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__69236),null);
}
} else {
var f = cljs.core.first(s__69234__$2);
var d = (function (){try{return cljs_time.format.parse.cljs$core$IFn$_invoke$arity$2(f,s);
...
if(cljs.core.truth_(d)){
return cljs.core.cons(d,cljs_time$local$from_local_string_$_iter__69233(cljs.core.rest(s__69234__$2)));
} else {
var G__69242 = cljs.core.rest(s__69234__$2);
s__69234__$1 = G__69242;
continue;
}
}
} else {
