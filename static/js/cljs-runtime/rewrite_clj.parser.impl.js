...
if((c === "\n")){
var G__88305 = escape_QMARK_;
var G__88306 = rewrite_clj.parser.impl.flush_into(lines,buf);
escape_QMARK_ = G__88305;
lines = G__88306;
continue;
} else {
buf.append(c);

var G__88307 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__88308 = lines;
escape_QMARK_ = G__88307;
lines = G__88308;
continue;
