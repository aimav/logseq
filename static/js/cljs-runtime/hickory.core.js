...
var hickory$core$HiccupRepresentable$as_hiccup$dyn_108684 = (function (this$){
...
return hickory$core$HiccupRepresentable$as_hiccup$dyn_108684(this$);
}
});
...
var hickory$core$HickoryRepresentable$as_hickory$dyn_108685 = (function (this$){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
return hickory$core$HickoryRepresentable$as_hickory$dyn_108685(this$);
}
});
...
var pred__108678 = cljs.core._EQ_;
var expr__108679 = (this$["nodeType"]);
if(cljs.core.truth_((pred__108678.cljs$core$IFn$_invoke$arity$2 ? pred__108678.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__108679) : pred__108678.call(null,hickory.core.Attribute,expr__108679)))){
...
if(cljs.core.truth_((pred__108678.cljs$core$IFn$_invoke$arity$2 ? pred__108678.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__108679) : pred__108678.call(null,hickory.core.Comment,expr__108679)))){
return ["<!--",cljs.core.str.cljs$core$IFn$_invoke$arity$1((this$["data"])),"-->"].join('');
} else {
if(cljs.core.truth_((pred__108678.cljs$core$IFn$_invoke$arity$2 ? pred__108678.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__108679) : pred__108678.call(null,hickory.core.Document,expr__108679)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,hickory.core.as_seq((this$["childNodes"])));
} else {
if(cljs.core.truth_((pred__108678.cljs$core$IFn$_invoke$arity$2 ? pred__108678.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__108679) : pred__108678.call(null,hickory.core.DocumentType,expr__108679)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__108678.cljs$core$IFn$_invoke$arity$2 ? pred__108678.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__108679) : pred__108678.call(null,hickory.core.Element,expr__108679)))){
...
if(cljs.core.truth_((pred__108678.cljs$core$IFn$_invoke$arity$2 ? pred__108678.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__108679) : pred__108678.call(null,hickory.core.Text,expr__108679)))){
return hickory.utils.html_escape(goog.dom.getRawTextContent(this$));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__108679)].join('')));
}
}
}
}
...
var pred__108681 = cljs.core._EQ_;
var expr__108682 = (this$["nodeType"]);
if(cljs.core.truth_((pred__108681.cljs$core$IFn$_invoke$arity$2 ? pred__108681.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__108682) : pred__108681.call(null,hickory.core.Attribute,expr__108682)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__108681.cljs$core$IFn$_invoke$arity$2 ? pred__108681.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__108682) : pred__108681.call(null,hickory.core.Comment,expr__108682)))){
...
if(cljs.core.truth_((pred__108681.cljs$core$IFn$_invoke$arity$2 ? pred__108681.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__108682) : pred__108681.call(null,hickory.core.Document,expr__108682)))){
...
if(cljs.core.truth_((pred__108681.cljs$core$IFn$_invoke$arity$2 ? pred__108681.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__108682) : pred__108681.call(null,hickory.core.DocumentType,expr__108682)))){
...
if(cljs.core.truth_((pred__108681.cljs$core$IFn$_invoke$arity$2 ? pred__108681.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__108682) : pred__108681.call(null,hickory.core.Element,expr__108682)))){
...
if(cljs.core.truth_((pred__108681.cljs$core$IFn$_invoke$arity$2 ? pred__108681.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__108682) : pred__108681.call(null,hickory.core.Text,expr__108682)))){
return goog.dom.getRawTextContent(this$);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__108682)].join('')));
}
}
}
}
...
var temp__5804__auto__ = cljs.core.second((function (){var or__5043__auto__ = cljs.core.re_find(/<!DOCTYPE ([^>]*)>/,s);
...
var temp__5804__auto___108686 = (doc["head"]["firstChild"]);
if(cljs.core.truth_(temp__5804__auto___108686)){
var title_el_108687 = temp__5804__auto___108686;
if(cljs.core.empty_QMARK_((title_el_108687["text"]))){
hickory.core.remove_el(title_el_108687);
} else {
}
} else {
}
