...
var scheduled = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__69567_SHARP_){
return clojure.string.starts_with_QMARK_(p1__69567_SHARP_,"SCHEDULED");
}),lines);
var deadline = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__69568_SHARP_){
return clojure.string.starts_with_QMARK_(p1__69568_SHARP_,"DEADLINE");
}),lines);
var body_without_timestamps = cljs.core.vec(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__69569_SHARP_){
return (!(((clojure.string.starts_with_QMARK_(p1__69569_SHARP_,"SCHEDULED")) || (clojure.string.starts_with_QMARK_(p1__69569_SHARP_,"DEADLINE")))));
}),body));
var start_idx = body_without_timestamps.indexOf(frontend.util.drawer.drawer_start(typ));
var end_idx = (function (){var vec__69571 = cljs.core.split_at(start_idx,body_without_timestamps);
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69571,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69571,(1),null);
...
var lines = clojure.string.split_lines(content);
var vec__69574 = cljs.core.split_with((function (l){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(l)),":LOGBOOK:")));
}),lines);
var title_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69574,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69574,(1),null);
