...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__90061_SHARP_){
var G__90062 = rewrite_clj.custom_zipper.core.node(p1__90061_SHARP_);
if((!((G__90062 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__90062.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__90062.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__90062);
} else {
return false;
}
}
...
var nsmap = (cljs.core.truth_((function (){var and__5041__auto__ = parent;
...
if(cljs.core.truth_((function (){var and__5041__auto__ = nsmap;
if(cljs.core.truth_(and__5041__auto__)){
