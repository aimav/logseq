...
else return reporter.error("Invalid arguments. Must be a DOM element or a collection of DOM elements.");var elementsReady=0,callOnAdd=getOption(options,"callOnAdd",JSCompiler_object_inline_callOnAdd_4176),onReadyCallback=getOption(options,"onReady",function(){}),debug=getOption(options,"debug",JSCompiler_object_inline_debug_4177);forEach(elements,function(element$jscomp$0){stateHandler.getState(element$jscomp$0)||(stateHandler.initState(element$jscomp$0),idHandler.set(element$jscomp$0));var id=idHandler.get(element$jscomp$0);
