...
return frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$6(content,status,clear_QMARK_,null,(1500),null);
}));

(frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$4 = (function (content,status,clear_QMARK_,uid){
return frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$6(content,status,clear_QMARK_,uid,(1500),null);
}));
