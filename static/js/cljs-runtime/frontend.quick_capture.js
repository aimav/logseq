...
return cljs.core.re_matches(/^https:\/\/twitter\.com\/.*?\/status\/.*?$/,url);
} else {
return null;
}
});
frontend.quick_capture.quick_capture = (function frontend$quick_capture$quick_capture(args){
var map__117599 = cljs_bean.core.__GT_clj(args);
var map__117599__$1 = cljs.core.__destructure_map(map__117599);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__117599__$1,new cljs.core.Keyword(null,"url","url",276297046));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__117599__$1,new cljs.core.Keyword(null,"title","title",636505583));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__117599__$1,new cljs.core.Keyword(null,"content","content",15833224));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__117599__$1,new cljs.core.Keyword(null,"page","page",849072397));
var append = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__117599__$1,new cljs.core.Keyword(null,"append","append",-291298229));
var title__$1 = (function (){var or__5043__auto__ = title;
...
var url__$1 = (function (){var or__5043__auto__ = url;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return "";
...
var page__$1 = (cljs.core.truth_((function (){var and__5041__auto__ = frontend.state.enable_journals_QMARK_.cljs$core$IFn$_invoke$arity$0();
if(cljs.core.truth_(and__5041__auto__)){
var or__5043__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page,"TODAY");
if(or__5043__auto__){
return or__5043__auto__;
} else {
var and__5041__auto____$1 = clojure.string.blank_QMARK_(page);
...
var text = (function (){var or__5043__auto__ = (function (){var and__5041__auto__ = content;
if(cljs.core.truth_(and__5041__auto__)){
...
if(cljs.core.truth_(and__5041__auto__)){
return ((cljs.core.not(append)) && (cljs.core.not(edit_content_include_capture_QMARK_)));
} else {
return and__5041__auto__;
}
})())){
...
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(page__$1,frontend.state.get_current_page())){
frontend.handler.page.create_BANG_.cljs$core$IFn$_invoke$arity$2(page__$1,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"redirect?","redirect?",-1229259098),redirect_page_QMARK_], null));
} else {
}
