...
var G__43995 = devtools.prefs.pref(v);
v = G__43995;
continue;
} else {
return v;
...
var and__5041__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__5041__auto__){
var and__5041__auto____$1 = (!(cljs.core.var_QMARK_(value)));
...
var or__5043__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e43984){var _e__42258__auto__ = e43984;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var or__5043__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e43986){var _e__42258__auto__ = e43986;
return false;
}})();
...
}catch (e43988){var _e__42258__auto__ = e43988;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__5041__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__5041__auto__)){
var and__5041__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_(f)));
if(and__5041__auto____$1){
...
var and__5041__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__5041__auto__)){
...
var or__5043__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var and__5041__auto__ = (function (){var or__5043__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var vec__43990 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43990,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43990,(1),null);
...
var and__5041__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__5041__auto__)){
...
return cljs.core.some((function (p1__43993_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43993_SHARP_);
}),template);
});
