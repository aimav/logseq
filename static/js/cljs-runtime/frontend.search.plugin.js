...
var G__101871 = arguments.length;
switch (G__101871) {
case 3:
...
var map__101872 = service;
var map__101872__$1 = cljs.core.__destructure_map(map__101872);
var pid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101872__$1,new cljs.core.Keyword(null,"pid","pid",1018387698));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101872__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
return frontend.state.update_plugin_search_engine(pid,name,(function (p1__101869_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__101869_SHARP_,new cljs.core.Keyword(null,"result","result",1415092211),cljs_bean.core.__GT_clj(e));
}));
}));
} else {
return null;
...
(frontend.search.plugin.Plugin.prototype.frontend$search$protocol$Engine$query_page$arity$3 = (function (_this,q,opts){
var self__ = this;
var _this__$1 = this;
return frontend.search.plugin.call_service_BANG_.cljs$core$IFn$_invoke$arity$4(self__.service,"search:queryPage",cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"q","q",689001697),q], null),opts], 0)),true);
}));
...
var self__ = this;
var _this__$1 = this;
var map__101873 = data;
var map__101873__$1 = cljs.core.__destructure_map(map__101873);
var blocks_to_remove_set = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101873__$1,new cljs.core.Keyword(null,"blocks-to-remove-set","blocks-to-remove-set",266406009));
var blocks_to_add = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101873__$1,new cljs.core.Keyword(null,"blocks-to-add","blocks-to-add",-814061792));
...
(frontend.search.plugin.Plugin.prototype.frontend$search$protocol$Engine$transact_pages_BANG_$arity$2 = (function (_this,data){
var self__ = this;
var _this__$1 = this;
var map__101874 = data;
var map__101874__$1 = cljs.core.__destructure_map(map__101874);
var pages_to_remove_set = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101874__$1,new cljs.core.Keyword(null,"pages-to-remove-set","pages-to-remove-set",-722220438));
var pages_to_add = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101874__$1,new cljs.core.Keyword(null,"pages-to-add","pages-to-add",-707496279));
return frontend.search.plugin.call_service_BANG_.cljs$core$IFn$_invoke$arity$3(self__.service,"search:transactpages",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"added","added",2057651688),pages_to_add,new cljs.core.Keyword(null,"removed","removed",609626430),pages_to_remove_set], null)], null));
}));
...
(frontend.search.plugin.Plugin.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"frontend.search.plugin/Plugin");
}));
