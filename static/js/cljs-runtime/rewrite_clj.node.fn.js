...
var sym_seq = (function (){var iter__5520__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__87350(s__87351){
return (new cljs.core.LazySeq(null,(function (){
var s__87351__$1 = s__87351;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__87351__$1);
if(temp__5804__auto__){
var s__87351__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__87351__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__87351__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__87353 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__87352 = (0);
while(true){
if((i__87352 < size__5519__auto__)){
var i = cljs.core._nth(c__5518__auto__,i__87352);
...
cljs.core.chunk_append(b__87353,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__87379 = (i__87352 + (1));
i__87352 = G__87379;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__87353),rewrite_clj$node$fn$fn_walk_$_iter__87350(cljs.core.chunk_rest(s__87351__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__87353),null);
}
} else {
var i = cljs.core.first(s__87351__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__87350(cljs.core.rest(s__87351__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__87349_SHARP_){
var or__5043__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__87349_SHARP_);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return p1__87349_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k87355,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__87363 = k87355;
var G__87363__$1 = (((G__87363 instanceof cljs.core.Keyword))?G__87363.fqn:null);
switch (G__87363__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k87355,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__87364){
var vec__87365 = p__87364;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87365,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87365,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__87354){
var self__ = this;
var G__87354__$1 = this;
return (new cljs.core.RecordIter((0),G__87354__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this87356,other87357){
var self__ = this;
var this87356__$1 = this;
return (((!((other87357 == null)))) && ((((this87356__$1.constructor === other87357.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this87356__$1.children,other87357.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this87356__$1.__extmap,other87357.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k87355){
var self__ = this;
var this__5347__auto____$1 = this;
var G__87371 = k87355;
var G__87371__$1 = (((G__87371 instanceof cljs.core.Keyword))?G__87371.fqn:null);
switch (G__87371__$1) {
case "children":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k87355);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__87354){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__87373 = cljs.core.keyword_identical_QMARK_;
var expr__87374 = k__5349__auto__;
if(cljs.core.truth_((pred__87373.cljs$core$IFn$_invoke$arity$2 ? pred__87373.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__87374) : pred__87373.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__87374)))){
return (new rewrite_clj.node.fn.FnNode(G__87354,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__87354),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__87354){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__87354,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__87358){
var extmap__5382__auto__ = (function (){var G__87376 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__87358,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__87358)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__87376);
} else {
return G__87376;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__87358),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
