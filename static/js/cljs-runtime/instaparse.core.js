...
if(cljs.core.truth_((function (){var fexpr__126106 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__126106.cljs$core$IFn$_invoke$arity$1 ? fexpr__126106.cljs$core$IFn$_invoke$arity$1(type) : fexpr__126106.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__126107 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__126107.cljs$core$IFn$_invoke$arity$1 ? fexpr__126107.cljs$core$IFn$_invoke$arity$1(type) : fexpr__126107.call(null,type));
})())){
} else {
...
var G__126108 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__126108)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__126108)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__126108)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__126108)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__126108)].join('')));
...
var len__5766__auto___126146 = arguments.length;
var i__5767__auto___126147 = (0);
while(true){
if((i__5767__auto___126147 < len__5766__auto___126146)){
args__5772__auto__.push((arguments[i__5767__auto___126147]));

var G__126148 = (i__5767__auto___126147 + (1));
i__5767__auto___126147 = G__126148;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__126112){
var map__126113 = p__126112;
var map__126113__$1 = cljs.core.__destructure_map(map__126113);
var options = map__126113__$1;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__126114 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__126114) : instaparse.reduction.node_builders.call(null,G__126114));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq126109){
var G__126110 = cljs.core.first(seq126109);
var seq126109__$1 = cljs.core.next(seq126109);
var G__126111 = cljs.core.first(seq126109__$1);
var seq126109__$2 = cljs.core.next(seq126109__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__126110,G__126111,seq126109__$2);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___126149 = arguments.length;
var i__5767__auto___126150 = (0);
while(true){
if((i__5767__auto___126150 < len__5766__auto___126149)){
args__5772__auto__.push((arguments[i__5767__auto___126150]));

var G__126151 = (i__5767__auto___126150 + (1));
i__5767__auto___126150 = G__126151;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__126118){
var map__126119 = p__126118;
var map__126119__$1 = cljs.core.__destructure_map(map__126119);
var options = map__126119__$1;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"unhide","unhide",-413983695)))){
} else {
throw (new Error("Assert failed: (contains? #{nil :tags :content :all} (get options :unhide))"));
}
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__126120 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__126120) : instaparse.reduction.node_builders.call(null,G__126120));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq126115){
var G__126116 = cljs.core.first(seq126115);
var seq126115__$1 = cljs.core.next(seq126115);
var G__126117 = cljs.core.first(seq126115__$1);
var seq126115__$2 = cljs.core.next(seq126115__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__126116,G__126117,seq126115__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k126122,else__5343__auto__){
var self__ = this;
var this__5342__auto____$1 = this;
var G__126127 = k126122;
var G__126127__$1 = (((G__126127 instanceof cljs.core.Keyword))?G__126127.fqn:null);
switch (G__126127__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k126122,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__126128){
var vec__126129 = p__126128;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126129,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126129,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this126123,other126124){
var self__ = this;
var this126123__$1 = this;
return (((!((other126124 == null)))) && ((((this126123__$1.constructor === other126124.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this126123__$1.grammar,other126124.grammar)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this126123__$1.start_production,other126124.start_production)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this126123__$1.output_format,other126124.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this126123__$1.__extmap,other126124.__extmap)))))))))));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k126122){
var self__ = this;
var this__5347__auto____$1 = this;
var G__126132 = k126122;
var G__126132__$1 = (((G__126132 instanceof cljs.core.Keyword))?G__126132.fqn:null);
switch (G__126132__$1) {
case "grammar":
case "start-production":
case "output-format":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k126122);

}
}));

(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__126121){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__126133 = cljs.core.keyword_identical_QMARK_;
var expr__126134 = k__5349__auto__;
if(cljs.core.truth_((pred__126133.cljs$core$IFn$_invoke$arity$2 ? pred__126133.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__126134) : pred__126133.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__126134)))){
return (new instaparse.core.Parser(G__126121,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__126133.cljs$core$IFn$_invoke$arity$2 ? pred__126133.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__126134) : pred__126133.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__126134)))){
return (new instaparse.core.Parser(self__.grammar,G__126121,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__126133.cljs$core$IFn$_invoke$arity$2 ? pred__126133.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__126134) : pred__126133.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__126134)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__126121,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__126121),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__126121){
var self__ = this;
var this__5339__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__126121,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.call = (function (unused__11814__auto__){
var self__ = this;
var self__ = this;
var G__126136 = (arguments.length - (1));
switch (G__126136) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args126126){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args126126)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__126125){
var extmap__5382__auto__ = (function (){var G__126137 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__126125,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__126125)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__126137);
} else {
return G__126137;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__126125),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__126125),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__126125),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
...
var args__5772__auto__ = [];
var len__5766__auto___126155 = arguments.length;
var i__5767__auto___126156 = (0);
while(true){
if((i__5767__auto___126156 < len__5766__auto___126155)){
args__5772__auto__.push((arguments[i__5767__auto___126156]));

var G__126157 = (i__5767__auto___126156 + (1));
i__5767__auto___126156 = G__126157;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__126140){
var map__126141 = p__126140;
var map__126141__$1 = cljs.core.__destructure_map(map__126141);
var options = map__126141__$1;
...
var _STAR_case_insensitive_literals_STAR__orig_val__126142 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__126143 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__126143);

try{var G__126144 = input_format;
var G__126144__$1 = (((G__126144 instanceof cljs.core.Keyword))?G__126144.fqn:null);
switch (G__126144__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__126144__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__126142);
}});
...
var map__126145 = temp__5802__auto__;
var map__126145__$1 = cljs.core.__destructure_map(map__126145);
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__126145__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__126145__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq126138){
var G__126139 = cljs.core.first(seq126138);
var seq126138__$1 = cljs.core.next(seq126138);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__126139,seq126138__$1);
}));
