...
return clojure.zip.up(clojure.zip.edit(clojure.zip.down(loc),(function (p1__113941_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__113941_SHARP_,new cljs.core.Keyword(null,"text","text",-1790561697),cljs.core.str,text);
})));
});
/**
...
var vec__113942 = hiccup;
var seq__113943 = cljs.core.seq(vec__113942);
var first__113944 = cljs.core.first(seq__113943);
var seq__113943__$1 = cljs.core.next(seq__113943);
var _ = first__113944;
var first__113944__$1 = cljs.core.first(seq__113943__$1);
var seq__113943__$2 = cljs.core.next(seq__113943__$1);
var ___$1 = first__113944__$1;
var body = seq__113943__$2;
...
var _STAR_opml_state_STAR__orig_val__113945 = frontend.handler.export$.opml._STAR_opml_state_STAR_;
var _STAR_opml_state_STAR__temp_val__113946 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.opml._STAR_opml_state_STAR_,new cljs.core.Keyword(null,"outside-em-symbol","outside-em-symbol",478063381),cljs.core.first(em_symbol));
(frontend.handler.export$.opml._STAR_opml_state_STAR_ = _STAR_opml_state_STAR__temp_val__113946);
...
}finally {(frontend.handler.export$.opml._STAR_opml_state_STAR_ = _STAR_opml_state_STAR__orig_val__113945);
}});
frontend.handler.export$.opml.inline_emphasis = (function frontend$handler$export$opml$inline_emphasis(p__113947){
var vec__113948 = p__113947;
var vec__113951 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113948,(0),null);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113951,(0),null);
var inline_coll = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113948,(1),null);
...
break;
case "Underline":
var _STAR_opml_state_STAR__orig_val__113955 = frontend.handler.export$.opml._STAR_opml_state_STAR_;
var _STAR_opml_state_STAR__temp_val__113956 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.opml._STAR_opml_state_STAR_,new cljs.core.Keyword(null,"outside-em-symbol","outside-em-symbol",478063381),outside_em_symbol);
(frontend.handler.export$.opml._STAR_opml_state_STAR_ = _STAR_opml_state_STAR__temp_val__113956);
...
}finally {(frontend.handler.export$.opml._STAR_opml_state_STAR_ = _STAR_opml_state_STAR__orig_val__113955);
}
break;
case "Strike_through":
...
frontend.handler.export$.opml.inline_link = (function frontend$handler$export$opml$inline_link(p__113957){
var map__113958 = p__113957;
var map__113958__$1 = cljs.core.__destructure_map(map__113958);
var full_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113958__$1,new cljs.core.Keyword(null,"full_text","full_text",1634289075));
...
frontend.handler.export$.opml.inline_nested_link = (function frontend$handler$export$opml$inline_nested_link(p__113959){
var map__113960 = p__113959;
var map__113960__$1 = cljs.core.__destructure_map(map__113960);
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113960__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
frontend.handler.export$.opml.inline_footnote_reference = (function frontend$handler$export$opml$inline_footnote_reference(p__113961){
var map__113962 = p__113961;
var map__113962__$1 = cljs.core.__destructure_map(map__113962);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113962__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.handler.export$.common.raw_text.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__113963 = cljs.core.first(ast_content);
switch (G__113963) {
case "Absolute":
var vec__113964 = ast_content;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113964,(0),null);
var current = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113964,(1),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113964,(2),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__113963)].join('')));
...
var vec__113967 = ast_content;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113967,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113967,(1),null);
var wrapper = (function (){var G__113970 = type;
switch (G__113970) {
case "Inline":
return "$";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__113970)].join('')));
...
frontend.handler.export$.opml.inline_macro = (function frontend$handler$export$opml$inline_macro(p__113971){
var map__113972 = p__113971;
var map__113972__$1 = cljs.core.__destructure_map(map__113972);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113972__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var arguments$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113972__$1,new cljs.core.Keyword(null,"arguments","arguments",-1182834456));
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[frontend.handler.export$.common.raw_text.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name,"cloze"))?clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",arguments$):(function (){var l = (function (){var G__113973 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["{{",name], null);
var G__113973__$1 = (((cljs.core.count(arguments$) > (0)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(G__113973,"(",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",arguments$),")"], 0)):G__113973);
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__113973__$1,"}}");

})();
return clojure.string.join.cljs$core$IFn$_invoke$arity$1(l);
})())], 0))],null));
});
frontend.handler.export$.opml.inline_entity = (function frontend$handler$export$opml$inline_entity(p__113974){
var map__113975 = p__113974;
var map__113975__$1 = cljs.core.__destructure_map(map__113975);
var unicode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113975__$1,new cljs.core.Keyword(null,"unicode","unicode",-542572710));
...
var vec__113976 = ast_content;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113976,(0),null);
var timestamp_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113976,(1),null);
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[frontend.handler.export$.common.raw_text.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var G__113979 = type;
switch (G__113979) {
case "Scheduled":
...
break;
case "Range":
var map__113980 = timestamp_content;
var map__113980__$1 = cljs.core.__destructure_map(map__113980);
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113980__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113980__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__113979)].join('')));

}
})())], 0))],null));
});
frontend.handler.export$.opml.inline_email = (function frontend$handler$export$opml$inline_email(p__113981){
var map__113982 = p__113981;
var map__113982__$1 = cljs.core.__destructure_map(map__113982);
var local_part = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113982__$1,new cljs.core.Keyword(null,"local_part","local_part",-1705904558));
var domain = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113982__$1,new cljs.core.Keyword(null,"domain","domain",1847214937));
...
var vec__113983 = inline;
var ast_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113983,(0),null);
var ast_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113983,(1),null);
var G__113986 = ast_type;
switch (G__113986) {
case "Emphasis":
...
frontend.handler.export$.opml.block_heading = (function frontend$handler$export$opml$block_heading(loc,p__113988){
var map__113989 = p__113988;
var map__113989__$1 = cljs.core.__destructure_map(map__113989);
var _meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"_meta","_meta",937543236));
var marker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"marker","marker",865118313));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _anchor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"_anchor","_anchor",-1041309458));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"title","title",636505583));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var priority = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"priority","priority",1431093715));
var _tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"_tags","_tags",58828915));
var _numbering = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"_numbering","_numbering",1825467892));
var _unordered = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113989__$1,new cljs.core.Keyword(null,"_unordered","_unordered",1249595382));
...
var simple_asts__$1 = cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__113987_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__113987_SHARP_,frontend.handler.export$.common.space);
}),simple_asts);
...
frontend.handler.export$.opml.block_list_item = (function frontend$handler$export$opml$block_list_item(loc,p__113990){
var map__113991 = p__113990;
var map__113991__$1 = cljs.core.__destructure_map(map__113991);
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113991__$1,new cljs.core.Keyword(null,"content","content",15833224));
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113991__$1,new cljs.core.Keyword(null,"items","items",1031954938));
...
frontend.handler.export$.opml.block_src = (function frontend$handler$export$opml$block_src(loc,p__113992){
var map__113993 = p__113992;
var map__113993__$1 = cljs.core.__destructure_map(map__113993);
var _language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113993__$1,new cljs.core.Keyword(null,"_language","_language",460812073));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__113993__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
...
frontend.handler.export$.opml.block_latex_env = (function frontend$handler$export$opml$block_latex_env(loc,p__113994){
var vec__113995 = p__113994;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113995,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113995,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113995,(2),null);
...
frontend.handler.export$.opml.block_footnote_definition = (function frontend$handler$export$opml$block_footnote_definition(loc,p__113998){
var vec__113999 = p__113998;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113999,(0),null);
var inline_coll = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__113999,(1),null);
...
var vec__114002 = block_ast;
var ast_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114002,(0),null);
var ast_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__114002,(1),null);
var G__114005 = ast_type;
switch (G__114005) {
case "Paragraph":
...
var len__5766__auto___114027 = arguments.length;
var i__5767__auto___114028 = (0);
while(true){
if((i__5767__auto___114028 < len__5766__auto___114027)){
args__5772__auto__.push((arguments[i__5767__auto___114028]));

var G__114029 = (i__5767__auto___114028 + (1));
i__5767__auto___114028 = G__114029;
continue;
} else {
}
break;
...
return frontend.handler.export$.opml.export_helper.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__5773__auto__);
});

(frontend.handler.export$.opml.export_helper.cljs$core$IFn$_invoke$arity$variadic = (function (content,format,options,p__114010){
var map__114011 = p__114010;
var map__114011__$1 = cljs.core.__destructure_map(map__114011);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__114011__$1,new cljs.core.Keyword(null,"title","title",636505583),"untitled");
...
var config_for_walk_block_ast = (function (){var G__114016 = cljs.core.PersistentArrayMap.EMPTY;
var G__114016__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"remove-emphasis?","remove-emphasis?",-1751965539)], null)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__114016,new cljs.core.Keyword(null,"mapcat-fns-on-inline-ast","mapcat-fns-on-inline-ast",-988900078),cljs.core.conj,frontend.handler.export$.common.remove_emphasis):G__114016);
var G__114016__$2 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"remove-page-ref-brackets?","remove-page-ref-brackets?",-276534720)], null)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__114016__$1,new cljs.core.Keyword(null,"map-fns-on-inline-ast","map-fns-on-inline-ast",-1834139513),cljs.core.conj,frontend.handler.export$.common.remove_page_ref_brackets):G__114016__$1);
var G__114016__$3 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"remove-tags?","remove-tags?",690905372)], null)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__114016__$2,new cljs.core.Keyword(null,"mapcat-fns-on-inline-ast","mapcat-fns-on-inline-ast",-988900078),cljs.core.conj,frontend.handler.export$.common.remove_tags):G__114016__$2);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("no-indent",cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"indent-style","indent-style",855468755)], null)))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__114016__$3,new cljs.core.Keyword(null,"mapcat-fns-on-inline-ast","mapcat-fns-on-inline-ast",-988900078),cljs.core.conj,frontend.handler.export$.common.remove_prefix_spaces_in_Plain);
} else {
return G__114016__$3;
}
})();
...
}finally {(frontend.handler.export$.opml._STAR_opml_state_STAR_ = _STAR_opml_state_STAR__orig_val__114013);

(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__orig_val__114012);
}}));

(frontend.handler.export$.opml.export_helper.cljs$lang$maxFixedArity = (3));

/** @this {Function} */
(frontend.handler.export$.opml.export_helper.cljs$lang$applyTo = (function (seq114006){
var G__114007 = cljs.core.first(seq114006);
var seq114006__$1 = cljs.core.next(seq114006);
var G__114008 = cljs.core.first(seq114006__$1);
var seq114006__$2 = cljs.core.next(seq114006__$1);
var G__114009 = cljs.core.first(seq114006__$2);
var seq114006__$3 = cljs.core.next(seq114006__$2);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__114007,G__114008,G__114009,seq114006__$3);
}));

/**
 * options: see also `export-blocks-as-markdown`
 */
frontend.handler.export$.opml.export_blocks_as_opml = (function frontend$handler$export$opml$export_blocks_as_opml(repo,root_block_uuids_or_page_name,options){
...
var k__62654__auto__ = new cljs.core.Keyword(null,"export-blocks-as-opml","export-blocks-as-opml",-1592224678);
...
var title = ((typeof root_block_uuids_or_page_name === 'string')?root_block_uuids_or_page_name:"untitled");
var first_block = (function (){var G__114017 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.first(root_block_uuids_or_page_name)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__114017) : frontend.db.entity.call(null,G__114017));
})();
...
var title = ((typeof root_block_uuids_or_page_name === 'string')?root_block_uuids_or_page_name:"untitled");
var first_block = (function (){var G__114018 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.first(root_block_uuids_or_page_name)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__114018) : frontend.db.entity.call(null,G__114018));
})();
var format = (function (){var or__5043__auto__ = new cljs.core.Keyword("block","format","block/format",-1212045901).cljs$core$IFn$_invoke$arity$1(first_block);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__114019){
var map__114020 = p__114019;
var map__114020__$1 = cljs.core.__destructure_map(map__114020);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114020__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114020__$1,new cljs.core.Keyword(null,"content","content",15833224));
var names = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114020__$1,new cljs.core.Keyword(null,"names","names",-1943074658));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__114020__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
if(cljs.core.truth_(cljs.core.first(names))){
if(cljs.core.truth_(goog.DEBUG)){
var k__62654__auto__ = cljs.core.print_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"export-files-as-opml","export-files-as-opml",2137421559),path], 0));
console.time(k__62654__auto__);

var res__62655__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [path,frontend.handler.export$.opml.export_helper.cljs$core$IFn$_invoke$arity$variadic(content,format,options,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"title","title",636505583),cljs.core.first(names)], 0))], null);
console.timeEnd(k__62654__auto__);
...
var temp__5804__auto__ = frontend.handler.export$.common.get_file_contents_with_suffix(repo);
if(cljs.core.truth_(temp__5804__auto__)){
var files = temp__5804__auto__;
var files__$1 = frontend.handler.export$.opml.export_files_as_opml(files,null);
var zip_file_name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(repo),"_opml_",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.quot(frontend.util.time_ms(),(1000)))].join('');
...
return promesa.protocols._promise((function (){var temp__5804__auto____$1 = goog.dom.getElement("export-as-opml");
