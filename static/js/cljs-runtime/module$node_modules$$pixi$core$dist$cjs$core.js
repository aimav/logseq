...
(this.depthTexture.destroy(),this.depthTexture=null,++this.dirtyId,++this.dirtyFormat)};return Framebuffer}(),BaseRenderTexture=function(_super){function BaseRenderTexture(options,JSCompiler_OptimizeArgumentsArray_p0,JSCompiler_OptimizeArgumentsArray_p1,JSCompiler_OptimizeArgumentsArray_p2){"number"===typeof options&&(options={width:options,height:JSCompiler_OptimizeArgumentsArray_p0,scaleMode:JSCompiler_OptimizeArgumentsArray_p1,resolution:JSCompiler_OptimizeArgumentsArray_p2});options.width=options.width||
100;options.height=options.height||100;options.multisample=void 0!==options.multisample?options.multisample:constants.MSAA_QUALITY.NONE;JSCompiler_OptimizeArgumentsArray_p0=_super.call(this,null,options)||this;JSCompiler_OptimizeArgumentsArray_p0.mipmap=constants.MIPMAP_MODES.OFF;JSCompiler_OptimizeArgumentsArray_p0.valid=!0;JSCompiler_OptimizeArgumentsArray_p0.clearColor=[0,0,0,0];JSCompiler_OptimizeArgumentsArray_p0.framebuffer=(new Framebuffer(JSCompiler_OptimizeArgumentsArray_p0.realWidth,JSCompiler_OptimizeArgumentsArray_p0.realHeight)).addColorTexture(0,
JSCompiler_OptimizeArgumentsArray_p0);JSCompiler_OptimizeArgumentsArray_p0.framebuffer.multisample=options.multisample;JSCompiler_OptimizeArgumentsArray_p0.maskStack=[];JSCompiler_OptimizeArgumentsArray_p0.filterStack=[{}];return JSCompiler_OptimizeArgumentsArray_p0}__extends(BaseRenderTexture,_super);BaseRenderTexture.prototype.resize=function(desiredWidth,desiredHeight){this.framebuffer.resize(desiredWidth*this.resolution,desiredHeight*this.resolution);this.setRealSize(this.framebuffer.width,this.framebuffer.height)};
...
if(this[name])throw Error('Whoops! The name "'+name+'" is already in use');this[name]=ClassRef;for(var i in this.runners)this.runners[i].add(ClassRef);return this};Renderer.prototype.render=function(displayObject,options,JSCompiler_OptimizeArgumentsArray_p3,JSCompiler_OptimizeArgumentsArray_p4,JSCompiler_OptimizeArgumentsArray_p5){if(options)if(options instanceof RenderTexture){utils.deprecation("6.0.0","Renderer#render arguments changed, use options instead.");var renderTexture=options;var clear=
JSCompiler_OptimizeArgumentsArray_p3;var transform=JSCompiler_OptimizeArgumentsArray_p4;var skipUpdateTransform=JSCompiler_OptimizeArgumentsArray_p5}else renderTexture=options.renderTexture,clear=options.clear,transform=options.transform,skipUpdateTransform=options.skipUpdateTransform;this.renderingToScreen=!renderTexture;this.runners.prerender.emit();this.emit("prerender");this.projection.transform=transform;this.context.isLost||(renderTexture||(this._lastObjectRendered=displayObject),skipUpdateTransform||
