...
var periods__$1 = cljs.core.vec((function (){var G__52699 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52698_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__52698_SHARP_,(0),(3));
}),G__52699);
} else {
return G__52699;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__52705){
var vec__52706 = p__52705;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52706,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52706,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__52709 = pattern;
switch (G__52709) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52709)].join('')));
...
return p1__52710_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__52711_SHARP_){
return p1__52711_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__52712_SHARP_){
return p1__52712_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__52713_SHARP_){
return p1__52713_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__52714_SHARP_){
return p1__52714_SHARP_.getHours();
});

break;
case "day":
return (function (p1__52715_SHARP_){
return p1__52715_SHARP_.getDate();
});

break;
case "month":
return (function (p1__52716_SHARP_){
return p1__52716_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__52717_SHARP_){
return p1__52717_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52718__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__52719){
var vec__52720 = p__52719;
var seq__52721 = cljs.core.seq(vec__52720);
var first__52722 = cljs.core.first(seq__52721);
var seq__52721__$1 = cljs.core.next(seq__52721);
var key = first__52722;
var args = seq__52721__$1;
var G__52723 = key;
...
break;
case "ordinal-suffix":
var vec__52724 = (function (){var G__52727 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__52727) : syntax_list.call(null,G__52727));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52724,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52723__$1)].join('')));
...
var d = value;
var G__52731 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__52732 = G__52731;
var seq__52733 = cljs.core.seq(vec__52732);
var first__52734 = cljs.core.first(seq__52733);
var seq__52733__$1 = cljs.core.next(seq__52733);
var unparser = first__52734;
var more = seq__52733__$1;
var s = "";
var d__$1 = d;
var G__52731__$1 = G__52731;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__52741 = G__52731__$1;
...
var unparser__$1 = first__52743;
var more__$1 = seq__52742__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__52744 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52744,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52744,(1),null);
var G__52763 = d__$3;
var G__52764 = more__$1;
var G__52765 = s__$3;
d__$1 = G__52763;
G__52731__$1 = G__52764;
s__$1 = G__52765;
continue;
}
break;
