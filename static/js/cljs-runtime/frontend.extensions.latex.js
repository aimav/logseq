...
var vec__111199 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111199,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111199,(1),null);
var display_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111199,(2),null);
...
var iter__5520__auto__ = (function frontend$extensions$latex$load_and_render_BANG__$_iter__111203(s__111204){
return (new cljs.core.LazySeq(null,(function (){
var s__111204__$1 = s__111204;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__111204__$1);
if(temp__5804__auto____$1){
var s__111204__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__111204__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__111204__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__111206 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__111205 = (0);
while(true){
if((i__111205 < size__5519__auto__)){
var map__111207 = cljs.core._nth(c__5518__auto__,i__111205);
var map__111207__$1 = cljs.core.__destructure_map(map__111207);
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111207__$1,new cljs.core.Keyword(null,"enhancer","enhancer",-929020171));
cljs.core.chunk_append(b__111206,((cljs.core.fn_QMARK_(f))?(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(window.katex) : f.call(null,window.katex)):null));

var G__111210 = (i__111205 + (1));
i__111205 = G__111210;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__111206),frontend$extensions$latex$load_and_render_BANG__$_iter__111203(cljs.core.chunk_rest(s__111204__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__111206),null);
}
} else {
var map__111208 = cljs.core.first(s__111204__$2);
var map__111208__$1 = cljs.core.__destructure_map(map__111208);
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111208__$1,new cljs.core.Keyword(null,"enhancer","enhancer",-929020171));
return cljs.core.cons(((cljs.core.fn_QMARK_(f))?(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(window.katex) : f.call(null,window.katex)):null),frontend$extensions$latex$load_and_render_BANG__$_iter__111203(cljs.core.rest(s__111204__$2)));
}
} else {
return null;
}
...
return daiquiri.interpreter.interpret(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [element,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),"initial"], null),(function (){var attrs111209 = s;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs111209))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["opacity-0"], null)], null),attrs111209], 0))):{'className':"opacity-0"}),((cljs.core.map_QMARK_(attrs111209))?null:[daiquiri.interpreter.interpret(attrs111209)]));
})()], null));
}
