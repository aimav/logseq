...
return ((typeof s === 'string') && (((clojure.string.starts_with_QMARK_(s,"file://")) || (((clojure.string.starts_with_QMARK_(s,"content://")) || (((clojure.string.starts_with_QMARK_(s,"assets://")) || (((clojure.string.starts_with_QMARK_(s,"logseq://")) || (((clojure.string.starts_with_QMARK_(s,"memory://")) || (clojure.string.starts_with_QMARK_(s,"s3://")))))))))))));
});
/**
...
return (((!(clojure.string.blank_QMARK_(fname)))) && ((((cljs.core.count(fname) < (255))) && (cljs.core.not((function (){var or__5043__auto__ = cljs.core.re_find(/[\\/?<>\\:*|\"]/,fname);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var or__5043__auto____$1 = cljs.core.re_find(/^\.+$/,fname);
if(cljs.core.truth_(or__5043__auto____$1)){
return or__5043__auto____$1;
} else {
var or__5043__auto____$2 = cljs.core.re_find(/[\. ]$/,fname);
if(cljs.core.truth_(or__5043__auto____$2)){
return or__5043__auto____$2;
} else {
var or__5043__auto____$3 = cljs.core.re_find(/^(COM[0-9]|CON|LPT[0-9]|NUL|PRN|AUX|com[0-9]|con|lpt[0-9]|nul|prn|aux)\..+/i,fname);
...
var len__5766__auto___68835 = arguments.length;
var i__5767__auto___68836 = (0);
while(true){
if((i__5767__auto___68836 < len__5766__auto___68835)){
args__5772__auto__.push((arguments[i__5767__auto___68836]));

var G__68837 = (i__5767__auto___68836 + (1));
i__5767__auto___68836 = G__68837;
continue;
} else {
}
break;
...
return logseq.common.path.path_join_internal.cljs$core$IFn$_invoke$arity$variadic(argseq__5773__auto__);
});
...
var segments__$2 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68802_SHARP_){
return clojure.string.replace(p1__68802_SHARP_,/[\/\\]+/,"/");
}),segments__$1);
...
var G__68804 = segs;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,G__68804)){
return ".";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [""], null),G__68804)){
return "/";
} else {
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("..",segment)){
var G__68805 = cljs.core.last(acc);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("..",G__68805)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,segment);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__68805)){
return acc;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__68805)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [".."], null);
} else {
...
/** @this {Function} */
(logseq.common.path.path_join_internal.cljs$lang$applyTo = (function (seq68803){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq68803));
}));
...
var args__5772__auto__ = [];
var len__5766__auto___68838 = arguments.length;
var i__5767__auto___68839 = (0);
while(true){
if((i__5767__auto___68839 < len__5766__auto___68838)){
args__5772__auto__.push((arguments[i__5767__auto___68839]));

var G__68840 = (i__5767__auto___68839 + (1));
i__5767__auto___68839 = G__68840;
continue;
} else {
}
break;
...
var argseq__5773__auto__ = ((((0) < args__5772__auto__.length))?(new cljs.core.IndexedSeq(args__5772__auto__.slice((0)),(0),null)):null);
return logseq.common.path.uri_path_join_internal.cljs$core$IFn$_invoke$arity$variadic(argseq__5773__auto__);
});
...
var segments__$2 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68806_SHARP_){
return clojure.string.replace(p1__68806_SHARP_,/[\/\\]+/,"/");
}),segments__$1);
var split_fn = (function (s){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(s,"/")){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [""], null);
...
var join_fn = (function (segs){
var G__68811 = segs;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,G__68811)){
return ".";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [""], null),G__68811)){
return "/";
} else {
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("/",segs);
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("..",segment)){
var G__68812 = cljs.core.last(acc);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("..",G__68812)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,segment);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__68812)){
return acc;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__68812)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [".."], null);
} else {
return cljs.core.pop(acc);
...
}),cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68807_SHARP_){
return encodeURIComponent(p1__68807_SHARP_);
...
/** @this {Function} */
(logseq.common.path.uri_path_join_internal.cljs$lang$applyTo = (function (seq68808){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq68808));
}));
...
var args__5772__auto__ = [];
var len__5766__auto___68841 = arguments.length;
var i__5767__auto___68842 = (0);
while(true){
if((i__5767__auto___68842 < len__5766__auto___68841)){
args__5772__auto__.push((arguments[i__5767__auto___68842]));

var G__68843 = (i__5767__auto___68842 + (1));
i__5767__auto___68842 = G__68843;
continue;
} else {
}
break;
...
return logseq.common.path.url_join.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5773__auto__);
});

(logseq.common.path.url_join.cljs$core$IFn$_invoke$arity$variadic = (function (base_url,segments){
var url = (new URL(base_url));
var scheme = url.protocol;
var domain = (function (){var or__5043__auto__ = cljs.core.not_empty(url.host);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return "";
...
var path = logseq.common.path.safe_decode_uri_component(url.pathname);
...
/** @this {Function} */
(logseq.common.path.url_join.cljs$lang$applyTo = (function (seq68814){
var G__68815 = cljs.core.first(seq68814);
var seq68814__$1 = cljs.core.next(seq68814);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68815,seq68814__$1);
}));
...
var args__5772__auto__ = [];
var len__5766__auto___68844 = arguments.length;
var i__5767__auto___68845 = (0);
while(true){
if((i__5767__auto___68845 < len__5766__auto___68844)){
args__5772__auto__.push((arguments[i__5767__auto___68845]));

var G__68846 = (i__5767__auto___68845 + (1));
i__5767__auto___68845 = G__68846;
continue;
} else {
}
break;
...
var argseq__5773__auto__ = ((((1) < args__5772__auto__.length))?(new cljs.core.IndexedSeq(args__5772__auto__.slice((1)),(0),null)):null);
return logseq.common.path.path_join.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5773__auto__);
});
...
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.not_empty(base);
...
/** @this {Function} */
(logseq.common.path.path_join.cljs$lang$applyTo = (function (seq68817){
var G__68818 = cljs.core.first(seq68817);
var seq68817__$1 = cljs.core.next(seq68817);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68818,seq68817__$1);
}));
...
var url = (new URL(clojure.string.replace(original_url,"assets://","file://")));
var path = logseq.common.path.safe_decode_uri_component(url.pathname);
var host = url.host;
...
var common_segs = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__68821_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__68821_SHARP_),cljs.core.second(p1__68821_SHARP_));
...
var base_prefix = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2((function (){var x__5128__auto__ = (0);
var y__5129__auto__ = (cljs.core.count(base_segs__$1) - (1));
...
var common_segs = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__68828_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__68828_SHARP_),cljs.core.second(p1__68828_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,base_segs,path_segs));
var base_segs__$1 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(common_segs),base_segs);
var remain_segs = cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(common_segs),path_segs);
var base_prefix = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2((function (){var x__5128__auto__ = (0);
var y__5129__auto__ = cljs.core.count(base_segs__$1);
return ((x__5128__auto__ > y__5129__auto__) ? x__5128__auto__ : y__5129__auto__);
})(),"../"));
if(is_url_QMARK_){
return logseq.common.path.safe_decode_uri_component([cljs.core.str.cljs$core$IFn$_invoke$arity$1(base_prefix),clojure.string.join.cljs$core$IFn$_invoke$arity$2("/",remain_segs)].join(''));
...
return cljs.core.boolean$((function (){var or__5043__auto__ = logseq.common.path.is_file_url_QMARK_(p__$1);
if(or__5043__auto__){
return or__5043__auto__;
} else {
var or__5043__auto____$1 = clojure.string.starts_with_QMARK_(p__$1,"/");
...
return cljs.core.boolean$((function (){var and__5041__auto__ = cljs.core.re_find(/^[a-zA-Z0-9_+\-\.]{2,}:/,p);
if(cljs.core.truth_(and__5041__auto__)){
