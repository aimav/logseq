...
var vec__111195 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111195,(0),null);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111195,(1),null);
...
return daiquiri.core.create_element("pre",{'className':"code pre-wrap-white-space"},[(function (){var attrs111198 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(attr,new cljs.core.Keyword(null,"id","id",-1388402092),id);
return daiquiri.core.create_element("code",((cljs.core.map_QMARK_(attrs111198))?daiquiri.interpreter.element_attributes(attrs111198):null),((cljs.core.map_QMARK_(attrs111198))?[daiquiri.interpreter.interpret(code)]:[daiquiri.interpreter.interpret(attrs111198),daiquiri.interpreter.interpret(code)]));
})()]);
