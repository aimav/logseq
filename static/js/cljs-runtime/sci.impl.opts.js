...
var namespaces__$1 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(cljs.core.merge,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var or__5043__auto__ = env_nss;
...
var len__5766__auto___83564 = arguments.length;
var i__5767__auto___83565 = (0);
while(true){
if((i__5767__auto___83565 < len__5766__auto___83564)){
args__5772__auto__.push((arguments[i__5767__auto___83565]));

var G__83566 = (i__5767__auto___83565 + (1));
i__5767__auto___83565 = G__83566;
continue;
} else {
}
break;
...
return sci.impl.opts.process_permissions.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5773__auto__);
});
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq83538){
var G__83539 = cljs.core.first(seq83538);
var seq83538__$1 = cljs.core.next(seq83538);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__83539,seq83538__$1);
}));
...
var G__83567 = null;
var G__83567__1 = (function (msg){
return (new Error(msg));
});
var G__83567__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__83567__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__83567 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__83567__1.call(this,msg);
case 2:
return G__83567__2.call(this,msg,filename);
case 3:
return G__83567__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__83567.cljs$core$IFn$_invoke$arity$1 = G__83567__1;
G__83567.cljs$core$IFn$_invoke$arity$2 = G__83567__2;
G__83567.cljs$core$IFn$_invoke$arity$3 = G__83567__3;
return G__83567;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__83543_SHARP_){
return (new cljs.core.Delay(p1__83543_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__83544_SHARP_){
return (new goog.string.StringBuffer(p1__83544_SHARP_));
})], null)], null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__83550 = temp__5802__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83550,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83550,(1),null);
var G__83568 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__83569 = cljs.core.rest(kvs);
class__GT_opts = G__83568;
kvs = G__83569;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__83557){
var map__83558 = p__83557;
var map__83558__$1 = cljs.core.__destructure_map(map__83558);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83558__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
var env__$1 = (function (){var or__5043__auto__ = env;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var map__83562 = opts;
var map__83562__$1 = cljs.core.__destructure_map(map__83562);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83562__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var classes__$1 = sci.impl.opts.normalize_classes(raw_classes);
var ctx__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(sci.impl.opts.__GT_ctx(cljs.core.PersistentArrayMap.EMPTY,env,features,readers,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"check-permissions","check-permissions",669054317).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var or__5043__auto____$1 = allow;
