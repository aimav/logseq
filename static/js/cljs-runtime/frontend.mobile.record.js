...
var map__119843 = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(result,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
var map__119843__$1 = cljs.core.__destructure_map(map__119843);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__119843__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2([cljs.core.str.cljs$core$IFn$_invoke$arity$1(frontend.date.get_date_time_string_2()),".aac"].join(''),(function (filename){
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.handler.assets.get_asset_file_link(format,url,filename,true),(function (file_link){
...
var map__119844 = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(value,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
var map__119844__$1 = cljs.core.__destructure_map(map__119844);
var _msDuration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__119844__$1,new cljs.core.Keyword(null,"_msDuration","_msDuration",-2088496118));
var recordDataBase64 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__119844__$1,new cljs.core.Keyword(null,"recordDataBase64","recordDataBase64",-1094381034));
var _mimeType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__119844__$1,new cljs.core.Keyword(null,"_mimeType","_mimeType",1358086728));
frontend.mobile.record.set_recording_state();
