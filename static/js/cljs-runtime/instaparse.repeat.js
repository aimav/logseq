...
var G__125523 = arguments.length;
switch (G__125523) {
case 1:
...
var vec__125524 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125524,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125524,(1),null);
...
var vec__125528 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125528,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125528,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__125552 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125552,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125552,(1),null);
...
var G__125765 = cljs.core.next(parses__$1);
parses__$1 = G__125765;
continue;
}
...
var G__125610 = arguments.length;
switch (G__125610) {
case 5:
...
var G__125636 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__125637 = G__125636;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125637,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125637,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125637,(2),null);
var selection = vec__125637;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__125636__$1 = G__125636;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__125647 = G__125636__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125647,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125647,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125647,(2),null);
var selection__$1 = vec__125647;
...
var G__125774 = cljs.core.long$(end__$1);
var G__125775 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__125776 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__125774;
parses__$1 = G__125775;
G__125636__$1 = G__125776;
continue;
...
var G__125656 = arguments.length;
switch (G__125656) {
case 5:
...
var G__125664 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__125665 = G__125664;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125665,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125665,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125665,(2),null);
var selection = vec__125665;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__125664__$1 = G__125664;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__125671 = G__125664__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125671,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125671,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125671,(2),null);
var selection__$1 = vec__125671;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__125797 = cljs.core.long$(end__$1);
var G__125798 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__125799 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__125797;
parses__$1 = G__125798;
G__125664__$1 = G__125799;
continue;
...
var G__125680 = arguments.length;
switch (G__125680) {
case 4:
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__125690 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__125691 = G__125690;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125691,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125691,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125691,(2),null);
var selection = vec__125691;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__125690__$1 = G__125690;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__125698 = G__125690__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125698,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125698,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__125698,(2),null);
var selection__$1 = vec__125698;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__125813 = cljs.core.long$(end__$1);
var G__125814 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__125815 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__125813;
parses__$1 = G__125814;
G__125690__$1 = G__125815;
continue;
...
var G__125706 = arguments.length;
switch (G__125706) {
case 4:
...
if(cljs.core.truth_((function (){var fexpr__125711 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__125711.cljs$core$IFn$_invoke$arity$1 ? fexpr__125711.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__125711.call(null,output_format));
})())){
} else {
...
if(cljs.core.truth_((function (){var or__5043__auto__ = cljs.core.empty_QMARK_(header_results);
if(or__5043__auto__){
...
var G__125738 = output_format;
var G__125738__$1 = (((G__125738 instanceof cljs.core.Keyword))?G__125738.fqn:null);
switch (G__125738__$1) {
case "enlive":
...
if(cljs.core.not((function (){var and__5041__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207));
if(and__5041__auto__){
var and__5041__auto____$1 = (function (){var G__125748 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__125747 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__125747.cljs$core$IFn$_invoke$arity$1 ? fexpr__125747.cljs$core$IFn$_invoke$arity$1(G__125748) : fexpr__125747.call(null,G__125748));
})();
