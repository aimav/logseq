...
var block_attrs = cljs.core.butlast(frontend.db.model.block_attrs);
 ...
 */
frontend.db.query_custom.add_rules_to_query = (function frontend$db$query_custom$add_rules_to_query(p__84150){
var map__84151 = p__84150;
var map__84151__$1 = cljs.core.__destructure_map(map__84151);
var query_m = map__84151__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84151__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var map__84152 = frontend.util.datalog.query_vec__GT_map(query);
var map__84152__$1 = cljs.core.__destructure_map(map__84152);
var where = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84152__$1,new cljs.core.Keyword(null,"where","where",-2044795965));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84152__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
var rules_found = frontend.util.datalog.find_rules_in_where(where,cljs.core.set(cljs.core.keys(logseq.db.rules.query_dsl_rules)));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(inputs),(cljs.core.count(inputs) - (1)),cljs.core.vec(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.last(inputs),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(logseq.db.rules.query_dsl_rules,rules_found)))));
}));
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2((function (){var or__5043__auto__ = rules;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return cljs.core.PersistentVector.EMPTY;
}
})(),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(logseq.db.rules.query_dsl_rules,rules_found));
}));
}
} else {
return query_m;
...
return frontend.db.query_react.react_query(repo,frontend.db.query_custom.add_rules_to_query(query_SINGLEQUOTE_),query_opts__$1);
}
}));
