...
var blocks_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__112351_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(p1__112351_SHARP_,new cljs.core.Keyword("block","level","block/level",1182509971),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("block","children","block/children",-1040716209)], 0));
}),blocks);
...
frontend.handler.editor.property.set_block_property_BANG_(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(first_block),new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(first_block)));

return frontend.handler.editor.api_insert_new_block_BANG_(logseq.graph_parser.util.block_ref.__GT_block_ref(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(first_block)),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(target_block),new cljs.core.Keyword(null,"sibling?","sibling?",-1086129060),(!(nested_QMARK_)),new cljs.core.Keyword(null,"before?","before?",765621039),top_QMARK_], null));
} else {
...
var _STAR_transaction_data_STAR__orig_val__112354 = frontend.modules.outliner.core._STAR_transaction_data_STAR_;
var _STAR_transaction_opts_STAR__orig_val__112355 = frontend.modules.outliner.core._STAR_transaction_opts_STAR_;
var _STAR_transaction_data_STAR__temp_val__112356 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
var _STAR_transaction_opts_STAR__temp_val__112357 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.core._STAR_transaction_data_STAR_ = _STAR_transaction_data_STAR__temp_val__112356);

(frontend.modules.outliner.core._STAR_transaction_opts_STAR_ = _STAR_transaction_opts_STAR__temp_val__112357);
...
if(top_QMARK_){
var first_child_QMARK__112362 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(frontend.modules.outliner.tree._get_parent_id(target_node),frontend.modules.outliner.tree._get_left_id(target_node));
if(first_child_QMARK__112362){
var parent_112363 = frontend.modules.outliner.tree._get_parent(target_node);
frontend.modules.outliner.core.move_blocks_BANG_(blocks,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(parent_112363),false);
} else {
var before_node_112364 = frontend.modules.outliner.tree._get_left(target_node);
frontend.modules.outliner.core.move_blocks_BANG_(blocks,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(before_node_112364),true);
}
} else {
...
}finally {(frontend.modules.outliner.core._STAR_transaction_opts_STAR_ = _STAR_transaction_opts_STAR__orig_val__112355);

(frontend.modules.outliner.core._STAR_transaction_data_STAR_ = _STAR_transaction_data_STAR__orig_val__112354);
}}
} else {
return null;
