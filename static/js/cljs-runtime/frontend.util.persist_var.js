...
var frontend$util$persist_var$ILoad$_load$dyn_91263 = (function (this$){
...
return frontend$util$persist_var$ILoad$_load$dyn_91263(this$);
}
});

var frontend$util$persist_var$ILoad$_loaded_QMARK_$dyn_91264 = (function (this$){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
return frontend$util$persist_var$ILoad$_loaded_QMARK_$dyn_91264(this$);
}
});
...
var frontend$util$persist_var$ISave$_save$dyn_91268 = (function (this$){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
return frontend$util$persist_var$ISave$_save$dyn_91268(this$);
}
});
...
var frontend$util$persist_var$IResetValue$_reset_value_BANG_$dyn_91270 = (function (this$,new$,graph){
var x__5390__auto__ = (((this$ == null))?null:this$);
...
return frontend$util$persist_var$IResetValue$_reset_value_BANG_$dyn_91270(this$,new$,graph);
}
});
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.file_exists_QMARK_.cljs$core$IFn$_invoke$arity$2(dir,path),(function (file_exists_QMARK_){
...
}catch (e91214){var e = e91214;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("read persist-var failed: %s",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([frontend.util.persist_var.load_rpath(self__.location)], 0))], 0));
...
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("load persist-var failed: %s: %s",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([frontend.util.persist_var.load_rpath(self__.location),e], 0))], 0));
})):null));
}));
}));
}
...
var dir = frontend.config.get_repo_dir(repo);
return frontend.fs.write_file_BANG_(repo,dir,path,content,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"skip-compare?","skip-compare?",82692960),true], null));
}
}));
