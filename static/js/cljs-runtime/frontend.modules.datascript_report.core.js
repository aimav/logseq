 ...
 */
frontend.modules.datascript_report.core.get_blocks_and_pages = (function frontend$modules$datascript_report$core$get_blocks_and_pages(p__102031){
var map__102032 = p__102031;
var map__102032__$1 = cljs.core.__destructure_map(map__102032);
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102032__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102032__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
var tx_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102032__$1,new cljs.core.Keyword(null,"tx-data","tx-data",934159761));
var tx_meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102032__$1,new cljs.core.Keyword(null,"tx-meta","tx-meta",1159283194));
...
var G__102033 = acc;
var G__102033__$1 = (((!((block_entity == null))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__102033,new cljs.core.Keyword(null,"blocks","blocks",-610462153),cljs.core.conj,block_entity):G__102033);
if((!((page_entity == null)))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__102033__$1,new cljs.core.Keyword(null,"pages","pages",-285406513),cljs.core.conj,page_entity);
} else {
return G__102033__$1;
}
...
var tx_meta_pages = cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__102030_SHARP_){
return frontend.modules.datascript_report.core.get_entity_from_db_after_or_before(db_before,db_after,p1__102030_SHARP_);
...
frontend.modules.datascript_report.core.get_blocks = (function frontend$modules$datascript_report$core$get_blocks(p__102034){
var map__102035 = p__102034;
var map__102035__$1 = cljs.core.__destructure_map(map__102035);
var _tx_report = map__102035__$1;
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102035__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102035__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
var tx_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102035__$1,new cljs.core.Keyword(null,"tx-data","tx-data",934159761));
var updated_db_ids = cljs.core.set(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.first,tx_data));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,x){
var block_entity = frontend.modules.datascript_report.core.get_entity_from_db_after_or_before(db_before,db_after,x);
var G__102036 = acc;
if((!((block_entity == null)))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__102036,block_entity);
} else {
return G__102036;
}
