...
return rewrite_clj.node.protocols.coerce((function (){var G__88646 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__88646) : f.call(null,G__88646));
})());
});
});
/**
...
var len__5766__auto___88658 = arguments.length;
var i__5767__auto___88659 = (0);
while(true){
if((i__5767__auto___88659 < len__5766__auto___88658)){
args__5772__auto__.push((arguments[i__5767__auto___88659]));

var G__88660 = (i__5767__auto___88659 + (1));
i__5767__auto___88659 = G__88660;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__88647_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__88647_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq88648){
var G__88649 = cljs.core.first(seq88648);
var seq88648__$1 = cljs.core.next(seq88648);
var G__88650 = cljs.core.first(seq88648__$1);
var seq88648__$2 = cljs.core.next(seq88648__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__88649,G__88650,seq88648__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__88651 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__88651) : str_fn.call(null,G__88651));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__88652 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__88652) : str_fn.call(null,G__88652));
})()):null)));
...
var G__88655 = rewrite_clj.zip.base.tag(zloc);
var G__88655__$1 = (((G__88655 instanceof cljs.core.Keyword))?G__88655.fqn:null);
switch (G__88655__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__88653_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__88653_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__88654_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__88654_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__88655__$1)].join('')));
...
var G__88657 = rewrite_clj.zip.base.tag(zloc);
var G__88657__$1 = (((G__88657 instanceof cljs.core.Keyword))?G__88657.fqn:null);
switch (G__88657__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__88656_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__88656_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__88657__$1)].join('')));
