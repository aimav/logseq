...
var attrs108492 = (logseq.shui.toaster.core.Toaster.cljs$core$IFn$_invoke$arity$0 ? logseq.shui.toaster.core.Toaster.cljs$core$IFn$_invoke$arity$0() : logseq.shui.toaster.core.Toaster.call(null));
return daiquiri.core.create_element(daiquiri.core.fragment,((cljs.core.map_QMARK_(attrs108492))?daiquiri.interpreter.element_attributes(attrs108492):null),((cljs.core.map_QMARK_(attrs108492))?null:[daiquiri.interpreter.interpret(attrs108492)]));
...
return cljs.core.update_keys(v,(function (p1__108493_SHARP_){
var G__108494 = p1__108493_SHARP_;
var G__108494__$1 = (((G__108494 instanceof cljs.core.Keyword))?G__108494.fqn:null);
switch (G__108494__$1) {
case "class":
...
var len__5766__auto___108507 = arguments.length;
var i__5767__auto___108508 = (0);
while(true){
if((i__5767__auto___108508 < len__5766__auto___108507)){
args__5772__auto__.push((arguments[i__5767__auto___108508]));

var G__108509 = (i__5767__auto___108508 + (1));
i__5767__auto___108508 = G__108509;
continue;
} else {
}
break;
...
return logseq.shui.toaster.core.interpret_vals.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5773__auto__);
});
...
/** @this {Function} */
(logseq.shui.toaster.core.interpret_vals.cljs$lang$applyTo = (function (seq108495){
var G__108496 = cljs.core.first(seq108495);
var seq108495__$1 = cljs.core.next(seq108495);
var G__108497 = cljs.core.first(seq108495__$1);
var seq108495__$2 = cljs.core.next(seq108495__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__108496,G__108497,seq108495__$2);
}));

logseq.shui.toaster.core.toast_BANG_ = (function logseq$shui$toaster$core$toast_BANG_(var_args){
var G__108500 = arguments.length;
switch (G__108500) {
case 1:
...
var map__108501 = temp__5802__auto__;
var map__108501__$1 = cljs.core.__destructure_map(map__108501);
var toast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108501__$1,new cljs.core.Keyword(null,"toast","toast",68598129));
var dismiss = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108501__$1,new cljs.core.Keyword(null,"dismiss","dismiss",412569545));
...
var id = (function (){var or__5043__auto__ = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(config__$1);
...
}),new cljs.core.Keyword(null,"update!","update!",-1453508586),(function (p1__108498_SHARP_){
return logseq.shui.toaster.core.toast_BANG_.cljs$core$IFn$_invoke$arity$1(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__108498_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092),id));
})], null)], 0));
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1((function (){var G__108502 = cljs.core.clj__GT_js(config__$3);
return (toast.cljs$core$IFn$_invoke$arity$1 ? toast.cljs$core$IFn$_invoke$arity$1(G__108502) : toast.call(null,G__108502));
})());
} else {
...
var G__108504 = arguments.length;
switch (G__108504) {
case 0:
...
if(cljs.core.truth_(temp__5804__auto__)){
var map__108505 = temp__5804__auto__;
var map__108505__$1 = cljs.core.__destructure_map(map__108505);
var dismiss = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108505__$1,new cljs.core.Keyword(null,"dismiss","dismiss",412569545));
return (dismiss.cljs$core$IFn$_invoke$arity$1 ? dismiss.cljs$core$IFn$_invoke$arity$1(id) : dismiss.call(null,id));
} else {
return null;
}
