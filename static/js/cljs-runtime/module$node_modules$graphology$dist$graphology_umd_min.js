...
c.key=i,e.emit("edgeAdded",c),i}function Ze(e){e.from=function(t,n){n=d$jscomp$1({},t.options,n);n=new e(n);return n.import(t),n}}var d$jscomp$1=function(){for(var e=arguments[0],t=1,n=arguments.length;t<n;t++)if(arguments[t])for(var r in arguments[t])e[r]=arguments[t][r];return e};"function"==typeof Object.assign&&(d$jscomp$1=Object.assign);var JSCompiler_object_inline_exports_4189={},w=(JSCompiler_object_inline_exports_4189="object"==typeof Reflect?Reflect:null)&&"function"==typeof JSCompiler_object_inline_exports_4189.apply?
JSCompiler_object_inline_exports_4189.apply:function(e,t,n){return Function.prototype.apply.call(e,t,n)};var y=JSCompiler_object_inline_exports_4189&&"function"==typeof JSCompiler_object_inline_exports_4189.ownKeys?JSCompiler_object_inline_exports_4189.ownKeys:Object.getOwnPropertySymbols?function(e){return Object.getOwnPropertyNames(e).concat(Object.getOwnPropertySymbols(e))}:function(e){return Object.getOwnPropertyNames(e)};var m=Number.isNaN||function(e){return e!=e};JSCompiler_object_inline_exports_4189=
_;JSCompiler_object_inline_exports_4189.once=function(e$jscomp$0,t$jscomp$0){return new Promise(function(n$jscomp$0,r){function i(n){e$jscomp$0.removeListener(t$jscomp$0,o);r(n)}function o(){"function"==typeof e$jscomp$0.removeListener&&e$jscomp$0.removeListener("error",i);n$jscomp$0([].slice.call(arguments))}j(e$jscomp$0,t$jscomp$0,o,{once:!0});"error"!==t$jscomp$0&&function(e,t,n){"function"==typeof e.on&&j(e,"error",t,n)}(e$jscomp$0,i,{once:!0})})};_.EventEmitter=_;_.prototype._events=void 0;_.prototype._eventsCount=
...
o.out)),"directed"!==a&&ke(u,o.undirected),C(u.values(),u.size))}return o}throw new z("Graph.".concat(n,": invalid number of arguments (expecting 1 or 2 and got ").concat(arguments.length,")."));}}(e$jscomp$1,t$jscomp$1);je(e$jscomp$1,t$jscomp$1);Ue(e$jscomp$1,t$jscomp$1);Oe(e$jscomp$1,t$jscomp$1)})})(Je);JSCompiler_object_inline_exports_4189=function(e){function n(t){t=d$jscomp$1({type:"directed"},t);if("multi"in t&&!1!==t.multi)throw new z("DirectedGraph.from: inconsistent indication that the graph should be multi in given options!");
...
return e.call(this,t)||this}return t$jscomp$2(n,e),n}(Je);return Ze(Je),Ze(JSCompiler_object_inline_exports_4189),Ze(K),Ze(Qe),Ze(Ve),Ze(Xe),Je.Graph=Je,Je.DirectedGraph=JSCompiler_object_inline_exports_4189,Je.UndirectedGraph=K,Je.MultiGraph=Qe,Je.MultiDirectedGraph=Ve,Je.MultiUndirectedGraph=Xe,Je.InvalidArgumentsGraphError=z,Je.NotFoundGraphError=M,Je.UsageGraphError=P,Je})}
