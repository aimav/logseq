...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.mkdir_if_not_exists(config_dir),(function (_){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.create_if_not_exists.cljs$core$IFn$_invoke$arity$4(repo_url,null,config_path,frontend.handler.global_config.default_content),(function (file_exists_QMARK_){
...
var config_path = frontend.handler.global_config.global_config_path();
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.read_file.cljs$core$IFn$_invoke$arity$2(null,config_path),(function (config_content){
...
var result = borkdude.rewrite_edn.parse_string((function (){var or__5043__auto__ = frontend.state.get_global_config_str_content();
...
frontend.fs.write_file_BANG_(null,null,frontend.handler.global_config.global_config_path(),new_str_content,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"skip-compare?","skip-compare?",82692960),true], null));
 ...
 */
frontend.handler.global_config.start = (function frontend$handler$global_config$start(p__90934){
var map__90935 = p__90934;
var map__90935__$1 = cljs.core.__destructure_map(map__90935);
var repo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90935__$1,new cljs.core.Keyword(null,"repo","repo",-1999060679));
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.timeout.cljs$core$IFn$_invoke$arity$2(promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37149__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(electron.ipc.ipc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["getLogseqDotDirRoot"], 0)),(function (root_dir_SINGLEQUOTE_){
return promesa.protocols._promise(cljs.core.reset_BANG_(frontend.handler.global_config.root_dir,root_dir_SINGLEQUOTE_));
}));
})),(function (___37148__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.handler.global_config.restore_global_config_BANG_(),(function (___37148__auto____$1){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.handler.global_config.create_global_config_file_if_not_exists(repo),(function (___37148__auto____$2){
