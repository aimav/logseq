...
var vec__112545 = cljs.core.re_find(/\s+([a-zA-Z0-9]+:\/\/[\S]*)$/,url);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__112545,(0),null);
var link = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__112545,(1),null);
...
var map__112548 = args;
var map__112548__$1 = cljs.core.__destructure_map(map__112548);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112548__$1,new cljs.core.Keyword(null,"url","url",276297046));
if(cljs.core.truth_(frontend.mobile.intent.is_link(url))){
return args;
} else {
var vec__112549 = frontend.mobile.intent.extract_highlight(url);
var highlight = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__112549,(0),null);
var url_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__112549,(1),null);
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.date.today(),(function (date_ref_name){
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.handler.assets.get_asset_file_link(format,url__$1,label,true),(function (url__$2){
...
return promesa.protocols._promise(clojure.string.replace(clojure.string.replace(clojure.string.replace(clojure.string.replace(template,"{time}",time),"{date}",date_ref_name),"{text}",""),"{url}",(function (){var or__5043__auto__ = url__$2;
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.date.get_current_time(),(function (time){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.date.today(),(function (date_ref_name){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2((function (){var G__112552 = (function (){var or__5043__auto__ = title;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var G__112552__$1 = (((G__112552 == null))?null:logseq.graph_parser.util.safe_decode_uri_component(G__112552));
var G__112552__$2 = (((G__112552__$1 == null))?null:(frontend.util.node_path.name.cljs$core$IFn$_invoke$arity$1 ? frontend.util.node_path.name.cljs$core$IFn$_invoke$arity$1(G__112552__$1) : frontend.util.node_path.name.call(null,G__112552__$1)));
if((G__112552__$2 == null)){
return null;
} else {
return logseq.graph_parser.util.page_name_sanity(G__112552__$2);
}
})(),(function (title__$1){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(module$node_modules$path$path.join(frontend.config.get_repo_dir(frontend.state.get_current_repo()),frontend.config.get_pages_directory(),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(encodeURI(frontend.util.fs.file_name_sanity.cljs$core$IFn$_invoke$arity$1(title__$1))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(module$node_modules$path$path.extname(url))].join('')),(function (path){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(module$node_modules$$capacitor$filesystem$dist$plugin_cjs.Filesystem.copy(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"from","from",1815293044),url,new cljs.core.Keyword(null,"to","to",192099007),path], null))),(function (error){
return lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("frontend.mobile.intent",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"copy-file-error","copy-file-error",-264206453),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),error], null),new cljs.core.Keyword(null,"line","line",212345235),124], null)),null);
})),(function (_){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(logseq.graph_parser.util.page_ref.__GT_page_ref(title__$1),(function (url__$1){
...
return promesa.protocols._promise(clojure.string.replace(clojure.string.replace(clojure.string.replace(clojure.string.replace(template,"{time}",time),"{date}",date_ref_name),"{text}",""),"{url}",(function (){var or__5043__auto__ = url__$1;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return "";
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(result,(function (p__112553){
var map__112554 = p__112553;
var map__112554__$1 = cljs.core.__destructure_map(map__112554);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112554__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(result,(function (p__112555){
var map__112556 = p__112555;
var map__112556__$1 = cljs.core.__destructure_map(map__112556);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112556__$1,new cljs.core.Keyword(null,"title","title",636505583));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112556__$1,new cljs.core.Keyword(null,"url","url",276297046));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112556__$1,new cljs.core.Keyword(null,"type","type",1174270348));
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2((function (){var or__5043__auto__ = frontend.state.get_current_page();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5520__auto__ = (function frontend$mobile$intent$decode_received_result_$_iter__112557(s__112558){
return (new cljs.core.LazySeq(null,(function (){
var s__112558__$1 = s__112558;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__112558__$1);
if(temp__5804__auto__){
var s__112558__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__112558__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__112558__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__112560 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__112559 = (0);
while(true){
if((i__112559 < size__5519__auto__)){
var vec__112561 = cljs.core._nth(c__5518__auto__,i__112559);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__112561,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__112561,(1),null);
cljs.core.chunk_append(b__112560,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,((cljs.core.vector_QMARK_(v))?cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(frontend.mobile.intent.decode_received_result,v)):((clojure.string.blank_QMARK_(v))?null:(cljs.core.truth_(frontend.mobile.util.native_ios_QMARK_())?logseq.graph_parser.util.safe_decode_uri_component(v):v)
))], null));

var G__112583 = (i__112559 + (1));
i__112559 = G__112583;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__112560),frontend$mobile$intent$decode_received_result_$_iter__112557(cljs.core.chunk_rest(s__112558__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__112560),null);
}
} else {
var vec__112564 = cljs.core.first(s__112558__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__112564,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__112564,(1),null);
...
))], null),frontend$mobile$intent$decode_received_result_$_iter__112557(cljs.core.rest(s__112558__$2)));
}
} else {
return null;
}
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.handler.editor.get_asset_path(basename),(function (path){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(module$node_modules$$capacitor$filesystem$dist$plugin_cjs.Filesystem.copy(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"from","from",1815293044),url,new cljs.core.Keyword(null,"to","to",192099007),path], null))),(function (error){
return lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("frontend.mobile.intent",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"copy-file-error","copy-file-error",-264206453),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),error], null),new cljs.core.Keyword(null,"line","line",212345235),193], null)),null);
})),(function (_file){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("../assets/%s",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([basename], 0)),(function (url__$1){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.handler.assets.get_asset_file_link(format,url__$1,label,true),(function (url_link){
...
frontend.mobile.intent.handle_payload_resource = (function frontend$mobile$intent$handle_payload_resource(p__112567,format){
var map__112568 = p__112567;
var map__112568__$1 = cljs.core.__destructure_map(map__112568);
var resource = map__112568__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112568__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112568__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var ext = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112568__$1,new cljs.core.Keyword(null,"ext","ext",-996964541));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112568__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var _STAR_print_newline_STAR__orig_val__112569_112584 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__112570_112585 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__112571_112586 = true;
var _STAR_print_fn_STAR__temp_val__112572_112587 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__112571_112586);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__112572_112587);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(resource);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__112570_112585);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__112569_112584);
}
...
return frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Parsing current shared content are not supported. Please report the following codes on ",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"https://github.com/logseq/logseq/issues/new?labels=from:in-app&template=bug_report.yaml",new cljs.core.Keyword(null,"target","target",253001721),"_blank"], null),"Github"], null),". We will look into it soon.",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre.code","pre.code",2043838796),(function (){var sb__5687__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__112573_112588 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__112574_112589 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__112575_112590 = true;
var _STAR_print_fn_STAR__temp_val__112576_112591 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__112575_112590);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__112576_112591);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(resource);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__112574_112589);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__112573_112588);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5687__auto__);
})()], null)], null),new cljs.core.Keyword(null,"warning","warning",-1685650671),false);
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(payload,(function (p__112577){
var map__112578 = p__112577;
var map__112578__$1 = cljs.core.__destructure_map(map__112578);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112578__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var resources = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__112578__$1,new cljs.core.Keyword(null,"resources","resources",1632806811));
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2((function (){var or__5043__auto__ = text;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return "";
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.all(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (resource){
...
return promesa.protocols._promise((cljs.core.truth_((function (){var or__5043__auto__ = cljs.core.not_empty(text__$1);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var edit_content_include_capture_QMARK_ = (function (){var and__5041__auto__ = cljs.core.not_empty(edit_content);
...
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.not(edit_content_include_capture_QMARK_);
} else {
return and__5041__auto__;
}
})())){
...
frontend.handler.editor.escape_editing.cljs$core$IFn$_invoke$arity$0();
...
return frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Parsing current shared content are not supported. Please report the following codes on ",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"https://github.com/logseq/logseq/issues/new?labels=from:in-app&template=bug_report.yaml",new cljs.core.Keyword(null,"target","target",253001721),"_blank"], null),"Github"], null),". We will look into it soon.",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre.code","pre.code",2043838796),(function (){var sb__5687__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__112579_112592 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__112580_112593 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__112581_112594 = true;
var _STAR_print_fn_STAR__temp_val__112582_112595 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__112581_112594);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__112582_112595);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(result__$1);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__112580_112593);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__112579_112592);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5687__auto__);
})()], null)], null),new cljs.core.Keyword(null,"warning","warning",-1685650671),false);
