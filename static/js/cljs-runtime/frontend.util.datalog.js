...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__82778_SHARP_){
return (((p1__82778_SHARP_ instanceof cljs.core.Symbol)) && (cljs.core.contains_QMARK_(valid_rules,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__82778_SHARP_))));
...
var G__82797 = parsed;
var G__82798 = q;
var G__82799 = cljs.core.next(qs);
parsed = G__82797;
key = G__82798;
qs = G__82799;
continue;
} else {
var G__82801 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(parsed,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [key], null),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.conj,cljs.core.PersistentVector.EMPTY),q);
var G__82802 = key;
var G__82803 = cljs.core.next(qs);
parsed = G__82801;
key = G__82802;
qs = G__82803;
continue;
...
return cljs.core.vec(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__82792){
var vec__82793 = p__82792;
