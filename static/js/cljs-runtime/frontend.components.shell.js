...
})),'className':"form-input font-mono block w-full sm:text-sm sm:leading-5"},[])])])]),(function (){var attrs117541 = frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic("Run",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-click","on-click",1632826543),frontend.components.shell.run_command], 0));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs117541))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","items-center"], null)], null),attrs117541], 0))):{'className':"flex flex-row items-center"}),((cljs.core.map_QMARK_(attrs117541))?[(function (){var attrs117542 = (cljs.core.truth_(loading_QMARK_)?frontend.ui.loading.cljs$core$IFn$_invoke$arity$1(""):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs117542))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-4"], null)], null),attrs117542], 0))):{'className':"ml-4"}),((cljs.core.map_QMARK_(attrs117542))?null:[daiquiri.interpreter.interpret(attrs117542)]));
})()]:[daiquiri.interpreter.interpret(attrs117541),(function (){var attrs117543 = (cljs.core.truth_(loading_QMARK_)?frontend.ui.loading.cljs$core$IFn$_invoke$arity$1(""):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs117543))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-4"], null)], null),attrs117543], 0))):{'className':"ml-4"}),((cljs.core.map_QMARK_(attrs117543))?null:[daiquiri.interpreter.interpret(attrs117543)]));
})()]));
})()])]);
