...
var G__88719 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__88719__$1 = (((G__88719 == null))?null:cljs.core.iterate((function (loc){
...
var G__88719__$2 = (((G__88719__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__88719__$1));
var G__88719__$3 = (((G__88719__$2 == null))?null:cljs.core.last(G__88719__$2));
if((G__88719__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__88719__$3);
}
} else {
return zloc;
}
...
var G__88723 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__88724 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__88723;
parent = G__88724;
continue;
} else {
var G__88725 = rewrite_clj.zip.move.right(zloc_map_value);
var G__88726 = parent;
loc = G__88725;
parent = G__88726;
continue;
...
var G__88727 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__88728 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__88727;
parent = G__88728;
continue;
} else {
var G__88729 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__88730 = parent;
loc = G__88729;
parent = G__88730;
continue;
...
var G__88720 = zloc;
var G__88720__$1 = (((G__88720 == null))?null:rewrite_clj.zip.move.down(G__88720));
var G__88720__$2 = (((G__88720__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__88720__$1,k));
if((G__88720__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__88720__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__88721 = zloc;
var G__88721__$1 = (((G__88721 == null))?null:rewrite_clj.zip.move.down(G__88721));
var G__88721__$2 = (((G__88721__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__88721__$1));
var G__88721__$3 = (((G__88721__$2 == null))?null:rewrite_clj.zip.move.down(G__88721__$2));
var G__88721__$4 = (((G__88721__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__88721__$3,k));
if((G__88721__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__88721__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__88722 = rewrite_clj.zip.move.down(zloc);
var G__88722__$1 = (((G__88722 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__88722));
if((G__88722__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__88722__$1);
}
})(),k);
