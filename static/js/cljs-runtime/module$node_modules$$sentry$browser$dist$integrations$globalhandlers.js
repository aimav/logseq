...
client=client&&client.getOptions().attachStacktrace;return[hub,client]}Object.defineProperty(exports,"__esModule",{value:!0});var tslib_1=require("module$node_modules$$sentry$browser$node_modules$tslib$tslib"),core_1=require("module$node_modules$$sentry$core$dist$index"),types_1=require("module$node_modules$$sentry$types$dist$index"),utils_1=require("module$node_modules$$sentry$utils$dist$index"),eventbuilder_1=require("module$node_modules$$sentry$browser$dist$eventbuilder"),flags_1=require("module$node_modules$$sentry$browser$dist$flags"),
helpers_1=require("module$node_modules$$sentry$browser$dist$helpers"),GlobalHandlers=function(){function GlobalHandlers(options){this.name=GlobalHandlers.id;this._installFunc={onerror:_installGlobalOnErrorHandler,onunhandledrejection:_installGlobalOnUnhandledRejectionHandler};this._options=tslib_1.__assign({onerror:!0,onunhandledrejection:!0},options)}GlobalHandlers.prototype.setupOnce=function(){Error.stackTraceLimit=50;var options=this._options,key;for(key in options){var installFunc=this._installFunc[key];
installFunc&&options[key]&&(flags_1.IS_DEBUG_BUILD&&utils_1.logger.log("Global Handler attached: "+key),installFunc(),this._installFunc[key]=void 0)}};GlobalHandlers.id="GlobalHandlers";return GlobalHandlers}();exports.GlobalHandlers=GlobalHandlers}
