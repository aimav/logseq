...
var G__124517 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__124517__$1 = (((G__124517 instanceof cljs.core.Keyword))?G__124517.fqn:null);
switch (G__124517__$1) {
case "raw":
...
var G__124519 = arguments.length;
switch (G__124519) {
case 1:
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5520__auto__ = (function instaparse$reduction$iter__124520(s__124521){
return (new cljs.core.LazySeq(null,(function (){
var s__124521__$1 = s__124521;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__124521__$1);
if(temp__5804__auto__){
var s__124521__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__124521__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__124521__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__124523 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__124522 = (0);
while(true){
if((i__124522 < size__5519__auto__)){
var vec__124524 = cljs.core._nth(c__5518__auto__,i__124522);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__124524,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__124524,(1),null);
cljs.core.chunk_append(b__124523,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__124532 = (i__124522 + (1));
i__124522 = G__124532;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__124523),instaparse$reduction$iter__124520(cljs.core.chunk_rest(s__124521__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__124523),null);
}
} else {
var vec__124527 = cljs.core.first(s__124521__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__124527,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__124527,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__124520(cljs.core.rest(s__124521__$2)));
}
} else {
return null;
}
