...
null===b?Object.create(b):(__.prototype=b.prototype,new __)}}();Object.defineProperty(exports,"__esModule",{value:!0});var React=require("module$react"),react_dom_1=require("module$react_dom"),fastdom=require("module$node_modules$fastdom$fastdom"),context_1=require("module$node_modules$react_resize_context$dist$context"),methods_1=require("module$node_modules$react_resize_context$dist$methods");global=function(_super){function ResizeProvider(){var _this=null!==_super&&_super.apply(this,arguments)||
this;_this.state={size:null};_this.currentListenElement=null;_this.onSizeChanged=function(element){fastdom.clear(_this.measureID);_this.measureID=fastdom.measure(function(){var size=methods_1.getSize(element);_this.updateSize(size)})};_this.updateSize=function(size){fastdom.clear(_this.mutateID);_this.mutateID=fastdom.mutate(function(){_this.setState({size})})};return _this}__extends(ResizeProvider,_super);ResizeProvider.prototype.componentDidMount=function(){this.updateListenElement()};ResizeProvider.prototype.componentWillUnmount=
