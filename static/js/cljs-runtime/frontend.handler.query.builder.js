...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(((((cljs.core.coll_QMARK_(item)) && (cljs.core.not((function (){var G__110665 = cljs.core.first(item);
return (frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1(G__110665) : frontend.handler.query.builder.operators_set.call(null,G__110665));
...
var f = (function (p1__110670_SHARP_){
return frontend.handler.query.builder.vec_dissoc_item(p1__110670_SHARP_,idx);
});
if(cljs.core.seq(ks)){
...
var result = (cljs.core.truth_((function (){var and__5041__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(loc,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null));
if(and__5041__auto__){
var G__110685 = cljs.core.first(q);
return (frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1(G__110685) : frontend.handler.query.builder.operators_set.call(null,G__110685));
} else {
...
if(cljs.core.truth_(temp__5804__auto__)){
var x = temp__5804__auto__;
if(cljs.core.truth_((function (){var and__5041__auto__ = (function (){var G__110686 = cljs.core.first(x);
return (frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1(G__110686) : frontend.handler.query.builder.operators_set.call(null,G__110686));
})();
...
if(typeof x === 'string'){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(logseq.graph_parser.util.page_ref.__GT_page_ref(x));
} else {
var G__110687 = cljs.core.second(x);
return (frontend.handler.query.builder.__GT_page_ref.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.__GT_page_ref.cljs$core$IFn$_invoke$arity$1(G__110687) : frontend.handler.query.builder.__GT_page_ref.call(null,G__110687));
}
});
...
return cljs.core.vec(cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"task","task",-1476607993)),cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.symbol,cljs.core.rest(f))));
} else {
...
if(((cljs.core.vector_QMARK_(f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((3),cljs.core.count(f))) && (cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"page-property","page-property",-417044665),null,new cljs.core.Keyword(null,"property","property",-1114278232),null], null), null),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.first(f)))))))){
var l = ((logseq.graph_parser.util.page_ref.page_ref_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.last(f))))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(cljs.core.last(f)):cljs.core.last(f));
...
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.vector_QMARK_(f_SINGLEQUOTE_);
if(and__5041__auto__){
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"page-ref","page-ref",-1047131151),logseq.graph_parser.util.page_ref.get_page_name(cljs.core.str.cljs$core$IFn$_invoke$arity$1(f))], null);
} else {
if(cljs.core.truth_((function (){var and__5041__auto__ = typeof f === 'string';
if(and__5041__auto__){
return logseq.graph_parser.util.page_ref.get_page_name(f);
} else {
return and__5041__auto__;
}
})())){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"page-ref","page-ref",-1047131151),logseq.graph_parser.util.page_ref.get_page_name(f)], null);
} else {
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.list_QMARK_(f);
if(and__5041__auto__){
var and__5041__auto____$1 = (cljs.core.first(f) instanceof cljs.core.Symbol);
if(and__5041__auto____$1){
var G__110699 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.first(f));
return (frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1(G__110699) : frontend.handler.query.builder.operators_set.call(null,G__110699));
} else {
