...
var G__69099 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__69099 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__69099,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__69100 = cljs.core.seq(lvls);
var chunk__69102 = null;
var count__69103 = (0);
var i__69104 = (0);
while(true){
if((i__69104 < count__69103)){
var vec__69112 = chunk__69102.cljs$core$IIndexed$_nth$arity$2(null,i__69104);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69112,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69112,(1),null);
var level_69131__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_69131__$1);


var G__69132 = seq__69100;
var G__69133 = chunk__69102;
var G__69134 = count__69103;
var G__69135 = (i__69104 + (1));
seq__69100 = G__69132;
chunk__69102 = G__69133;
count__69103 = G__69134;
i__69104 = G__69135;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__69100);
if(temp__5804__auto__){
var seq__69100__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__69100__$1)){
var c__5565__auto__ = cljs.core.chunk_first(seq__69100__$1);
var G__69136 = cljs.core.chunk_rest(seq__69100__$1);
var G__69137 = c__5565__auto__;
var G__69138 = cljs.core.count(c__5565__auto__);
var G__69139 = (0);
seq__69100 = G__69136;
chunk__69102 = G__69137;
count__69103 = G__69138;
i__69104 = G__69139;
continue;
} else {
var vec__69115 = cljs.core.first(seq__69100__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69115,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69115,(1),null);
var level_69140__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_69140__$1);


var G__69141 = cljs.core.next(seq__69100__$1);
var G__69142 = null;
var G__69143 = (0);
var G__69144 = (0);
seq__69100 = G__69141;
chunk__69102 = G__69142;
count__69103 = G__69143;
i__69104 = G__69144;
continue;
}
} else {
...
var temp__5804__auto___69145 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5804__auto___69145)){
var instance_69146 = temp__5804__auto___69145;
instance_69146.setCapturing(true);

var instance_69147__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_69147__$1);

instance_69147__$1.setCapturing();
} else {
}
...
var G__69118 = (new goog.debug.FancyWindow());
G__69118.setEnabled(true);
...
var G__69119 = (new goog.debug.DivConsole(element));
G__69119.setCapturing(true);
...
var len__5766__auto___69148 = arguments.length;
var i__5767__auto___69149 = (0);
while(true){
if((i__5767__auto___69149 < len__5766__auto___69148)){
args__5772__auto__.push((arguments[i__5767__auto___69149]));

var G__69150 = (i__5767__auto___69149 + (1));
i__5767__auto___69149 = G__69150;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq69120){
var G__69121 = cljs.core.first(seq69120);
var seq69120__$1 = cljs.core.next(seq69120);
var G__69122 = cljs.core.first(seq69120__$1);
var seq69120__$2 = cljs.core.next(seq69120__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69121,G__69122,seq69120__$2);
}));
...
var G__69125 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"sequenceNumber","sequenceNumber",-543983615),record.sequenceNumber_,new cljs.core.Keyword(null,"time","time",1385887882),record.time_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case(record.level_.name)),new cljs.core.Keyword(null,"message","message",-406056002),record.msg_,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927),record.loggerName_,new cljs.core.Keyword(null,"exception","exception",-335277064),record.exception_], null);
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__69125) : handler_fn.call(null,G__69125));
});
if(cljs.core.truth_(logger)){
var temp__5804__auto___69152 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5804__auto___69152)){
var handler_69153 = temp__5804__auto___69152;
lambdaisland.glogi.goog_removeHandler(logger,handler_69153);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__69126,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5804__auto___69155 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5804__auto___69155)){
var handler_69156 = temp__5804__auto___69155;
lambdaisland.glogi.goog_removeHandler(logger,handler_69156);
} else {
}
