...
var G__118598 = config;
var G__118599 = block__$1;
var G__118600 = (level + (1));
return (frontend.extensions.slide.block_container.cljs$core$IFn$_invoke$arity$3 ? frontend.extensions.slide.block_container.cljs$core$IFn$_invoke$arity$3(G__118598,G__118599,G__118600) : frontend.extensions.slide.block_container.call(null,G__118598,G__118599,G__118600));
}),children):null);
...
var attrs118601 = dom_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs118601))?daiquiri.interpreter.element_attributes(attrs118601):null),((cljs.core.map_QMARK_(attrs118601))?[(function (){var attrs118602 = block_el;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs118602))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative"], null)], null),attrs118602], 0))):{'className':"relative"}),((cljs.core.map_QMARK_(attrs118602))?null:[daiquiri.interpreter.interpret(attrs118602)]));
})(),daiquiri.interpreter.interpret(children__$1)]:[daiquiri.interpreter.interpret(attrs118601),(function (){var attrs118603 = block_el;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs118603))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative"], null)], null),attrs118603], 0))):{'className':"relative"}),((cljs.core.map_QMARK_(attrs118603))?null:[daiquiri.interpreter.interpret(attrs118603)]));
})(),daiquiri.interpreter.interpret(children__$1)]));
} else {
var attrs118604 = dom_attrs;
return daiquiri.core.create_element("section",((cljs.core.map_QMARK_(attrs118604))?daiquiri.interpreter.element_attributes(attrs118604):null),((cljs.core.map_QMARK_(attrs118604))?[daiquiri.interpreter.interpret(block_el)]:[daiquiri.interpreter.interpret(attrs118604),daiquiri.interpreter.interpret(block_el)]));
}
...
var page = (function (){var G__118607 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__118607) : frontend.db.entity.call(null,G__118607));
})();
var journal_QMARK_ = new cljs.core.Keyword(null,"journal?","journal?",-897756522).cljs$core$IFn$_invoke$arity$1(page);
var repo = frontend.state.get_current_repo();
var blocks = frontend.modules.outliner.tree.blocks__GT_vec_tree.cljs$core$IFn$_invoke$arity$2((function (){var G__118608 = repo;
var G__118609 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
var G__118610 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"limit","limit",-1355822363),(1000)], null);
return (frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$3 ? frontend.db.get_paginated_blocks.cljs$core$IFn$_invoke$arity$3(G__118608,G__118609,G__118610) : frontend.db.get_paginated_blocks.call(null,G__118608,G__118609,G__118610));
})(),page_name);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__118606_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__118606_SHARP_,new cljs.core.Keyword("block","children","block/children",-1040716209));
