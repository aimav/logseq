...
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.not(hidden_QMARK_);
if(and__5041__auto__){
var G__123214 = (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"tag","tag",-1290361223)) : parser.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223)));
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__123214) : tag_set.call(null,G__123214));
} else {
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__123217){
var map__123218 = p__123217;
var map__123218__$1 = cljs.core.__destructure_map(map__123218);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123218__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123218__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
var G__123222 = arguments.length;
switch (G__123222) {
case 1:
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__123224,hidden_QMARK_){
var map__123225 = p__123224;
var map__123225__$1 = cljs.core.__destructure_map(map__123225);
var p = map__123225__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123225__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123225__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123225__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123225__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123225__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.not(hidden_QMARK_);
if(and__5041__auto__){
...
var G__123229 = tag;
var G__123229__$1 = (((G__123229 instanceof cljs.core.Keyword))?G__123229.fqn:null);
switch (G__123229__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__123234_123280 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__123235_123281 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__123236_123282 = true;
var _STAR_print_fn_STAR__temp_val__123237_123283 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__123236_123282);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__123237_123283);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__123235_123281);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__123234_123280);
}
...
case "string-ci":
var sb__5687__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__123239_123284 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__123240_123285 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__123241_123286 = true;
var _STAR_print_fn_STAR__temp_val__123242_123287 = (function (x__5688__auto__){
return sb__5687__auto__.append(x__5688__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__123241_123286);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__123242_123287);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__123240_123285);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__123239_123284);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5687__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__123229__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__123248){
var map__123249 = p__123248;
var map__123249__$1 = cljs.core.__destructure_map(map__123249);
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123249__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123249__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__5520__auto__ = (function instaparse$print$Parser__GT_str_$_iter__123251(s__123252){
return (new cljs.core.LazySeq(null,(function (){
var s__123252__$1 = s__123252;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__123252__$1);
if(temp__5804__auto__){
var s__123252__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__123252__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__123252__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__123254 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__123253 = (0);
while(true){
if((i__123253 < size__5519__auto__)){
var vec__123255 = cljs.core._nth(c__5518__auto__,i__123253);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123255,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123255,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__123254,instaparse.print.rule__GT_str(non_terminal,parser));

var G__123291 = (i__123253 + (1));
i__123253 = G__123291;
continue;
} else {
var G__123292 = (i__123253 + (1));
i__123253 = G__123292;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__123254),instaparse$print$Parser__GT_str_$_iter__123251(cljs.core.chunk_rest(s__123252__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__123254),null);
}
} else {
var vec__123261 = cljs.core.first(s__123252__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123261,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123261,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__123251(cljs.core.rest(s__123252__$2)));
} else {
var G__123293 = cljs.core.rest(s__123252__$2);
s__123252__$1 = G__123293;
continue;
}
}
} else {
