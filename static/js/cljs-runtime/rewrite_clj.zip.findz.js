...
var len__5766__auto___88705 = arguments.length;
var i__5767__auto___88706 = (0);
while(true){
if((i__5767__auto___88706 < len__5766__auto___88705)){
args__5772__auto__.push((arguments[i__5767__auto___88706]));

var G__88707 = (i__5767__auto___88706 + (1));
i__5767__auto___88706 = G__88707;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__88666){
var vec__88667 = p__88666;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88667,(0),null);
...
return (function (p1__88663_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__88663_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq88664){
var G__88665 = cljs.core.first(seq88664);
var seq88664__$1 = cljs.core.next(seq88664);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__88665,seq88664__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__88670 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88670,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88670,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__88673 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__88676 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88673,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88676,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88676,(1),null);
var vec__88679 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88673,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88679,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88679,(1),null);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__88684_SHARP_){
var and__5041__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__88684_SHARP_) : p_QMARK_.call(null,p1__88684_SHARP_));
if(cljs.core.truth_(and__5041__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__88684_SHARP_,pos);
} else {
return and__5041__auto__;
}
...
var G__88689 = zloc;
var G__88689__$1 = (((G__88689 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__88689) : f.call(null,G__88689)));
if((G__88689__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__88689__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__88690_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__88690_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__88695_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__88695_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__88700_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__88700_SHARP_),v);
}));
