...
tongue.core.format_inst_iso = (function (){var G__84790 = "{year}-{month-numeric-padded}-{day-padded}T{hour24-padded}:{minutes-padded}:{seconds-padded}";
var G__84791 = cljs.core.PersistentArrayMap.EMPTY;
return (tongue.core.inst_formatter.cljs$core$IFn$_invoke$arity$2 ? tongue.core.inst_formatter.cljs$core$IFn$_invoke$arity$2(G__84790,G__84791) : tongue.core.inst_formatter.call(null,G__84790,G__84791));
})();
...
var or__5043__auto__ = (function (){var fexpr__84792 = cljs.core.deref(tongue.core.tags_cache);
return (fexpr__84792.cljs$core$IFn$_invoke$arity$1 ? fexpr__84792.cljs$core$IFn$_invoke$arity$1(locale) : fexpr__84792.call(null,locale));
})();
...
var G__84813 = cljs.core.next(subtags);
var G__84814 = tag;
var G__84815 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(tags,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag));
subtags = G__84813;
last_tag = G__84814;
tags = G__84815;
continue;
...
var G__84816 = cljs.core.next(tags);
tags = G__84816;
continue;
}
}
...
var tongue$core$IInterpolate$interpolate_named$dyn_84817 = (function (v,dicts,locale,interpolations){
...
return tongue$core$IInterpolate$interpolate_named$dyn_84817(v,dicts,locale,interpolations);
}
});

var tongue$core$IInterpolate$interpolate_positional$dyn_84818 = (function (v,dicts,locale,interpolations){
var x__5390__auto__ = (((v == null))?null:v);
...
return tongue$core$IInterpolate$interpolate_positional$dyn_84818(v,dicts,locale,interpolations);
}
});
...
return clojure.string.replace(s,/\{([\w*!_?$%&=<>'\-+.#0-9]+|[\w*!_?$%&=<>'\-+.#0-9]+\/[\w*!_?$%&=<>'\-+.#0-9:]+)\}/,(function (p__84793){
var vec__84794 = p__84793;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84794,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84794,(1),null);
...
return clojure.string.replace(s,/\{(\d+)\}/,(function (p__84797){
var vec__84798 = p__84797;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84798,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84798,(1),null);
...
var len__5766__auto___84820 = arguments.length;
var i__5767__auto___84821 = (0);
while(true){
if((i__5767__auto___84821 < len__5766__auto___84820)){
args_arr__5791__auto__.push((arguments[i__5767__auto___84821]));

var G__84822 = (i__5767__auto___84821 + (1));
i__5767__auto___84821 = G__84822;
continue;
} else {
}
break;
...
/** @this {Function} */
(tongue.core.translate.cljs$lang$applyTo = (function (seq84803){
var G__84804 = cljs.core.first(seq84803);
var seq84803__$1 = cljs.core.next(seq84803);
var G__84805 = cljs.core.first(seq84803__$1);
var seq84803__$2 = cljs.core.next(seq84803__$1);
var G__84806 = cljs.core.first(seq84803__$2);
var seq84803__$3 = cljs.core.next(seq84803__$2);
var G__84807 = cljs.core.first(seq84803__$3);
var seq84803__$4 = cljs.core.next(seq84803__$3);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__84804,G__84805,G__84806,G__84807,seq84803__$4);
}));
...
var G__84824 = val;
var G__84825 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,v);
v = G__84824;
path = G__84825;
continue;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__84811_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.first(p1__84811_SHARP_),tongue.core.resolve_alias_1(m,cljs.core.second(p1__84811_SHARP_))],null));
}),m));
});
...
var G__84827 = function (locale,key,x,var_args){
var args = null;
if (arguments.length > 3) {
var G__84828__i = 0, G__84828__a = new Array(arguments.length -  3);
while (G__84828__i < G__84828__a.length) {G__84828__a[G__84828__i] = arguments[G__84828__i + 3]; ++G__84828__i;}
  args = new cljs.core.IndexedSeq(G__84828__a,0,null);
} 
return G__84827__delegate.call(this,locale,key,x,args);};
G__84827.cljs$lang$maxFixedArity = 3;
G__84827.cljs$lang$applyTo = (function (arglist__84829){
var locale = cljs.core.first(arglist__84829);
arglist__84829 = cljs.core.next(arglist__84829);
var key = cljs.core.first(arglist__84829);
arglist__84829 = cljs.core.next(arglist__84829);
var x = cljs.core.first(arglist__84829);
var args = cljs.core.rest(arglist__84829);
return G__84827__delegate(locale,key,x,args);
});
G__84827.cljs$core$IFn$_invoke$arity$variadic = G__84827__delegate;
return G__84827;
})()
;
G__84826 = function(locale,key,x,var_args){
var args = var_args;
switch(arguments.length){
case 2:
return G__84826__2.call(this,locale,key);
case 3:
return G__84826__3.call(this,locale,key,x);
default:
var G__84830 = null;
if (arguments.length > 3) {
var G__84831__i = 0, G__84831__a = new Array(arguments.length -  3);
while (G__84831__i < G__84831__a.length) {G__84831__a[G__84831__i] = arguments[G__84831__i + 3]; ++G__84831__i;}
G__84830 = new cljs.core.IndexedSeq(G__84831__a,0,null);
}
return G__84826__4.cljs$core$IFn$_invoke$arity$variadic(locale,key,x, G__84830);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__84826.cljs$lang$maxFixedArity = 3;
G__84826.cljs$lang$applyTo = G__84826__4.cljs$lang$applyTo;
G__84826.cljs$core$IFn$_invoke$arity$2 = G__84826__2;
G__84826.cljs$core$IFn$_invoke$arity$3 = G__84826__3;
G__84826.cljs$core$IFn$_invoke$arity$variadic = G__84826__4.cljs$core$IFn$_invoke$arity$variadic;
return G__84826;
})()
});
