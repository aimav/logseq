...
var reader = (function (){var or__5043__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__5043__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return (128);
...
var map__42516 = top_item;
var map__42516__$1 = cljs.core.__destructure_map(map__42516);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42516__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42516__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42516__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e42515){var _e = e42515;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___42534 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___42534)){
var seen_errors_42535 = temp__5802__auto___42534;
if(cljs.core.truth_(seen_errors_42535.has(self))){
} else {
seen_errors_42535.add(self);

var temp__5804__auto___42537 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___42537)){
var sense_42538 = temp__5804__auto___42537;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42538)].join(''));
} else {
}
}
} else {
