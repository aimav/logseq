...
(cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"cljs.core.async.impl.timers/SkipListNode");
}));
...
var i_45002 = (self__.level + (1));
while(true){
if((i_45002 <= (new_level + (1)))){
(update[i_45002] = self__.header);

var G__45003 = (i_45002 + (1));
i_45002 = G__45003;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_45004 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45004[i]));
} else {
x__$2.forward.push((((i < links_45004.length))?(links_45004[i]):null));
}

if((i < links_45004.length)){
(links_45004[i] = x__$2);
} else {
links_45004.push(x__$2);
}
...
var i_45006 = (0);
while(true){
if((i_45006 <= self__.level)){
var links_45007 = (update[i_45006]).forward;
if((x__$1 === (((i_45006 < links_45007.length))?(links_45007[i_45006]):null))){
(links_45007[i_45006] = (x__$1.forward[i_45006]));

var G__45008 = (i_45006 + (1));
i_45006 = G__45008;
continue;
} else {
var G__45009 = (i_45006 + (1));
i_45006 = G__45009;
continue;
}
} else {
...
var G__45011 = nx;
var G__45012 = (level__$1 - (1));
x = G__45011;
level__$1 = G__45012;
continue;
} else {
var G__45013 = x;
var G__45014 = (level__$1 - (1));
x = G__45013;
level__$1 = G__45014;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__45016 = nx;
var G__45017 = (level__$1 - (1));
x = G__45016;
level__$1 = G__45017;
continue;
} else {
var G__45018 = x;
var G__45019 = (level__$1 - (1));
x = G__45018;
level__$1 = G__45019;
continue;
}
...
(cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"cljs.core.async.impl.timers/SkipList");
}));
...
var or__5043__auto__ = (cljs.core.truth_((function (){var and__5041__auto__ = me__$1;
