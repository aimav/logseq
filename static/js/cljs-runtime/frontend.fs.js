...
if((typeof frontend !== 'undefined') && (typeof frontend.fs !== 'undefined') && (typeof frontend.fs.nfs_backend !== 'undefined')){
} else {
frontend.fs.nfs_backend = frontend.fs.nfs.__GT_Nfs();
}
...
if((typeof frontend !== 'undefined') && (typeof frontend.fs !== 'undefined') && (typeof frontend.fs.mobile_backend !== 'undefined')){
} else {
frontend.fs.mobile_backend = frontend.fs.capacitor_fs.__GT_Capacitorfs();
}
/**
...
return frontend.fs.mobile_backend;
} else {
return frontend.fs.nfs_backend;

}
}
});
frontend.fs.get_fs = (function frontend$fs$get_fs(dir){
var bfs_local_QMARK_ = (function (){var and__5041__auto__ = dir;
if(cljs.core.truth_(and__5041__auto__)){
return ((clojure.string.starts_with_QMARK_(dir,"/local")) || (clojure.string.starts_with_QMARK_(dir,"local")));
} else {
...
var len__5766__auto___85016 = arguments.length;
var i__5767__auto___85017 = (0);
while(true){
if((i__5767__auto___85017 < len__5766__auto___85016)){
args__5772__auto__.push((arguments[i__5767__auto___85017]));

var G__85018 = (i__5767__auto___85017 + (1));
i__5767__auto___85017 = G__85018;
continue;
} else {
}
break;
...
return frontend.fs.readdir.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5773__auto__);
});

(frontend.fs.readdir.cljs$core$IFn$_invoke$arity$variadic = (function (dir,p__84999){
var map__85000 = p__84999;
var map__85000__$1 = cljs.core.__destructure_map(map__85000);
var path_only_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85000__$1,new cljs.core.Keyword(null,"path-only?","path-only?",-825545027));
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.protocol.readdir(frontend.fs.get_fs(dir),dir),(function (result){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(cljs_bean.core.__GT_clj(result),(function (result__$1){
return promesa.protocols._promise(cljs.core.map.cljs$core$IFn$_invoke$arity$2(logseq.graph_parser.util.path_normalize,result__$1));
}));
}));
}));
}));
...
/** @this {Function} */
(frontend.fs.readdir.cljs$lang$applyTo = (function (seq84997){
var G__84998 = cljs.core.first(seq84997);
var seq84997__$1 = cljs.core.next(seq84997);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__84998,seq84997__$1);
}));
...
frontend.fs.write_file_BANG_ = (function frontend$fs$write_file_BANG_(repo,dir,rpath,content,opts){
if(cljs.core.truth_(content)){
var path = logseq.graph_parser.util.path_normalize(rpath);
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (error){
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.protocol.write_file_BANG_(frontend.fs.get_fs(dir),repo,dir,path,content,opts__$1),(function (_){
...
var new_path__$1 = logseq.graph_parser.util.path_normalize(new_path);
...
var vec__85006 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__85005_SHARP_){
...
return p1__85005_SHARP_;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(frontend.config.get_repo_dir(repo)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__85005_SHARP_)].join('');
}
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [old_path,new_path], null));
var old_path__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85006,(0),null);
var new_path__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85006,(1),null);
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.mkdir_if_not_exists(new_dir),(function (___37148__auto__){
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.protocol.open_dir(record,dir),(function (result){
return promesa.protocols._promise((cljs.core.truth_(result)?(function (){var map__85009 = result;
var map__85009__$1 = cljs.core.__destructure_map(map__85009);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85009__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var files = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85009__$1,new cljs.core.Keyword(null,"files","files",-472457450));
var dir__$1 = path;
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.protocol.get_files(fs_record,dir),(function (files){
return promesa.protocols._promise((function (){
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("frontend.fs","get-files","frontend.fs/get-files",52623820),cljs.core.count(files),"files"], 0));
...
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.stat.cljs$core$IFn$_invoke$arity$2(dir,path),(function (_stat){
return promesa.protocols._promise(true);
}));
})),(function (_error){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.write_file_BANG_(repo,dir,path,initial_content,null),(function (_){
...
return frontend.util.p_handle.cljs$core$IFn$_invoke$arity$3(frontend.fs.stat.cljs$core$IFn$_invoke$arity$1(fpath),(function (stat){
return (!((stat == null)));
}),(function (_e){
return false;
}));
...
return frontend.util.p_handle.cljs$core$IFn$_invoke$arity$3(frontend.fs.stat.cljs$core$IFn$_invoke$arity$2(dir,path),(function (stat){
return (!((stat == null)));
}),(function (_e){
return false;
}));
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.config.get_repo_dir(frontend.state.get_current_repo()),(function (repo_dir){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(logseq.common.path.relative_path(repo_dir,href),(function (rpath){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.file_exists_QMARK_.cljs$core$IFn$_invoke$arity$2(repo_dir,rpath),(function (exist_QMARK_){
...
if(cljs.core.truth_(frontend.mobile.util.native_platform_QMARK_())){
return frontend.fs.capacitor_fs.backup_file(repo,new cljs.core.Keyword(null,"backup-dir","backup-dir",287434857),path,db_content);
} else {
return null;
}
}
