...
var vec__50431 = cljs.core.name(k).split("-");
var seq__50432 = cljs.core.seq(vec__50431);
var first__50433 = cljs.core.first(seq__50432);
var seq__50432__$1 = cljs.core.next(seq__50432);
var first_word = first__50433;
var words = seq__50432__$1;
...
var or__5043__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(daiquiri.util.attrs_cache),k);
...
return cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (p1__50434_SHARP_,p2__50435_SHARP_,p3__50436_SHARP_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(p1__50434_SHARP_,daiquiri.util.camel_case(p2__50435_SHARP_),p3__50436_SHARP_);
...
var m__$1 = cljs.core.persistent_BANG_(cljs.core.reduce_kv((function (p1__50437_SHARP_,p2__50438_SHARP_,p3__50439_SHARP_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(p1__50437_SHARP_,daiquiri.util.camel_case(p2__50438_SHARP_),p3__50439_SHARP_);
}),cljs.core.transient$(cljs.core.PersistentArrayMap.EMPTY),m));
var G__50440 = m__$1;
if(cljs.core.map_QMARK_(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m__$1))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__50440,new cljs.core.Keyword(null,"style","style",-496642736),daiquiri.util.camel_case_keys);
} else {
return G__50440;
}
} else {
