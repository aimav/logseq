...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.handler.editor.get_asset_path(filename),(function (image_path){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(module$node_modules$$capacitor$filesystem$dist$plugin_cjs.Filesystem.writeFile(cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"data","data",-232669377),photo.base64String,new cljs.core.Keyword(null,"path","path",-188191168),image_path,new cljs.core.Keyword(null,"recursive","recursive",718885872),true], null))),(function (_ret){
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(null,(function (___37159__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.mobile.camera.take_or_choose_photo(),(function (filename){
