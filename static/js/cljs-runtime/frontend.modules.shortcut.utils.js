...
}catch (e101163){if((e101163 instanceof Error)){
var e = e101163;
...
return clojure.string.lower_case(frontend.modules.shortcut.utils.mod_key(clojure.string.replace(clojure.string.replace(binding,/[;=-\[\]'\(\)\~\→\←\⇧]/,(function (p1__101164_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(keynames,p1__101164_SHARP_);
})),/\s+/," ")));
} else {
return null;
}
