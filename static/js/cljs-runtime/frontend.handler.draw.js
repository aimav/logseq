...
return frontend.util.p_handle.cljs$core$IFn$_invoke$arity$3(frontend.fs.mkdir_BANG_([cljs.core.str.cljs$core$IFn$_invoke$arity$1(repo_dir),["/",logseq.graph_parser.config.default_draw_directory].join('')].join('')),(function (_result){
return null;
}),(function (_error){
return null;
}));
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.handler.draw.create_draws_directory_BANG_(repo),(function (___37148__auto__){
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.write_file_BANG_(repo,repo_dir,path,data,null),(function (___37148__auto____$1){
return promesa.protocols._promise((function (){var G__91494 = repo;
var G__91495 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("file","path","file/path",-191335748),path,new cljs.core.Keyword("block","name","block/name",1619760316),(frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(file) : frontend.util.page_name_sanity_lc.call(null,file)),new cljs.core.Keyword("block","file","block/file",183171933),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("file","path","file/path",-191335748),path], null),new cljs.core.Keyword("block","journal?","block/journal?",-970683127),false], null)], null);
return (frontend.db.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? frontend.db.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__91494,G__91495) : frontend.db.transact_BANG_.call(null,G__91494,G__91495));
})());
}));
}));
})),(function (error){
...
return promesa.core.bind.cljs$core$IFn$_invoke$arity$2(frontend.fs.file_exists_QMARK_.cljs$core$IFn$_invoke$arity$2(frontend.config.get_repo_dir(repo),[logseq.graph_parser.config.default_draw_directory,cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_file)].join('')),(function (exists_QMARK_){
