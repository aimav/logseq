...
(clojure.test.check.rose_tree.RoseTree.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"clojure.test.check.rose-tree/RoseTree");
}));
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__121178 = (n - (1));
var G__121179 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__121178,G__121179) : clojure.test.check.rose_tree.exclude_nth.call(null,G__121178,G__121179));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__121181 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__121181) : f.call(null,G__121181));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__121180_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__121180_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__121180_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__121182_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__121182_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__121182_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__121183_SHARP_){
var G__121184 = clojure.test.check.rose_tree.root(p1__121183_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__121184) : pred.call(null,G__121184));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5520__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__121185(s__121186){
return (new cljs.core.LazySeq(null,(function (){
var s__121186__$1 = s__121186;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__121186__$1);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var vec__121191 = cljs.core.first(xs__6360__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121191,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121191,(1),null);
var iterys__5516__auto__ = ((function (s__121186__$1,vec__121191,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__121185_$_iter__121187(s__121188){
return (new cljs.core.LazySeq(null,((function (s__121186__$1,vec__121191,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function (){
var s__121188__$1 = s__121188;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__121188__$1);
if(temp__5804__auto____$1){
var s__121188__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__121188__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__121188__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__121190 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__121189 = (0);
while(true){
if((i__121189 < size__5519__auto__)){
var child = cljs.core._nth(c__5518__auto__,i__121189);
cljs.core.chunk_append(b__121190,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__121200 = (i__121189 + (1));
i__121189 = G__121200;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__121190),clojure$test$check$rose_tree$permutations_$_iter__121185_$_iter__121187(cljs.core.chunk_rest(s__121188__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__121190),null);
}
} else {
var child = cljs.core.first(s__121188__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__121185_$_iter__121187(cljs.core.rest(s__121188__$2)));
}
} else {
return null;
}
...
});})(s__121186__$1,vec__121191,rose,index,xs__6360__auto__,temp__5804__auto__))
,null,null));
});})(s__121186__$1,vec__121191,rose,index,xs__6360__auto__,temp__5804__auto__))
;
var fs__5517__auto__ = cljs.core.seq(iterys__5516__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5517__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5517__auto__,clojure$test$check$rose_tree$permutations_$_iter__121185(cljs.core.rest(s__121186__$1)));
} else {
var G__121201 = cljs.core.rest(s__121186__$1);
s__121186__$1 = G__121201;
continue;
}
} else {
return null;
...
return iter__5520__auto__(cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,roses,cljs.core.range.cljs$core$IFn$_invoke$arity$0()));
});
/**
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__121194_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__121194_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__121194_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__121195_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__121195_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__121195_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__121196 = f;
var G__121197 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__121196,G__121197) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__121196,G__121197));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__121198 = f;
var G__121199 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__121198,G__121199) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__121198,G__121199));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
