...
var vec__115102 = cljs.math.setup_hl(ix,hx__$1,lx);
var hx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115102,(0),null);
var lx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115102,(1),null);
var vec__115105 = cljs.math.setup_hl(iy,hy__$1,ly);
var hy__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115105,(0),null);
var ly__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115105,(1),null);
var vec__115108 = (function (){var n = (ix - iy);
var hx__$3 = hx__$2;
var lx__$2 = lx__$1;
while(true){
if((n === (0))){
...
var vec__115120 = (((hz < (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hx__$3 + hx__$3) + (lx__$2 >>> (31))),(lx__$2 + lx__$2)], null):((((hz | lz) === (0)))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Signed zero",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"zero","zero",-858964576),true], null))})():new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hz + hz) + (lz >>> (31))),(lz + lz)], null)));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115120,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115120,(1),null);
var G__115144 = (n - (1));
var G__115145 = ((4294967295) & hx__$4);
var G__115146 = ((4294967295) & lx__$3);
n = G__115144;
hx__$3 = G__115145;
lx__$2 = G__115146;
continue;
...
var hx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115108,(0),null);
var lx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115108,(1),null);
var hz = ((cljs.math.u_LT_(lx__$2,ly__$1))?((hx__$3 - hy__$2) - (1)):(hx__$3 - hy__$2));
var lz = (lx__$2 - ly__$1);
var vec__115111 = (((hz >= (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hz,lz], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hx__$3,lx__$2], null));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115111,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115111,(1),null);
...
var vec__115114 = (function (){var hx__$5 = hx__$4;
var lx__$4 = lx__$3;
var iy__$1 = iy;
while(true){
if((!((hx__$5 < (1048576))))){
...
var G__115147 = ((hx__$5 + hx__$5) + (lx__$4 >>> (31)));
var G__115148 = (lx__$4 + lx__$4);
var G__115149 = (iy__$1 - (1));
hx__$5 = G__115147;
lx__$4 = G__115148;
iy__$1 = G__115149;
continue;
...
var hx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115114,(0),null);
var lx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115114,(1),null);
var iy__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115114,(2),null);
if((iy__$1 >= (-1022))){
...
var n = ((-1022) - iy__$1);
var vec__115123 = (((n <= (20)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(hx__$5 >> n),((lx__$4 >>> n) | (hx__$5 << ((32) - n)))], null):(((n <= (31)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,((hx__$5 << ((32) - n)) | (lx__$4 >>> n))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,(hx__$5 >> (n - (32)))], null)
));
var hx__$6 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115123,(0),null);
var lx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115123,(1),null);
(i[cljs.math.HI_x] = (hx__$6 | sx));
...
}catch (e115101){var ___$2 = e115101;
return (cljs.math.Zero[(sx >>> (31))]);
}
}
}
...
var vec__115127 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115127,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115127,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__115130 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115130,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115130,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__115133 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115133,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115133,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__115136 = (((d > (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115136,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115136,(1),null);
(i[cljs.math.HI] = hr);
...
var vec__115139 = (((scaleFactor < (0)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [Math.max(scaleFactor,(- cljs.math.MAX_SCALE)),(-512),cljs.math.two_to_the_double_scale_down], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [Math.min(scaleFactor,cljs.math.MAX_SCALE),(512),cljs.math.two_to_the_double_scale_up], null));
var scale_factor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115139,(0),null);
var scale_increment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115139,(1),null);
var exp_delta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__115139,(2),null);
...
var G__115151 = (d__$1 * exp_delta);
var G__115152 = (scale_factor__$1 - scale_increment);
d__$1 = G__115151;
scale_factor__$1 = G__115152;
continue;
}
break;
}
