...
var o43883 = temp__5802__auto__;
var temp__5802__auto____$1 = (o43883["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o43884 = temp__5802__auto____$1;
return (o43884["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42246__auto__ = f;
return (o__42246__auto__["toString"]).call(o__42246__auto__);
} else {
return "";
}
}catch (e43885){var _ = e43885;
return "";
}});
...
try{var o__42246__auto___43963 = t;
(o__42246__auto___43963["cljs$lang$ctorPrWriter"]).call(o__42246__auto___43963,t,writer);
}catch (e43886){var __43964 = e43886;
}
...
var char_code = (function (){var o__42246__auto__ = (new String(char$));
return (o__42246__auto__["charCodeAt"]).call(o__42246__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42246__auto__ = String;
return (o__42246__auto__["fromCharCode"]).call(o__42246__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43887 = num_code;
switch (G__43887) {
case (1):
return (185);
...
var o__42246__auto__ = String;
return (o__42246__auto__["fromCharCode"]).call(o__42246__auto__,superscript_code);
});
/**
...
}catch (e43888){var _e__42258__auto__ = e43888;
return false;
}})())){
...
var vec__43889 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43889,(0),null);
...
var or__5043__auto__ = (function (){var temp__5802__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5802__auto__)){
...
var len__5766__auto___43966 = arguments.length;
var i__5767__auto___43967 = (0);
while(true){
if((i__5767__auto___43967 < len__5766__auto___43966)){
args__5772__auto__.push((arguments[i__5767__auto___43967]));

var G__43968 = (i__5767__auto___43967 + (1));
i__5767__auto___43967 = G__43968;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5773__auto__);
});

(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43894){
var vec__43895 = p__43894;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43895,(0),null);
var effective_detector = (function (){var or__5043__auto__ = ns_detector;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var G__43969 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__43970 = cljs.core.butlast(remaining_tokens);
name_tokens = G__43969;
remaining_tokens = G__43970;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43892){
var G__43893 = cljs.core.first(seq43892);
var seq43892__$1 = cljs.core.next(seq43892);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43893,seq43892__$1);
}));
...
var vec__43900 = cljs.core.split_with((function (p1__43899_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43899_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43900,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43900,(1),null);
...
var vec__43906 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43906,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43906,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__43972 = cljs.core.rest(remaining_tokens);
var G__43973 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__43972;
name_tokens = G__43973;
continue;
} else {
...
var vec__43911 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43911,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43911,(1),null);
var vec__43914 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43914,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43914,(1),null);
var vec__43917 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43917,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43917,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43917,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43917,(3),null);
...
var vec__43922 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43922,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__43925 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43925,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43925,(1),null);
var vec__43928 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43928,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43928,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__43931 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__43931) : devtools.munging.parse_fn_info_deep.call(null,G__43931));
})()));
}
} else {
return fn_info;
...
var G__43976 = (arity + (1));
var G__43977 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43932){
var vec__43933 = p__43932;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43933,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43933,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities(f,(function (){var or__5043__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43936_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__43936_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43937_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__43937_SHARP_);
}),sorted_infos);
...
var args__5772__auto__ = [];
var len__5766__auto___43978 = arguments.length;
var i__5767__auto___43979 = (0);
while(true){
if((i__5767__auto___43979 < len__5766__auto___43978)){
args__5772__auto__.push((arguments[i__5767__auto___43979]));

var G__43980 = (i__5767__auto___43979 + (1));
i__5767__auto___43979 = G__43980;
continue;
} else {
}
break;
...
var argseq__5773__auto__ = ((((1) < args__5772__auto__.length))?(new cljs.core.IndexedSeq(args__5772__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5773__auto__);
});

(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43940){
var vec__43941 = p__43940;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43941,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43938){
var G__43939 = cljs.core.first(seq43938);
var seq43938__$1 = cljs.core.next(seq43938);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43939,seq43938__$1);
}));
...
return devtools.munging.args_lists_to_strings(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((function (){var or__5043__auto__ = devtools.munging.collect_fn_arities(f);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
return [(cljs.core.truth_((function (){var and__5041__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_(protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_(protocol_method))))?[(cljs.core.truth_((function (){var or__5043__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var map__43945 = options;
var map__43945__$1 = cljs.core.__destructure_map(map__43945);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43945__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43945__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43945__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43945__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43946 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43946,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43946,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43946,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43946,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43946,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43946,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__5041__auto__ = protocol_ns;
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core.not((function (){var and__5041__auto____$1 = silence_common_protocols_QMARK_;
...
return [(function (){var or__5043__auto__ = protocol_part;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return fn_part;
...
var o__42246__auto__ = f;
return (o__42246__auto__["getBasis"]).call(o__42246__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__5041__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__5041__auto__)){
...
}catch (e43949){var _e__42258__auto__ = e43949;
...
var G__43982 = (obj[cljs.core.first(path)]);
var G__43983 = cljs.core.rest(path);
obj = G__43982;
path = G__43983;
continue;
} else {
...
var partition_bits = (function (){var or__5043__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return (0);
...
var _STAR_ = (function (accum,p__43950){
var vec__43951 = p__43950;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43951,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43951,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43954){
var vec__43955 = p__43954;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43955,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43955,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43955,(2),null);
...
var post_process = (function (p__43959){
var vec__43960 = p__43959;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43960,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43960,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43958_SHARP_){
return (obj[cljs.core.first(p1__43958_SHARP_)]);
}),sorted_matches);
