...
var clojure$test$check$random$IRandom$rand_long$dyn_121170 = (function (rng){
var x__5390__auto__ = (((rng == null))?null:rng);
var m__5391__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__5390__auto__)]);
if((!((m__5391__auto__ == null)))){
return (m__5391__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5391__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5391__auto__.call(null,rng));
} else {
var m__5389__auto__ = (clojure.test.check.random.rand_long["_"]);
if((!((m__5389__auto__ == null)))){
return (m__5389__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5389__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5389__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_long$dyn_121170(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_121171 = (function (rng){
var x__5390__auto__ = (((rng == null))?null:rng);
var m__5391__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__5390__auto__)]);
if((!((m__5391__auto__ == null)))){
return (m__5391__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5391__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5391__auto__.call(null,rng));
} else {
var m__5389__auto__ = (clojure.test.check.random.rand_double["_"]);
if((!((m__5389__auto__ == null)))){
return (m__5389__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5389__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5389__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_double$dyn_121171(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_121172 = (function (rng){
var x__5390__auto__ = (((rng == null))?null:rng);
var m__5391__auto__ = (clojure.test.check.random.split[goog.typeOf(x__5390__auto__)]);
if((!((m__5391__auto__ == null)))){
return (m__5391__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5391__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5391__auto__.call(null,rng));
} else {
var m__5389__auto__ = (clojure.test.check.random.split["_"]);
if((!((m__5389__auto__ == null)))){
return (m__5389__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5389__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__5389__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$split$dyn_121172(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_121173 = (function (rng,n){
var x__5390__auto__ = (((rng == null))?null:rng);
var m__5391__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__5390__auto__)]);
if((!((m__5391__auto__ == null)))){
return (m__5391__auto__.cljs$core$IFn$_invoke$arity$2 ? m__5391__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__5391__auto__.call(null,rng,n));
} else {
var m__5389__auto__ = (clojure.test.check.random.split_n["_"]);
if((!((m__5389__auto__ == null)))){
return (m__5389__auto__.cljs$core$IFn$_invoke$arity$2 ? m__5389__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__5389__auto__.call(null,rng,n));
} else {
...
return clojure$test$check$random$IRandom$split_n$dyn_121173(rng,n);
}
});
...
var G__121160 = z;
if(((24) > (function (){var G__121161 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__121161) : clojure.test.check.random.longs.bit_count.call(null,G__121161));
})())){
return clojure.test.check.random.longs.bit_xor(G__121160,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__121160;
}
});
...
var G__121175 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__121176 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__121175;
ret = G__121176;
continue;
}
...
(clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
}));
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__5043__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__121163){
var map__121164 = p__121163;
var map__121164__$1 = cljs.core.__destructure_map(map__121164);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121164__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__121165 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121165,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121165,(1),null);
...
var G__121169 = arguments.length;
switch (G__121169) {
case 0:
