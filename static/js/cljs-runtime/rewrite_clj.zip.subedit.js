...
var zloc_SINGLEQUOTE_ = (function (){var G__90007 = zloc;
var G__90007__$1 = (((G__90007 == null))?null:rewrite_clj.custom_zipper.core.node(G__90007));
if((G__90007__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.of_node_STAR_.cljs$core$IFn$_invoke$arity$2(G__90007__$1,rewrite_clj.zip.options.get_opts(zloc));
}
})();
...
var zloc_SINGLEQUOTE_ = (function (){var G__90009 = rewrite_clj.zip.subedit.subzip(zloc);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__90009) : f.call(null,G__90009));
})();
if((!((zloc_SINGLEQUOTE_ == null)))){
} else {
