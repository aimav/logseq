...
"use strict";var pna=require("module$node_modules$process_nextick_args$index");module.exports=Readable;var isArray=require("module$node_modules$isarray$index"),Duplex;Readable.ReadableState=ReadableState;require("module$node_modules$events$events");var Stream=require("module$node_modules$readable_stream$lib$internal$streams$stream_browser"),Buffer=require("module$node_modules$readable_stream$node_modules$safe_buffer$index").Buffer,OurUint8Array=("undefined"!==typeof global?global:"undefined"!==typeof window?
window:"undefined"!==typeof self?self:{}).Uint8Array||function(){};global=Object.create(require("module$node_modules$util$util"));global.inherits=require("module$node_modules$inherits$inherits_browser");module=require("module$node_modules$util$util");var debug=void 0;debug=module&&module.debuglog?module.debuglog("stream"):function(){};var BufferList=require("module$node_modules$readable_stream$lib$internal$streams$BufferList");module=require("module$node_modules$readable_stream$lib$internal$streams$destroy");
var StringDecoder;global.inherits(Readable,Stream);var kProxyEvents=["error","close","destroy","pause","resume"];Object.defineProperty(Readable.prototype,"destroyed",{get:function(){return void 0===this._readableState?!1:this._readableState.destroyed},set:function(value){this._readableState&&(this._readableState.destroyed=value)}});Readable.prototype.destroy=module.destroy;Readable.prototype._undestroy=module.undestroy;Readable.prototype._destroy=function(err,cb){this.push(null);cb(err)};Readable.prototype.push=
function(chunk,encoding){var state=this._readableState;if(state.objectMode)var skipChunkCheck=!0;else"string"===typeof chunk&&(encoding=encoding||state.defaultEncoding,encoding!==state.encoding&&(chunk=Buffer.from(chunk,encoding),encoding=""),skipChunkCheck=!0);return readableAddChunk(this,chunk,encoding,!1,skipChunkCheck)};Readable.prototype.unshift=function(chunk){return readableAddChunk(this,chunk,null,!0,!1)};Readable.prototype.isPaused=function(){return!1===this._readableState.flowing};Readable.prototype.setEncoding=
function(enc){StringDecoder||(StringDecoder=require("module$node_modules$readable_stream$node_modules$string_decoder$lib$string_decoder").StringDecoder);this._readableState.decoder=new StringDecoder(enc);this._readableState.encoding=enc;return this};Readable.prototype.read=function(n){debug("read",n);n=parseInt(n,10);var state=this._readableState,nOrig=n;0!==n&&(state.emittedReadable=!1);if(0===n&&state.needReadable&&(state.length>=state.highWaterMark||state.ended))return debug("read: emitReadable",
...
!0),this._read(state.highWaterMark),state.sync=!1,state.reading||(n=howMuchToRead(nOrig,state)));doRead=0<n?fromList(n,state):null;null===doRead?(state.needReadable=!0,n=0):state.length-=n;0===state.length&&(state.ended||(state.needReadable=!0),nOrig!==n&&state.ended&&endReadable(this));null!==doRead&&this.emit("data",doRead);return doRead};Readable.prototype._read=function(n){this.emit("error",Error("_read() is not implemented"))};Readable.prototype.pipe=function(dest,pipeOpts){function onunpipe(readable,
unpipeInfo){debug("onunpipe");readable===src&&unpipeInfo&&!1===unpipeInfo.hasUnpiped&&(unpipeInfo.hasUnpiped=!0,debug("cleanup"),dest.removeListener("close",onclose),dest.removeListener("finish",onfinish),dest.removeListener("drain",ondrain),dest.removeListener("error",onerror),dest.removeListener("unpipe",onunpipe),src.removeListener("end",onend),src.removeListener("end",unpipe),src.removeListener("data",ondata),cleanedUp=!0,!state.awaitDrain||dest._writableState&&!dest._writableState.needDrain||
ondrain())}function onend(){debug("onend");dest.end()}function ondata(chunk){debug("ondata");increasedAwaitDrain=!1;!1!==dest.write(chunk)||increasedAwaitDrain||((1===state.pipesCount&&state.pipes===dest||1<state.pipesCount&&-1!==indexOf(state.pipes,dest))&&!cleanedUp&&(debug("false write response, pause",state.awaitDrain),state.awaitDrain++,increasedAwaitDrain=!0),src.pause())}function onerror(er){debug("onerror",er);unpipe();dest.removeListener("error",onerror);0===dest.listeners("error").length&&
dest.emit("error",er)}function onclose(){dest.removeListener("finish",onfinish);unpipe()}function onfinish(){debug("onfinish");dest.removeListener("close",onclose);unpipe()}function unpipe(){debug("unpipe");src.unpipe(dest)}var src=this,state=this._readableState;switch(state.pipesCount){case 0:state.pipes=dest;break;case 1:state.pipes=[state.pipes,dest];break;default:state.pipes.push(dest)}state.pipesCount+=1;debug("pipe count\x3d%d opts\x3d%j",state.pipesCount,pipeOpts);pipeOpts=pipeOpts&&!1===pipeOpts.end||
dest===process.stdout||dest===process.stderr?unpipe:onend;if(state.endEmitted)pna.nextTick(pipeOpts);else src.once("end",pipeOpts);dest.on("unpipe",onunpipe);var ondrain=pipeOnDrain(src);dest.on("drain",ondrain);var cleanedUp=!1,increasedAwaitDrain=!1;src.on("data",ondata);prependListener(dest,"error",onerror);dest.once("close",onclose);dest.once("finish",onfinish);dest.emit("pipe",src);state.flowing||(debug("pipe resume"),src.resume());return dest};Readable.prototype.unpipe=function(dest){var state=
this._readableState,unpipeInfo={hasUnpiped:!1};if(0===state.pipesCount)return this;if(1===state.pipesCount){if(dest&&dest!==state.pipes)return this;dest||(dest=state.pipes);state.pipes=null;state.pipesCount=0;state.flowing=!1;dest&&dest.emit("unpipe",this,unpipeInfo);return this}if(!dest){dest=state.pipes;unpipeInfo=state.pipesCount;state.pipes=null;state.pipesCount=0;state.flowing=!1;for(state=0;state<unpipeInfo;state++)dest[state].emit("unpipe",this,{hasUnpiped:!1});return this}var index=indexOf(state.pipes,
dest);if(-1===index)return this;state.pipes.splice(index,1);--state.pipesCount;1===state.pipesCount&&(state.pipes=state.pipes[0]);dest.emit("unpipe",this,unpipeInfo);return this};Readable.prototype.on=function(ev,fn){fn=Stream.prototype.on.call(this,ev,fn);"data"===ev?!1!==this._readableState.flowing&&this.resume():"readable"===ev&&(ev=this._readableState,ev.endEmitted||ev.readableListening||(ev.readableListening=ev.needReadable=!0,ev.emittedReadable=!1,ev.reading?ev.length&&emitReadable(this):pna.nextTick(nReadingNextTick,
this)));return fn};Readable.prototype.addListener=Readable.prototype.on;Readable.prototype.resume=function(){var state=this._readableState;state.flowing||(debug("resume"),state.flowing=!0,state.resumeScheduled||(state.resumeScheduled=!0,pna.nextTick(resume_,this,state)));return this};Readable.prototype.pause=function(){debug("call pause flowing\x3d%j",this._readableState.flowing);!1!==this._readableState.flowing&&(debug("pause"),this._readableState.flowing=!1,this.emit("pause"));return this};Readable.prototype.wrap=
function(stream){var _this=this,state=this._readableState,paused=!1;stream.on("end",function(){debug("wrapped end");if(state.decoder&&!state.ended){var chunk=state.decoder.end();chunk&&chunk.length&&_this.push(chunk)}_this.push(null)});stream.on("data",function(chunk){debug("wrapped data");state.decoder&&(chunk=state.decoder.write(chunk));state.objectMode&&(null===chunk||void 0===chunk)||!(state.objectMode||chunk&&chunk.length)||_this.push(chunk)||(paused=!0,stream.pause())});for(var i in stream)void 0===
this[i]&&"function"===typeof stream[i]&&(this[i]=function(method){return function(){return stream[method].apply(stream,arguments)}}(i));for(i=0;i<kProxyEvents.length;i++)stream.on(kProxyEvents[i],this.emit.bind(this,kProxyEvents[i]));this._read=function(n){debug("wrapped _read",n);paused&&(paused=!1,stream.resume())};return this};Object.defineProperty(Readable.prototype,"readableHighWaterMark",{enumerable:!1,get:function(){return this._readableState.highWaterMark}});Readable._fromList=fromList}
