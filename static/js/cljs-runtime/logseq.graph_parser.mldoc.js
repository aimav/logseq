...
var G__69160 = opt;
var G__69160__$1 = (((G__69160 instanceof cljs.core.Keyword))?G__69160.fqn:null);
switch (G__69160__$1) {
case "page-ref":
...
return logseq.graph_parser.util.json__GT_clj((logseq.graph_parser.mldoc.getReferences.cljs$core$IFn$_invoke$arity$2 ? logseq.graph_parser.mldoc.getReferences.cljs$core$IFn$_invoke$arity$2(text,config) : logseq.graph_parser.mldoc.getReferences.call(null,text,config)));
}
});
...
var G__69161 = ast;
var G__69162 = config;
var G__69163 = (function (){var or__5043__auto__ = references;
...
return (logseq.graph_parser.mldoc.astExportMarkdown.cljs$core$IFn$_invoke$arity$3 ? logseq.graph_parser.mldoc.astExportMarkdown.cljs$core$IFn$_invoke$arity$3(G__69161,G__69162,G__69163) : logseq.graph_parser.mldoc.astExportMarkdown.call(null,G__69161,G__69162,G__69163));
});
...
(logseq.graph_parser.mldoc.default_config.cljs$core$IFn$_invoke$arity$2 = (function (format,p__69167){
var map__69168 = p__69167;
var map__69168__$1 = cljs.core.__destructure_map(map__69168);
var export_heading_to_list_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69168__$1,new cljs.core.Keyword(null,"export-heading-to-list?","export-heading-to-list?",-596132321));
var export_keep_properties_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69168__$1,new cljs.core.Keyword(null,"export-keep-properties?","export-keep-properties?",1001383866));
var export_md_indent_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69168__$1,new cljs.core.Keyword(null,"export-md-indent-style","export-md-indent-style",481813710));
var export_md_remove_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69168__$1,new cljs.core.Keyword(null,"export-md-remove-options","export-md-remove-options",-1015252352));
var parse_outline_only_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69168__$1,new cljs.core.Keyword(null,"parse_outline_only?","parse_outline_only?",-731229637));
...
return JSON.stringify(cljs_bean.core.__GT_js(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__69164_SHARP_){
return (!((cljs.core.second(p1__69164_SHARP_) == null)));
...
var vec__69169 = lines;
var seq__69170 = cljs.core.seq(vec__69169);
var first__69171 = cljs.core.first(seq__69170);
var seq__69170__$1 = cljs.core.next(seq__69170);
var f = first__69171;
var r = seq__69170__$1;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__69172){
var vec__69173 = p__69172;
var block = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69173,(0),null);
var pos_meta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69173,(1),null);
if(((cljs.core.vector_QMARK_(block)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("Src",cljs.core.first(block))))){
var map__69176 = pos_meta;
var map__69176__$1 = cljs.core.__destructure_map(map__69176);
var start_pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69176__$1,new cljs.core.Keyword(null,"start_pos","start_pos",272375959));
var end_pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69176__$1,new cljs.core.Keyword(null,"end_pos","end_pos",-1418940));
...
var directive_QMARK_ = (function (p__69180){
var vec__69181 = p__69180;
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69181,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69181,(1),null);
...
var vec__69177 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.get.cljs$core$IFn$_invoke$arity$2(grouped_ast,true)),cljs.core.get.cljs$core$IFn$_invoke$arity$2(grouped_ast,false)], null);
var properties_ast = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69177,(0),null);
var other_ast = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69177,(1),null);
var properties = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__69184){
var vec__69185 = p__69184;
var _directive = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69185,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69185,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69185,(2),null);
...
logseq.graph_parser.mldoc.__GT_edn = (function logseq$graph_parser$mldoc$__GT_edn(content,config){
if(typeof content === 'string'){
try{if(clojure.string.blank_QMARK_(content)){
return cljs.core.PersistentVector.EMPTY;
} else {
return logseq.graph_parser.mldoc.collect_page_properties(logseq.graph_parser.mldoc.update_src_full_content(logseq.graph_parser.util.json__GT_clj(logseq.graph_parser.mldoc.parse_json(content,config)),content),config);
}
}catch (e69188){var e = e69188;
lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("logseq.graph-parser.mldoc",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"unexpected-error","unexpected-error",1973845951),e,new cljs.core.Keyword(null,"line","line",212345235),146], null)),null);
...
}catch (e69189){var _e = e69189;
return cljs.core.PersistentVector.EMPTY;
}});
logseq.graph_parser.mldoc.ast_link_QMARK_ = (function logseq$graph_parser$mldoc$ast_link_QMARK_(p__69190){
var vec__69191 = p__69190;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69191,(0),null);
var link = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69191,(1),null);
var vec__69194 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(link);
var ref_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69194,(0),null);
var ref_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69194,(1),null);
...
var G__69197 = cljs.core.first(logseq.graph_parser.mldoc.inline__GT_edn(link,logseq.graph_parser.mldoc.default_config.cljs$core$IFn$_invoke$arity$1(format)));
if((G__69197 == null)){
return null;
} else {
return logseq.graph_parser.mldoc.ast_link_QMARK_(G__69197);
}
} else {
return null;
}
...
var and__5041__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(result));
