...
return logseq.graph_parser.util.db.resolve_input(db,input,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"current-page-fn","current-page-fn",1987406514),(function (){
...
var vec__84089 = cljs.core.rest(f);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84089,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84089,(1),null);
var vec__84092 = ((page_ref_QMARK_(x))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [y,x], null));
var page_ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84092,(0),null);
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84092,(1),null);
var page_ref__$1 = clojure.string.lower_case(page_ref);
return (new cljs.core.List(null,new cljs.core.Symbol(null,"contains?","contains?",-1676812576,null),(new cljs.core.List(null,sym,(new cljs.core.List(null,logseq.graph_parser.util.page_ref.get_page_name(page_ref__$1),null,(1),null)),(2),null)),(3),null));
} else {
...
frontend.db.query_react.react_query = (function frontend$db$query_react$react_query(repo,p__84096,query_opts){
var map__84097 = p__84096;
var map__84097__$1 = cljs.core.__destructure_map(map__84097);
var query_SINGLEQUOTE_ = map__84097__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84097__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84097__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84097__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var pprint = (cljs.core.truth_(frontend.config.dev_QMARK_)?frontend.debug.pprint:(function (_){
return null;
}));
...
var resolved_inputs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__84095_SHARP_){
return frontend.db.query_react.resolve_input.cljs$core$IFn$_invoke$arity$3(db,p1__84095_SHARP_,resolve_with);
}),inputs);
var inputs__$1 = (function (){var G__84098 = resolved_inputs;
if(cljs.core.truth_(rules)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__84098,rules);
} else {
return G__84098;
}
})();
var k = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"custom","custom",340151948),(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"query-string","query-string",-1018845061).cljs$core$IFn$_invoke$arity$1(query_SINGLEQUOTE_);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var G__84099_84101 = ["time elapsed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((performance.now() - start_time).toFixed((2))),"ms"].join('');
(pprint.cljs$core$IFn$_invoke$arity$1 ? pprint.cljs$core$IFn$_invoke$arity$1(G__84099_84101) : pprint.call(null,G__84099_84101));
