...
var hierarchy__5643__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__111759 = cljs.core.get_global_hierarchy;
return (fexpr__111759.cljs$core$IFn$_invoke$arity$0 ? fexpr__111759.cljs$core$IFn$_invoke$arity$0() : fexpr__111759.call(null));
})());
...
var page_title = (function (){var G__111760 = frontend.extensions.zotero.extractor.item_type(item);
switch (G__111760) {
case "case":
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__111761){
var map__111762 = p__111761;
var map__111762__$1 = cljs.core.__destructure_map(map__111762);
var first_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111762__$1,new cljs.core.Keyword(null,"first-name","first-name",-1559982131));
var last_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111762__$1,new cljs.core.Keyword(null,"last-name","last-name",-1695738974));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111762__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var tags = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__111763_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__111763_SHARP_,/,\s?/);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__111764){
var map__111765 = p__111764;
var map__111765__$1 = cljs.core.__destructure_map(map__111765);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111765__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
return logseq.graph_parser.util.page_ref.__GT_page_ref(date);
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__111766){
var vec__111767 = p__111766;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111767,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111767,(1),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__111770){
var vec__111771 = p__111770;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111771,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111771,(1),null);
...
var G__111775 = arguments.length;
switch (G__111775) {
case 2:
...
return frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("{{zotero-linked-file %s}}",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.replace_first(path,"attachments:","")], 0))], 0));
});
frontend.extensions.zotero.extractor.extract.cljs$core$IMultiFn$_add_method$arity$3(null,"attachment",(function (item){
var map__111776 = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(item);
var map__111776__$1 = cljs.core.__destructure_map(map__111776);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111776__$1,new cljs.core.Keyword(null,"title","title",636505583));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111776__$1,new cljs.core.Keyword(null,"url","url",276297046));
var link_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111776__$1,new cljs.core.Keyword(null,"link-mode","link-mode",-960686913));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111776__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var filename = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111776__$1,new cljs.core.Keyword(null,"filename","filename",-1428840783));
var G__111777 = link_mode;
switch (G__111777) {
case "imported_file":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__111777)].join('')));
