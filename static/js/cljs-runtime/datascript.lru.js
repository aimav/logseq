...
var G__62530 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__62530) : datascript.lru.cleanup_lru.call(null,G__62530));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__62531 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62531,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62531,(1),null);
...
var datascript$lru$ICache$_get$dyn_62538 = (function (this$,key,compute_fn){
...
return datascript$lru$ICache$_get$dyn_62538(this$,key,compute_fn);
}
});

datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
if((typeof datascript !== 'undefined') && (typeof datascript.lru !== 'undefined') && (typeof datascript.lru.t_datascript$lru62535 !== 'undefined')){
} else {
...
*/
datascript.lru.t_datascript$lru62535 = (function (limit,_STAR_impl,meta62536){
this.limit = limit;
this._STAR_impl = _STAR_impl;
this.meta62536 = meta62536;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(datascript.lru.t_datascript$lru62535.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_62537,meta62536__$1){
var self__ = this;
var _62537__$1 = this;
return (new datascript.lru.t_datascript$lru62535(self__.limit,self__._STAR_impl,meta62536__$1));
}));

(datascript.lru.t_datascript$lru62535.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_62537){
var self__ = this;
var _62537__$1 = this;
return self__.meta62536;
}));

(datascript.lru.t_datascript$lru62535.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru62535.prototype.datascript$lru$ICache$_get$arity$3 = (function (_,key,compute_fn){
var self__ = this;
var ___$1 = this;
...
(datascript.lru.t_datascript$lru62535.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta62536","meta62536",-1102288433,null)], null);
}));

(datascript.lru.t_datascript$lru62535.cljs$lang$type = true);

(datascript.lru.t_datascript$lru62535.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru62535");

(datascript.lru.t_datascript$lru62535.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"datascript.lru/t_datascript$lru62535");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru62535.
 */
datascript.lru.__GT_t_datascript$lru62535 = (function datascript$lru$cache_$___GT_t_datascript$lru62535(limit__$1,_STAR_impl__$1,meta62536){
return (new datascript.lru.t_datascript$lru62535(limit__$1,_STAR_impl__$1,meta62536));
});

}

return (new datascript.lru.t_datascript$lru62535(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
