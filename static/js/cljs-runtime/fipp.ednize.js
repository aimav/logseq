...
var fipp$ednize$IEdn$_edn$dyn_58411 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_58411(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5520__auto__ = (function fipp$ednize$edn_$_iter__58404(s__58405){
return (new cljs.core.LazySeq(null,(function (){
var s__58405__$1 = s__58405;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__58405__$1);
if(temp__5804__auto__){
var s__58405__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58405__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__58405__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__58407 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__58406 = (0);
while(true){
if((i__58406 < size__5519__auto__)){
var k = cljs.core._nth(c__5518__auto__,i__58406);
cljs.core.chunk_append(b__58407,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__58412 = (i__58406 + (1));
i__58406 = G__58412;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58407),fipp$ednize$edn_$_iter__58404(cljs.core.chunk_rest(s__58405__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58407),null);
}
} else {
var k = cljs.core.first(s__58405__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__58404(cljs.core.rest(s__58405__$2)));
}
} else {
return null;
}
