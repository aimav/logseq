...
frontend.components.scheduled_deadlines.scheduled_and_deadlines_inner = rum.core.lazy_build(rum.core.build_defc,(function (page_name){
var scheduled_or_deadlines = ((frontend.components.scheduled_deadlines.scheduled_or_deadlines_QMARK_(page_name))?(function (){var G__114580 = clojure.string.capitalize(page_name);
return (frontend.db.get_date_scheduled_or_deadlines.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_date_scheduled_or_deadlines.cljs$core$IFn$_invoke$arity$1(G__114580) : frontend.db.get_date_scheduled_or_deadlines.call(null,G__114580));
})():null);
...
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [rum.core.reactive,frontend.db_mixins.query], null),"frontend.components.scheduled-deadlines/scheduled-and-deadlines-inner");
