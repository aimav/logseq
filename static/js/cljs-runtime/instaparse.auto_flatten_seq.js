...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_123388 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_123388(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_123393 = (function (self){
var x__5390__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_123393(self);
}
});
...
var G__123394 = n__$1;
var G__123395 = y;
var G__123396 = cljs.core.imul(z,z);
n = G__123394;
y = G__123395;
z = G__123396;
continue;
...
var G__123397 = n__$1;
var G__123398 = cljs.core.imul(z,y);
var G__123399 = cljs.core.imul(z,z);
n = G__123397;
y = G__123398;
z = G__123399;
continue;
...
var G__123400 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__123401 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__123400;
index__$1 = G__123401;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__123245 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__123245) : instaparse.auto_flatten_seq.true_count.call(null,G__123245));
})() - (1)))){
...
var G__123402 = v;
var G__123403 = cljs.core.pop(index);
v = G__123402;
index = G__123403;
continue;
...
var G__123250 = arguments.length;
switch (G__123250) {
case 1:
...
var G__123301 = arguments.length;
switch (G__123301) {
case 1:
...
while(true){
if((!((coll__$1 == null)))){
var G__123467 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__123468 = cljs.core.next(coll__$1);
unmixed_hash = G__123467;
coll__$1 = G__123468;
continue;
} else {
return unmixed_hash;
...
var G__123469 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__123470 = cljs.core.next(v);
acc = G__123469;
v = G__123470;
continue;
} else {
var G__123471 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__123472 = cljs.core.next(v);
acc = G__123471;
v = G__123472;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_123473 = (function (self){
var x__5390__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_123473(self);
}
});
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.call = (function (unused__11814__auto__){
var self__ = this;
var self__ = this;
var G__123366 = (arguments.length - (1));
switch (G__123366) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args123342){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args123342)));
}));
