...
rewrite_clj.parser.core.parse_next_STAR_ = (function (){var method_table__5639__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
var hierarchy__5643__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__88361 = cljs.core.get_global_hierarchy;
return (fexpr__88361.cljs$core$IFn$_invoke$arity$0 ? fexpr__88361.cljs$core$IFn$_invoke$arity$0() : fexpr__88361.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("rewrite-clj.parser.core","parse-next*"),cljs.core.comp.cljs$core$IFn$_invoke$arity$2(new cljs.core.Var(function(){return rewrite_clj.parser.core.dispatch;},new cljs.core.Symbol("rewrite-clj.parser.core","dispatch","rewrite-clj.parser.core/dispatch",-1962626312,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,cljs.core.with_meta(new cljs.core.Symbol(null,"rewrite-clj.parser.core","rewrite-clj.parser.core",1408837387,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-doc","no-doc",1559921891),true], null)),new cljs.core.Symbol(null,"dispatch","dispatch",-1335098760,null),"rewrite_clj/parser/core.cljc",16,1,28,28,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"c","c",-122660552,null)], null)),null,(cljs.core.truth_(rewrite_clj.parser.core.dispatch)?rewrite_clj.parser.core.dispatch.cljs$lang$test:null)])),rewrite_clj.reader.peek),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__5643__auto__,method_table__5639__auto__,prefer_table__5640__auto__,method_cache__5641__auto__,cached_hierarchy__5642__auto__));
})();
}
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__88362_SHARP_){
var _STAR_delimiter_STAR__orig_val__88363 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__88364 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__88364);

try{return rewrite_clj.parser.core.parse_next(p1__88362_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__88363);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5772__auto__ = [];
var len__5766__auto___88375 = arguments.length;
var i__5767__auto___88376 = (0);
while(true){
if((i__5767__auto___88376 < len__5766__auto___88375)){
args__5772__auto__.push((arguments[i__5767__auto___88376]));

var G__88377 = (i__5767__auto___88376 + (1));
i__5767__auto___88376 = G__88377;
continue;
} else {
}
break;
...
return rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__5773__auto__);
});

(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__88369){
var vec__88370 = p__88369;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88370,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq88365){
var G__88366 = cljs.core.first(seq88365);
var seq88365__$1 = cljs.core.next(seq88365);
var G__88367 = cljs.core.first(seq88365__$1);
var seq88365__$2 = cljs.core.next(seq88365__$1);
var G__88368 = cljs.core.first(seq88365__$2);
var seq88365__$3 = cljs.core.next(seq88365__$2);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__88366,G__88367,G__88368,seq88365__$3);
}));
...
var G__88373 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__88373)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__88373)){
...
return cljs.core.cons((function (){var G__88374 = rewrite_clj.reader.peek(reader);
switch (G__88374) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__88373)){
