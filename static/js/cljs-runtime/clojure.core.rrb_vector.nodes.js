...
var G__58372 = (root.arr[(slc - (1))]);
var G__58373 = (shift - (5));
var G__58374 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__58372;
shift = G__58373;
cnt = G__58374;
continue;
...
if((!(r_QMARK_))){
var rngs_58383 = clojure.core.rrb_vector.nodes.node_ranges(parent);
var rng0_58384 = (rngs_58383[(0)]);
var new_rngs_58385 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_58386 = (rngs_58383[(32)]);
cljs.core.array_copy(rngs_58383,(1),new_rngs_58385,(0),(lim_58386 - (1)));

var i_58387 = (0);
while(true){
if((i_58387 < lim_58386)){
(new_rngs_58385[i_58387] = ((new_rngs_58385[i_58387]) - rng0_58384));

var G__58388 = (i_58387 + (1));
i_58387 = G__58388;
continue;
} else {
}
...
(new_rngs_58385[(32)] = ((rngs_58383[(32)]) - (1)));

(new_rngs_58385[((rngs_58383[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_58385);
} else {
}
...
while(true){
if((i_58389 <= li)){
(new_rngs[i_58389] = ((new_rngs[(i_58389 - (1))]) + step));

var G__58390 = (i_58389 + (1));
i_58389 = G__58390;
continue;
} else {
}
...
while(true){
if((i_58391 <= li)){
(new_rngs[i_58391] = ((rngs[i_58391]) - d));

var G__58392 = (i_58391 + (1));
i_58391 = G__58392;
continue;
} else {
}
...
while(true){
if((j_58393 <= i)){
(rngs[j_58393] = r_58394);

var G__58395 = (j_58393 + (1));
var G__58396 = (r_58394 + step);
j_58393 = G__58395;
r_58394 = G__58396;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__58365 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__58365[(0)] = node.arr.length);
...
var arr_58397__$1 = arr;
var shift_58398__$1 = shift;
while(true){
if((shift_58398__$1 === (5))){
if((!(reg_QMARK_))){
(arr_58397__$1[(32)] = rngs);
} else {
}

(arr_58397__$1[(0)] = node);
} else {
var a_58399 = (new Array(len));
var e_58400 = cljs.core.__GT_VectorNode(null,a_58399);
(arr_58397__$1[(0)] = e_58400);
...
var G__58401 = a_58399;
var G__58402 = (shift_58398__$1 - (5));
arr_58397__$1 = G__58401;
shift_58398__$1 = G__58402;
continue;
}
break;
}
...
var cret = (((shift === (5)))?cljs.core.__GT_VectorNode(null,tail):(function (){var G__58366 = (arr[(li - (1))]);
var G__58367 = (shift - (5));
var G__58368 = ((clojure.core.rrb_vector.nodes.regular_QMARK_(node))?cljs.core.mod(cnt,((1) << shift)):(function (){var li__$1 = ((rngs[(32)]) - (1));
if((li__$1 > (0))){
...
var G__58369 = tail;
return (clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4 ? clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4(G__58366,G__58367,G__58368,G__58369) : clojure.core.rrb_vector.nodes.fold_tail.call(null,G__58366,G__58367,G__58368,G__58369));
})());
