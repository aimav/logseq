...
if(cljs.core.truth_((function (){var and__5041__auto__ = (function (){var G__119846 = frontend.state.sub(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"route-match","route-match",-1450985937),new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"name","name",1843675177)], null));
var fexpr__119845 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"home","home",-74557309),null,new cljs.core.Keyword(null,"page","page",849072397),null], null), null);
return (fexpr__119845.cljs$core$IFn$_invoke$arity$1 ? fexpr__119845.cljs$core$IFn$_invoke$arity$1(G__119846) : fexpr__119845.call(null,G__119846));
})();
if(cljs.core.truth_(and__5041__auto__)){
var and__5041__auto____$1 = cljs.core.not(frontend.state.sub(new cljs.core.Keyword("editor","editing?","editor/editing?",807325417)));
if(and__5041__auto____$1){
var and__5041__auto____$2 = frontend.state.sub(new cljs.core.Keyword("mobile","show-tabbar?","mobile/show-tabbar?",925227298));
