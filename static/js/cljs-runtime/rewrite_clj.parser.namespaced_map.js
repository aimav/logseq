...
var or__5043__auto__ = rewrite_clj.reader.boundary_QMARK_(c);
if(or__5043__auto__){
...
if(cljs.core.truth_((function (){var and__5041__auto__ = n;
...
var G__88350 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,n);
nodes = G__88350;
continue;
} else {
...
var vec__88347 = rewrite_clj.parser.namespaced_map.parse_to_next_elem(reader,read_next);
var whitespace_nodes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88347,(0),null);
var map_node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88347,(1),null);
