...
var and__5041__auto__ = cljs.core.not(devtools.formatters.state.prevent_recursion_QMARK_());
if(and__5041__auto__){
var or__5043__auto__ = devtools.formatters.helpers.cljs_value_QMARK_(value);
...
}catch (e44381){var _e__42258__auto__ = e44381;
return false;
...
}catch (e44383){var _e__42258__auto__ = e44383;
return false;
...
}catch (e44385){var _e__42258__auto__ = e44385;
return false;
...
}catch (e44387){var _e__42258__auto__ = e44387;
return false;
...
}catch (e44389){var _e__42258__auto__ = e44389;
return false;
}})())){
...
}catch (e44391){var _e__42258__auto__ = e44391;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__44393 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__44394 = (function (){var or__5043__auto__ = config;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__44394);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__44393);
}});
});
...
return (function() { 
var G__44396__delegate = function (args){
try{return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,args);
}catch (e44395){var e = e44395;
...
while (G__44397__i < G__44397__a.length) {G__44397__a[G__44397__i] = arguments[G__44397__i + 0]; ++G__44397__i;}
  args = new cljs.core.IndexedSeq(G__44397__a,0,null);
} 
return G__44396__delegate.call(this,args);};
G__44396.cljs$lang$maxFixedArity = 0;
G__44396.cljs$lang$applyTo = (function (arglist__44398){
var args = cljs.core.seq(arglist__44398);
return G__44396__delegate(args);
});
...
var pre_handler = (function (){var or__5043__auto__ = devtools.prefs.pref(pre_handler_key);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var post_handler = (function (){var or__5043__auto__ = devtools.prefs.pref(post_handler_key);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return cljs.core.identity;
