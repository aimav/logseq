...
var el_126168__$1 = el.querySelector(".draw-wrap");
while(true){
if((((el_126168__$1 == null)) || ((((void 0 === el_126168__$1)) || ((void 0 === el_126168__$1.classList)))))){
} else {
if(cljs.core.truth_(el_126168__$1.classList.contains("block-content"))){
var client_width_126169 = el_126168__$1.clientWidth;
var width_126170 = (((client_width_126169 === (0)))?el_126168__$1.getBoundingClientRect.width:client_width_126169);
cljs.core.reset_BANG_(new cljs.core.Keyword("frontend.extensions.excalidraw","draw-width","frontend.extensions.excalidraw/draw-width",-681100043).cljs$core$IFn$_invoke$arity$1(state),width_126170);
} else {
var G__126171 = el_126168__$1.parentNode;
el_126168__$1 = G__126171;
continue;
...
var map__126160 = option;
var map__126160__$1 = cljs.core.__destructure_map(map__126160);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__126160__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__126160__$1,new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638));
...
}),'className':"mr-2"},[daiquiri.interpreter.interpret(frontend.util.format.cljs$core$IFn$_invoke$arity$variadic("Grid Mode (%s)",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(cljs.core.truth_(cljs.core.deref(_STAR_grid_mode_QMARK_))?"ON":"OFF")], 0)))]),daiquiri.core.create_element("a",{'onClick':(function (){
var temp__5804__auto__ = (function (){var G__126161 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_uuid], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__126161) : frontend.db.pull.call(null,G__126161));
})();
if(cljs.core.truth_(temp__5804__auto__)){
var block = temp__5804__auto__;
return (frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3(block,new cljs.core.Keyword(null,"max","max",61366548),block_uuid) : frontend.handler.editor.edit_block_BANG_.call(null,block,new cljs.core.Keyword(null,"max","max",61366548),block_uuid));
} else {
return null;
}
}),'className':"mr-2"},["Edit Block"])]),daiquiri.core.create_element("div",{'ref':ref,'onMouseDown':(function (e){
...
}),'style':{'width':cljs.core.deref(_STAR_draw_width),'height':(cljs.core.truth_(wide_mode_QMARK_)?(650):(500))},'className':"draw-wrap"},[daiquiri.interpreter.interpret((function (){var G__126163 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (elements,app_state,files){
...
return (frontend.extensions.excalidraw.excalidraw.cljs$core$IFn$_invoke$arity$1 ? frontend.extensions.excalidraw.excalidraw.cljs$core$IFn$_invoke$arity$1(G__126163) : frontend.extensions.excalidraw.excalidraw.call(null,G__126163));
})())])]);
} else {
return null;
}
...
var attrs126164 = frontend.ui.loading.cljs$core$IFn$_invoke$arity$0();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs126164))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ls-center"], null)], null),attrs126164], 0))):{'className':"ls-center"}),((cljs.core.map_QMARK_(attrs126164))?null:[daiquiri.interpreter.interpret(attrs126164)]));
} else {
...
var vec__126165 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__126165,(0),null);
